...
//_Tillage_operation_class:constructor______________________________2011-01-13_/
...
//_setup_parameters_________________________________________________2011-01-13_/
...
//_log______________________________________________________________2011-01-13_/
...
//_Organic_nitrogen_operation_abstract_class:constructor____________2011-01-XX_/
...
//_multiply_amount_by_______________________________________________2007-07-16_/
...
//_is_liquid________________________________________________________2002-03-22_/
void Organic_nitrogen_operation_abstract_class::log(std::ostream &log_file) const
{  CropSyst_field_operation_VX::log(log_file);
   std::string org_N_appl_method_string;                                         //190109
   log_file << LABEL_org_N_appl_method << '='
      << org_N_appl_method_cowl.append_label(org_N_appl_method_string) <<std::endl;  //021105
   ...
   std::string organic_matter_source_string;                                     //190109
   log_file << "source="
      << organic_matter_source_cowl.append_label(organic_matter_source_string)  //190109
      << std::endl;
}
//_log______________________________________________________________2002-??-??_/
...
//_Inorganic_nitrogen_operation_class__________________________________________/
...
{  CropSyst_field_operation_VX::setup_parameters(data_rec, for_write);
   ...
   data_rec.expect_bool(LABEL_NH4_volatilization_calculated,NH4_volatilization_calculated); //180326_990227
...
{  CropSyst_field_operation_VX::log(log_file);
   std::string NH4_source_string;
   std::string NH4_appl_method_string;
   log_file << LABEL_ammonium_source << '=' <<
      NH4_source_cowl.append_label(NH4_source_string)<< std::endl;               //190109_021105
      //190109 NH4_source_cowl.get_label()
   log_file << LABEL_NH4_appl_method << '=' <<
      NH4_appl_method_cowl.append_label(NH4_appl_method_string) << std::endl;    //190109_021105
      //190109 NH4_appl_method_cowl.get_label()
}
...
//_Harvest_or_clipping_operation_class:constructor__________________2011-01-XX_/
...
//_setup_parameters_________________________________________________2003-10-14_/
...
//_log______________________________________________________________2002-03-14_/
...
//_Auto_clip_biomass_mode_class:constructor_________________________2010-10-27_/
Auto_clip_biomass_mode_class::Auto_clip_biomass_mode_class
...
//_Auto_clip_biomass_mode_class:constructor_________________________2002-03-14_/
...
//_update_considerations____________________________________________2004-08-31_/
...
//_set_considerations_______________________________________________2004-08-31_/
...
//_setup_parameters_________________________________________________2002-03-14_/
...
{  chemical_name              .assign(""); // In the case of pesticides (NYI)
   ...
   wetting_area_surface_fraction = 1.0;                                          //200225
}
//_Irrigation_operation_class:constructor___________________________2005-05-11_/
void Irrigation_operation_class::setup_parameters(Data_record &data_rec,bool for_write)
{  CropSyst_field_operation_VX::setup_parameters(data_rec, for_write);
   data_rec.expect_string(LABEL_chemical,chemical_name);
   ...
   if (!for_write) // the original management editor
      data_rec.expect_float32("wetting_surface_evaporation_area_fraction",wetting_area_surface_fraction); //200220
   data_rec.expect_float32("wetting_surface",wetting_area_surface_fraction);     //200220
...
//_get_min_application_m____________________________________________2011-01-XX_/
bool Irrigation_operation_class::multiply_amount_by(float32 multiplier) modification_
{  amount_mm *= multiplier;
   return true;
}
//_multiply_amount_by_______________________________________________2009-07-16_/
...
{  CropSyst_field_operation_VX::log(log_file);
   if (CORN::is_zero<float32>(amount_mm/*200127,0.0,0.00001*/))                  //120427
...
{}
//_Automatic_irrigation_mode_class:constructor______________________2002-03-13_/
...
//_setup_parameters_________________________________________________1999-11-22_/
...
{  CropSyst_field_operation_VX::label_string(result);
   ...
   if (!CORN::is_zero<float32>(actual_NO3_kg_m2))
   {  result += " (";
   ...
   result += "%";
   // During runtime we will calculate the actual amount (this will not be printed in the parameter editor).
   if (!CORN::is_zero<float32>(actual_NH4_kg_m2))
   {  result += " (";
...
{  CropSyst_field_operation_VX::setup_parameters(data_rec,for_write);
   data_rec.expect_bool(LABEL_split_applications,split_applications); //020611
   // Supplemental application is achieved with
   // normal fixed management but now condition for application is added
}
//_setup_parameters_________________________________________________1997-07-09_/
...
//_N_application_soil_observation_mode_class___________________________________/
void N_application_soil_observation_mode_class::log(std::ostream &log_file) const
{  CropSyst_field_operation_VX::log(log_file);
   std::string automatic_N_mode_string;
   log_file << LABEL_automatic_N_mode << '=' <<
      automatic_N_mode_cowl.append_label(automatic_N_mode_string)                //190109
      //190109 automatic_N_mode_cowl.get_label()
      << std::endl;  //021105
...
//_log______________________________________________________________2002-03-11_/
...
{  buffer.append(TL_Soil_N_sampling_depth );
   ...
   buffer += ": ";
   if (CORN::is_zero<float32>(total_N_application_kg_m2))
...
//_Split_application::log___________________________________________2011-01-XX_/
...
,land_treatment_clad                   (DEFAULT_land_treatment)                  //020322
...
//_Management_parameters_class:constructor_____________________________________/
...
{  bool expected = Common_parameters_data_record::expect_structure(for_write);   //161025_040614
   ...
   expect_enum(LABEL_land_treatment,land_treatment_clad);
...
//   expect_enum("irrigation_system", irrigation_system_labeled);
   ...
   EXPECT_ENUMERATED_SECTION(LABEL_residue               ,residue_operation_section_VV             ,residue_operations);                     //200511
...
//_Chemical_operation_class:constructor________________________________________/
...
//_total_automatic_N_applications___________________________________2002-04-03_/
...
//_irrigation_multiply_by___________________________________________2007-07-16_/
...
//_delete_event_____________________________________________________2017-07-01_/
}//_namespace CropSyst_________________________________________________________/
