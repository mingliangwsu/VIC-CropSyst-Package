...
, public extends_ CS::Parameter_float64
{
 public:
   ...
   inline virtual CORN::Units_code get_units()                             const
                                  { return CS::Parameter_float64::get_units(); }
...
//_Temperature______________________________________________________2015-01-20_/
