...
#endif
//______________________________________________________________________________
const std::string &Time_deprecated::append_to_string                             //140614
(std::string &target
,const Date_format *target_date_format                                           //180624
,const Time_format *target_time_format)                                    const //180624
{  char t_buf[10];

   const Time_format *format = preferred_format;                                 //180625
...
datetime64 Time_deprecated::set_c_str
(const char *time_str
//,const Date_format *target_date_format                                           //180624
,const Time_format *target_time_format)
{
   const Time_format *format
      = target_time_format ? target_time_format : preferred_format;              //180625
...
datetime64 Time_deprecated::inc_seconds(Seconds more_seconds)
...
//______________________________________________________________________________
Time_deprecated::Time_deprecated()
: Time_second_clad()                                                             //170825
/*170825
...
//______________________________________________________________________________
Time_deprecated::Time_deprecated(datetime64 time64)
: Time_second_clad()                                                             //170825
{  set_datetime64(time64);
}
//_2003-07-14___________________________________________________________________
datetime64 Time_deprecated::set_datetime64(datetime64 time64)
...
//_2003-07-14___________________________________________________________________
datetime64 Time_deprecated::get_datetime64()                                          const
...
int8 Time_deprecated::compare_time(const Time &other_time)                            const
