...
//_Snow_pack________________________________________________________2014-12-05_/
...
: public implements_ Snow_pack
{
 ...
 protected:
   contribute_ float64  liquid_water_m; // In simple model this will always be 0 //990111
   contribute_ float64  ice_water_m;                                             //990111
   // This the depth of water in the form of snow.
   // This is not the depth of the snow, but the depth of water.
   contribute_ bool     new_snow_this_time_step;                                 //000315
   contribute_ float64  snow_pack_thickness_m;                                   //141205
   contribute_ float64  snow_melted_today; // m                                  //981019
public:
   Snow_pack_common
      (modifiable_ Precipitation     &liberated_water
      ,const Precipitation           &precipitation
...
//_Snow_pack_common____________________________________________________________/
...
//_Snow_pack_temperature_based_________________________________________________/
...
public:
   Snow_pack_energy_based
      ...
      ,float64       soil_slope_percent  = 0
      ,float64       site_aspect_deg     = 180
      ,bool          forest_vegetation   = false);
private:
...
//_Snow_pack_energy_based______________________________________________________/
#endif
