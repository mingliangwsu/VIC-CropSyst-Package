...
{  nat32 processed = 0;
   ...
   const UED::Geolocation_record *source_geoloc = source_UED.ref_geolocation_record();
   if (source_geoloc)
   {
...
{
   bool added = false;
      const UED::Geolocation_record *geoloc = source_UED_file.ref_geolocation_record();
      if (geoloc)
      {
...
//_process_UED_files___________________________________________________________/
...
//_add_ETref_to_named_UED______________________________________________________/
