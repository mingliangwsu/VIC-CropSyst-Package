#ifndef spreadsheetAH
#define spreadsheetAH

#include "corn/format/binary/oldbinrec/oldbinrec_s.h"
/*
   This set of classes allow reading and writing old spreadsheet files.
...
class Spreadsheet_abstract //200107 Common_spreadsheet_file
: public Old_binary_record_file
{
 ...
 public: // The following are abstract methods that must be defined in derived classes
   ...
   virtual void write_col_width                                                  //981006
      ...
      **/
   inline virtual void freeze_pane                                               //981006
   ...
   inline void write_float(float64 value, int8 width, int8 precision_)
      { write_real(value, width, precision_); }                                  //021216
 ...
 public: // reading methods
   ...
   virtual Record_type read_next(Record_type filter_type = any_record) = 0;
      ...
      **/
   bool reset() stream_IO_; // Go back to the beginning of the files             //111111
...
//_Spreadsheet_abstract_____________________________________________1998-10-06_/
#endif
