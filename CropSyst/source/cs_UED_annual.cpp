...
)
{
   ...
   alloc_ID = alloc_ID_;
   #ifdef NITROGEN
   const Soil::NO3_Profile *NO3 = 0;                                             //180107
   const Soil::NH4_Profile *NH4 = 0;                                             //180107
   const Chemical_balance_accumulators_molecular *NO3_ANNL_bal_accums_M = 0;               //180107
   const Chemical_balance_accumulators_molecular *NH4_ANNL_bal_accums_M = 0;               //180107
   #endif
   if (soil)                                                                     //180107
   {                                                                             //180107
      #ifdef NITROGEN
      Soil::Chemicals_profile *soil_chemical = soil->chemicals;                  //180107
      if (soil_chemical)                                                         //180107
      {  NO3 = soil_chemical->NO3;                                               //180107
         NH4 = soil_chemical->NH4;                                               //180107
         NO3_ANNL_bal_accums_M = NO3->ANNL_bal_accums_M;                         //180107
         NH4_ANNL_bal_accums_M = NO3->ANNL_bal_accums_M;                         //180107
      }
      #endif
      RUSLE::Soil_erosion *soil_erosion = soil->erosion;                         //180107
      if (soil_erosion)                                                          //180107
      {  soil_loss      = soil_erosion->total_soil_loss;                         //180107
         RUSLE_C_factor = soil_erosion->C_factor_tally.get_sum();                //180107
      }
   }
...
//180108 temp restored   #ifndef CS_INSPECTOR_VERSION
   ET_max                         = ANNL_accumulators.evapotranspiration_max; //190812 pot_evapotranspiration;
   ET_act                         = ANNL_accumulators.evapotranspiration_act;
   ET_ref                         = ANNL_accumulators.evapotranspiration_ref;    //130723
...
//180108 temp restored   #endif
   ...
   {
      //180108 temp restored#ifndef CS_INSPECTOR_VERSION
      if (NO3 && NO3_ANNL_bal_accums_M && NH4_ANNL_bal_accums_M)                 //140829_990409
      {
         N_inorganic_applied        =                                            //160323
              (NO3_ANNL_bal_accums_M->get_applied(true)
              +NH4_ANNL_bal_accums_M->get_applied(true));
         N_total_applied = N_inorganic_applied + N_organic_applied;              //160323
         N_leached        =
            /*190909 shouldnt be different
            #ifdef OFOOT_VERSION
              (NO3_ANNL_bal_accums_M->get_reported_leached(true)                  //140620
              +NH4_ANNL_bal_accums_M->get_reported_leached(true));                //140620
            #else
            */
              (NO3_ANNL_bal_accums_M->get_reported_leached(true)                  //981230
              +NH4_ANNL_bal_accums_M->get_reported_leached(true));                //981230
            //190909 #endif
         N_uptake         =
              (NO3_ANNL_bal_accums_M->get_uptake(true)
              +NH4_ANNL_bal_accums_M->get_uptake(true));
      }
   ...
   // CS_INSPECTOR_VERSION
      ...
      denitrification_X = NO3_ANNL_bal_accums_M->get_transformed_to(true);
      N_soil_profile
      = NO3_ANNL_bal_accums_M->get_current_profile_content(true)
      + NH4_ANNL_bal_accums_M->get_current_profile_content(true);      // Mineral N in the soil    (mineral profile N)  // this is only for luca
      //180108 temp restored      #ifndef CS_INSPECTOR_VERSION
...
{  CORN::Data_record::expect_structure(for_write);
   ...
   expect_float32("RUSLE_C_factor",RUSLE_C_factor);
      //180108 temp restored   #ifndef CS_INSPECTOR_VERSION
   expect_float32("ET_max",ET_max);                                              //190812
   //190812 expect_float32("ET_pot",ET_pot);
...
, Annual_data_record()
{
   ...
   //190812 add_field2(annual_section,"ET_pot"                     ,CSVC_weather_ET_pot_time_step_sum                ,UC_m    ,UT_arbitrary_date);
   add_field2(annual_section,"ET_max"                     ,CSVC_weather_ET_max_time_step_sum                ,UC_m    ,UT_arbitrary_date);
...
//_Annual_data_source_______________________________________________2004-09-21_/
...
//_Annual_data_record:constructor______________________________________________/
