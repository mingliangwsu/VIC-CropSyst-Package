#error obsolete replaced with Delineator
...
{}
//_Text_format_auto_identifier:constructor_____________________________________/
...
//   tabular_file_format.detail_lines_delineation.relative_to_row_labeled.set(BEGIN_FILE_RELATIVE);  
   tabular_file_format.detail_lines_delineation.start_row_number = detail_line_start_row;
   ...
   if (!character_delimited)
   {
      if (may_be_character_delimited)
      {
         ...
         {  character_delimited = true;
            tabular_file_format.detail_lines_delineation.tabulation_labeled.set(Delineation::delimit_TABULATION);
         }
         else
         {
      ...
      {
         tabular_file_format.detail_lines_delineation.tabulation_labeled.set(Delineation::fixed_TABULATION);
      }
   }

   if (character_delimited)
   {  tabular_file_format.detail_lines_delineation.tabulation_labeled.set(Delineation::delimit_TABULATION);
      tabular_file_format.detail_lines_delineation.delimiter_comma = true; // presume comma delimited unless we find another delimiter
      if (character_count[detail_line_start_row][';'] > 0)  // check for semicolons, if any, most likely
      {
         tabular_file_format.detail_lines_delineation.delimiter_semicolon = true;
         tabular_file_format.detail_lines_delineation.delimiter_comma = false;
         // presume not both semicolon and tab delimited
      }
      if (character_count[detail_line_start_row]['\t'] > 0)
      {
         tabular_file_format.detail_lines_delineation.delimiter_tab = true;
         tabular_file_format.detail_lines_delineation.delimiter_comma = false;
         // presume not both comma and tab delimited
      }
...
//      tabular_file_format.detail_lines_delineation.delimiter_string;   // Currently unable to determine here
   ...
   if (character_count[detail_line_start_row]['\"'] > 2)
      tabular_file_format.detail_lines_delineation.separation.quotation = "\"";  //200220
      //200220 tabular_file_format.detail_lines_delineation.text__quote_mode_labeled.set(Delineation::DOUBLE_QUOTE);
   if (character_count[detail_line_start_row]['\''] > 2)
      tabular_file_format.detail_lines_delineation.separation.quotation = "'";   //200220
      //200220 tabular_file_format.detail_lines_delineation.text__quote_mode_labeled.set(Delineation::SINGLE_QUOTE);

   tabular_file_format.detail_lines_delineation.separation.decimal = ".";  //20020
   //200220 tabular_file_format.detail_lines_delineation.decimal_mark.assign(".");
   ...
   { // there are both commas and semicolons in the data lines then decimal must be ,
      tabular_file_format.detail_lines_delineation.separation.decimal = ",";     //200220
      //200220 tabular_file_format.detail_lines_delineation.decimal_mark.assign(",");
   }
   ...
   tabular_file_format.column_headers_delineation.start_row_number        = column_header_start_row;
   ...
   tabular_file_format.column_headers_delineation.tabulation_labeled     .set(tabular_file_format.detail_lines_delineation.tabulation_labeled.get()); // Currently presume the same  delimit mode for column headers (if any)

   tabular_file_format.column_headers_delineation.separation.continuous = tabular_file_format.detail_lines_delineation.separation.continuous;//200220
   tabular_file_format.column_headers_delineation.separation.delimiter  = tabular_file_format.detail_lines_delineation.separation.delimiter; //200220
   tabular_file_format.column_headers_delineation.separation.decimal    = tabular_file_format.detail_lines_delineation.separation.decimal;   //200220
   tabular_file_format.column_headers_delineation.separation.quotation  = tabular_file_format.detail_lines_delineation.separation.quotation; //200220
   tabular_file_format.column_headers_delineation.separation.notes      = tabular_file_format.detail_lines_delineation.separation.notes;     //200220
...
//_identify____________________________________________________________________/
#ifdef NYI
...
//                        (character_count[l]['('] > 0 ) && (character_count[l][')'] > 0 );
   ...
   tabular_file_format.detail_lines_delineation.start_row_number = detail_line_start_row;
   tabular_file_format.detail_lines_delineation.tabulation_labeled.set(Delineation::intrinsic_TABULATION);
   ...
   tabular_file_format.column_headers_delineation.separation.quotation     = tabular_file_format.detail_lines_delineation.separation.quotation; //200220
   tabular_file_format.column_headers_delineation.separation.decimal       = tabular_file_format.detail_lines_delineation.separation.decimal; //200220
   tabular_file_format.column_headers_delineation.extent.notes             = tabular_file_format.detail_lines_delineation.extent.notes; //200220
   ...
   tabular_file_format.column_headers_delineation.delimiter_string         = tabular_file_format.detail_lines_delineation.delimiter_string;
   tabular_file_format.column_headers_delineation.other_delimiter_string   = tabular_file_format.detail_lines_delineation.other_delimiter_string;
   tabular_file_format.column_headers_delineation.text__quote_mode_labeled  .set(tabular_file_format.detail_lines_delineation.text__quote_mode_labeled.get());
   tabular_file_format.column_headers_delineation.decimal_mark             .assign(tabular_file_format.detail_lines_delineation.decimal_mark);
   tabular_file_format.column_headers_delineation.notes                    .assign(tabular_file_format.detail_lines_delineation.notes);
   */
...
//_identify____________________________________________________________________/
Format_file_type Tabular_format_identifier::identify_file_type_by_extension
(const char *_sample_filename)                                             const
...
//_identify_file_type_by_extension_____________________________________________/
...
//_identify_file_type__________________________________________________________/
#ifdef NYI
bool Tabular_format_identifier::identify
(modifiable_ Tabular_file_format/*200220 Common_tabular_file__format*/  &tabular_file_format
,const char *sample_filename
...
{  bool format_identified = false;
   ...
   tabular_file_format.definer.assign("Tabular format editor auto-identification (rnelson@mail.wsu.edu)");
   tabular_file_format.variable_order_labeled.set(Common_tabular_file__format::fixed_order);  // presume fixed order since this is the only sample file to go on
