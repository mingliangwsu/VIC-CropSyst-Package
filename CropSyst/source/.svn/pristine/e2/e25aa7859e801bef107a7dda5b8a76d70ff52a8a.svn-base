...
{public:
 ...
 public:
    const CropSyst::Project_editor_parameters  &project_parameters;
 protected:
...
public:
   ...
   virtual const CORN::OS::Directory_name& get_generated_scenarios_directory_qual() = 0;
   const CORN::OS::File_name &get_generate_scenarios_log()                const; //140214
   virtual bool was_launched_by_CS_explorer()                             const; //101116
};
//_CropSyst_multirun___________________________________________________________/
#endif
