...
DECLARE_ENUM_CLAD(Snow_pack_model_clad,Snow_pack_model,snow_pack_model_label_table);
//_Snow_pack_model__________________________________________________1999-10-04_/
enum Season_S_S_F_W{UNKNOWN_SEASON_S_S_F_W,SPRING_SEASON,SUMMER_SEASON
                   ,FALL_SEASON,WINTER_SEASON,SEASON_S_S_F_W_COUNT};
extern const char *season_S_S_F_W_label_table[];
DECLARE_ENUM_CLAD(Season_S_S_F_W_clad,Season_S_S_F_W,season_S_S_F_W_label_table);
//_Season_S_S_F_W___________________________________________________2004-01-15_/
enum Season_S_W_SF{UNKNOWN_SEASON_S_W_SF,SUMMER_ONLY_SEASON,WINTER_ONLY_SEASON
                  ,SPRING_OR_FALL_SEASON,SEASON_S_W_SF_COUNT};
extern const char *season_S_W_SF_label_table[];
DECLARE_ENUM_CLAD(Season_S_W_SF_clad,Season_S_W_SF,season_S_W_SF_label_table);
//_Season_S_W_SF____________________________________________________2004-01-15_/
 enum Wind_speed_classification{WIND_SPEED_VERY_LOW,WIND_SPEED_LOW
      ,WIND_SPEED_MEDIUM,WIND_SPEED_MEDIUM_HIGH,WIND_SPEED_HIGH
      ,WIND_SPEED_VERY_HIGH,WIND_SPEED_SPECIFIED,WIND_SPEED_UNKNOWN};
 extern const char *wind_speed_class_label_table[];                              //020322
 DECLARE_ENUM_CLAD(Wind_speed_classification_clad
      ,Wind_speed_classification,wind_speed_class_label_table);                  //020322
//_Wind_speed_classification________________________________________1998-02-20_/
namespace CS {
...
//_Annual_temperature______________________________________________2015-04-24_/
}//_namespace_CS______________________________________________________________/
