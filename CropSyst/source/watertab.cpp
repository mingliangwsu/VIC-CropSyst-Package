...
, value_today(0.0)
{
   ...
   std::string junk;
   float64 initial_concentration_molecular
         = initial_value_elemental*convert_to_molecular_concentration;           //080219
#ifdef __BCPLUSPLUS__
      ...
      {  recal_file >> read_year >> DOY >> code >> value;
         ...
         {  CORN::Date_clad_32 observation_date(year,DOY);                       //000504
            ...
            {  any_apropos_records_in_the_file = true;                           //080213
               interpolator->set_by_date
                  (observation_date,value * convert_to_molecular_concentration); //000504
      }  }  }
...
{  return (interpolator != NULL)
      || !CORN::is_zero<float64>(constant_value);
}
