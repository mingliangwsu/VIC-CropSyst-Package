...
//201007 #include "corn/format/spreadsheet/css_file.h"
...
class BIFF234_File //200108 was  Biff_file                   // rename this to BIFF234_File
: public Spreadsheet_abstract //200107 Common_spreadsheet_file
{
 protected:
   BIFF_Format BIFF_format;                                                      //090618
   // 2=BIFF2 3=BIFF3 4=BIFF4 5=BIFF5 8=BIFF8
   // (There does not appear to be BIFF1,BIFF6,BIFF7 these versions were probably never released)
 protected: // Pane attributes
   bool has_frozen_panes;
   nat16 pane_left_most_column;
   nat16 pane_top_most_row;
   nat16 pane_active;
 public:
   BIFF234_File(const char *filename_ ,std::ios_base::openmode openmode_);       //111108_000211
   BIFF234_File
      (const char *filename_
      ,sint32 first_row  ,sint32 rows                                            //090618
      ,int16 first_col   ,int16 cols
      ,BIFF_Format BIFF_format_ = BIFF4);                                        //000307
   virtual ~BIFF234_File();                                                      //040929
 ...
 public:  // Writing methods
   ...
   virtual void write_dimensions
      (sint32 first_row  ,sint32 rows
         // BIFF8 allows 32bits for row info  earlier version we 16 bit
      ,int16 first_col , int16 cols);
 ...
 public:  // reading methods
   ...
   //200107 virtual Common_spreadsheet_file::Record_type read_next(Common_spreadsheet_file::Record_type filter_type = any_record);
   virtual Spreadsheet_abstract::Record_type read_next
      (Spreadsheet_abstract::Record_type filter_type = any_record);
 ...
 public:  // identification methods
   virtual nat16 get_BOF_code() const;
   virtual nat16 get_EOF_code() const;
};
//_BIFF234_File________________________________________________________________/
#endif
