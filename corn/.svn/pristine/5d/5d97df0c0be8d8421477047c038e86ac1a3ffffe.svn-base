...
: file_name(0)                                                                   //981019
, endian_swapping(big_endian_ != CPU_is_big_endian())                            //990106
, openmode(openmode_|std::ios::binary)                                           //160927_111026
{
   file_name = new char[strlen(file_name_) + 1]; // should only need to add 1
   strcpy(file_name,file_name_);
}
//_Binary_file_abstract:constructor____________________________________________/
Binary_file_abstract::~Binary_file_abstract()
{  if (file_name) delete [] file_name; file_name = 0;
}
//_Binary_file_abstract:destructor__________________________________2002-01-25_/
/*
...
(const string_class &str,String_format format ,nat32 field_length)    stream_IO_                      \
{                                                                                                     \
...
//_write_Xstring_implementation________________________________________________/
const std::string &Binary_file_abstract::write_string
(const std::string &str,String_format format ,nat32 field_length)     stream_IO_
{
   nat32 str_length = str.length();
   nat32 remaining_field_length = field_length;
   Data_type character_count_datatype = (Data_type)(format & CORN_len_data_type_bitmask);
...
//_write_string_____________________________________________________2010-01-14_/
...
(const char *c_str,String_format format ,nat32 field_length)          stream_IO_
{
   std::string str(c_str);
   write_string(str,format,field_length);
   return c_str;
}
//_write_Xstring_implementation_____________________________________2010-01-14_/
/*
...
//_read_Xstring_method_name____________________________________________________/
...
//_read_wstring__________________________________________2010-01-14_2005-04-08_/
...
#endif
//_read_string______________________________________________________2005-04-08_/
...
(char *cstr,String_format format ,nat32 field_length)                 stream_IO_
{  std::string buffer;
...
//_read_c_str__________________________________________________________________/
