...
#define CS_UED_variable_code nat32
// UED::variable_code
...
{
   UED::Variable_code /*CS_UED_variable_code*/  code;
...
//_CS_output_variable_layout___________________________________________________/
class CropSyst_Variable_code_clad
: public UED::Variable_code_clad
{
public:
   CropSyst_Variable_code_clad(UED::Variable_code code_)
   :UED::Variable_code_clad(code_)
   {}
...
//_CropSyst_Variable_code_clad_________________________________________________/
extern CS_output_variable_layout CS_output_variables[];
extern void set_CS_output_variable_max_warning_range
   (UED::Variable_code/*190812 CS_UED_variable_code*/ code,float highest_value);
