...
: public extends_ Interpolation_abstract
{
 ...
 protected:
   ...
   //_Spline____________________________________________________________________
 public:
   inline Interpolation_spline_cubic
...
*/
 public:
   ...
   virtual float32 get_ordinate
      (float32 abscissa
      ,bool extrapolate_terminal = true)                                  const;
};
//_Interpolation_spline_cubic__________________________________________________/
