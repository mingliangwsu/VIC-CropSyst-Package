...
bool Directory_entry_name_concrete::is_qualified_relative()         affirmation_
{
   bool has_rel_path
      =  has_in_path_cstr("..",include_qualification_designated,false)
      || has_in_path_cstr("." ,include_qualification_designated,false);
   return has_rel_path;
}
//_if_qualified_relative____________________________________________2012-04-30_/
...
//_get_path_directory_name__________________________________________2012-02-06_/
...
//_Directory_entry_name_concrete____________________________________2012-03-20_/
Directory_entry_name_concrete::Directory_entry_name_concrete
...
//_Directory_entry_name_concrete____________________________________2012-04-30_/
Directory_entry_name_concrete::Directory_entry_name_concrete
(const char *raw_name
...
,qualified_path_provided(0)
{}
//_constructor______________________________________________________2012-02-02_/
Directory_entry_name_concrete::Directory_entry_name_concrete
...
,qualified_path_provided(0)
{}
//_Copy constructor_________________________________________________2012-03-09_/
Directory_entry_name_concrete::Directory_entry_name_concrete
...
,qualified_path_provided(0)
{}
//_Copy constructor_________________________________________________2012-03-25_/
Directory_entry_name_concrete::Directory_entry_name_concrete
...
{}
//_Directory_entry_name_concrete:constructor________________________2012-03-21_/
Directory_entry_name_concrete::Directory_entry_name_concrete
(nat16 CSIDL
...
#endif
//_constructor______________________________________________________2009-11-07_/
Directory_entry_name_concrete::Directory_entry_name_concrete
...
/*
   ...
   if (decomposed_name_includes & include_designator)
   {  designator_item = dynamic_cast<CORN::Text_list::Item *>(decomposed_name.pop_head());
...
//_Directory_entry_name_concrete____________________________________2013-11-07_/
Directory_entry_name_concrete::~Directory_entry_name_concrete()
{  delete qualified_path_provided; qualified_path_provided = 0;
}
...
//_set_wchar________________________________________________________2012-02-07_/
...
//_set_cstr_________________________________________________________2012-02-07_/
const Directory_entry_name & Directory_entry_name_concrete::replace_name
...
const Directory_entry_name & Directory_entry_name_concrete::replace_name_cstr
...
const Directory_entry_name & Directory_entry_name_concrete::replace_name_str
...
//_replace_extension________________________________________________2014-02-14_/
//NYI   virtual const Directory_entry_name & replace_extenstion_cstr(std::wstring *new_name) modification_;
//_replace_extenstion_cstr__________________________________________2014-02-14_/
