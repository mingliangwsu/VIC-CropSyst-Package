...
class Separate_crop_tally : public Association
{public:
...
//_Separate_crop_tally______________________________________________1998-07-21_/
class Tally_variable
: public Enumeration

, public CORN::statistical::Sample_dataset_clad<float32,float32,float32>
...
//_Tally_variable______________________________________________________________/
...
{public: // the following are not recorded
 ...
 public:
   Scenario_tally_data_record
      ...
      ,sint32 polygon_ID                                                         //050630
       // signed because negative values were used to indicate offsite values
...
//_Scenario_tally_data_record_______________________________________2005-05-05_/
class Avg_prob_map_tallier
...
//_Avg_prob_map_tallier________________________________________________________/
#endif
