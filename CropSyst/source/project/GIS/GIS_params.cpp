...
{}
//_GIS_Project_parameters:constructor_____________________________________1999_/
...
bool GIS_Project_parameters::setup_structure(Data_record &data_rec,bool for_write)
{
   data_rec.set_current_section(LABEL_GIS);
      ...
      data_rec.expect_bool(LABEL_donatelli,perform_donatelli_analysis,VV_bool_entry::form_true);
...
//_setup_structure__________________________________________________2005-02-02_/
#ifdef NYI_V4
050202 Not yet implemented in V4

void GIS_Project_parameters::setup_common_analysis_structures
(const char *template_simulation_filename)
{
...
#endif
//______________________________________________________________________________
const char *GIS_Project_parameters::get_relative_filename
(const char *filename,const char *ext) const
{
...
//_get_relative_filename____________________________________________2003-02-20_/
#endif
