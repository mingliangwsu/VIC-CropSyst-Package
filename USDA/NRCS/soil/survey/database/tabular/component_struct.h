...
struct Component_struct
{
   ...
   Component_kind_clad compkind;      // Kind 254
   ...
   USDA_NRCS::Capability_class_clad     nirrcapcl;  // Nirr LCC 254
   USDA_NRCS::Capability_subclass_clad  nirrcapscl; //  Nirr Subcl Choice No 254
   nat8 nirrcapunit;            // Nirr LCU  1 99
   USDA_NRCS::Capability_class_clad irrcapcl;    // Irr LCC 254
   USDA_NRCS::Capability_subclass_clad irrcapscl;// Irr Subcl Choice No 254
   ...
   Hydrologic_group_clad   hydgrp;        // Hydrologic Group   254
