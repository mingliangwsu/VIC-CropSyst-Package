...
: public extends_ CS::Cycler
{
 protected:                                                                      //160908
   ...
   //200524 CropSyst::Arguments arguments;                                                //160513
   CS::Arguments &arguments;                                                     //160513
   CropSyst::Scenario_directory scenario_directory;                              //200524
...
/*200817 obsolete never really used
...
*/
 ...
 public: // eventually may move stores to CS::Simulation_engine
   CS::Parameter_stores  &provide_stores();
...
//_Simulation_engine________________________________________________2015-10-08_/
}}//_name_CropSyst::V5_________________________________________________________/
#endif
