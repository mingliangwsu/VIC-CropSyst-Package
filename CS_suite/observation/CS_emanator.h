...
// Actually the Emanator could be named Context
// because it is now also used for adjustors
...
//_class_Emanator___________________________________________________2015-08-18_/
class Emanators
: public extends_ CORN::Enumeration_list // list of Emanators
{
 ...
 public:
   ...
   bool forget(nat32 emanator_ID)                                ; //cognition_;
      ...
      // which would be forget((nat32)this)
...
//_class_Emanators__________________________________________________2015-08-18_/
