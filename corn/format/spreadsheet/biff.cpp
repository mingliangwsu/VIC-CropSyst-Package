...
nat16 BIFF234_File::get_BOF_code() const {return BIFF578_CODE_BOF; }
nat16 BIFF234_File::get_EOF_code() const {return BIFF234578_CODE_EOF; }          //981016
/*
...
#define SUPERCLASS Spreadsheet_abstract
//______________________________________________________________________________
BIFF234_File::BIFF234_File(const char *filename_,std::ios_base::openmode openmode_)//111108
:SUPERCLASS(filename_,openmode_)                                                 //111108
...
//_constructor_reading______________________________________________2000-02-11_/
BIFF234_File::BIFF234_File
(const char *     filename_
,sint32 first_row  ,sint32 rows                                                  //090618
,int16 first_col   ,int16 cols
,BIFF_Format      BIFF_format_ )                                                 //090618
:SUPERCLASS(filename_,first_row,rows,first_col,cols)
   ,BIFF_format(BIFF_format_)                                                    //090618
   ,has_frozen_panes(false)                                                      //000307
   ,pane_left_most_column(0)                                                     //000307
   ,pane_top_most_row(0)                                                         //000307
...
//_constructor_writing_________________________________________________________/
void BIFF234_File::initialize()
{  /* derived classes may override this */
}
//_initialize_______________________________________________________1998-10-06_/
void BIFF234_File::write_end_of_document_records()
{
//NYI       PROTECT
//NYI       WINDOW PROTECT
//NYI       PASSWORD
...
//_write_end_of_document_records____________________________________1998-10-06_/
BIFF234_File::~BIFF234_File()
{  if (get_open_mode() && std::ios::out)                                         //990412
      write_end_of_document_records();                                           //000307
}
//______________________________________________________________________________
void BIFF234_File::write_cell_attributes
(nat8 attribute_0, nat8 attribute_1 , nat8 attribute_2)
...
//_write_cell_attributes_______________________________________________________/
void BIFF234_File::read_cell_attributes()
{
...
//_read_cell_attributes________________________________________________________/
/* Not yet implemented
...
*/
void BIFF234_File::write_dimensions
(sint32 first_row, sint32 rows                                                   //090618
,int16 first_col , int16 cols)
{
...
//_write_dimensions____________________________________________________________/
...
*/
//______________________________________________________________________________
void BIFF234_File::write_integer_cell
(int16 at_col
,int16 at_row
,int16 value)
{  SUPERCLASS::write_integer_cell(col,row,value);
...
void BIFF234_File::read_integer_cell(bool expect_header)
{  if (expect_header) read_rec_header();
   ...
   SUPERCLASS::read_integer_cell(expect_header);
}
//_read_integer_cell___________________________________________________________/
void BIFF234_File::write_number_cell
(int16   at_col
,int16   at_row
,float64 value
,int8    precision_decimals)                                                     //980917
{  SUPERCLASS::write_number_cell( col,  row,  value,precision_decimals);
...
void BIFF234_File::read_number_cell(bool expect_header)
{  if (expect_header) read_rec_header();
   row = read_nat16(); // perhaps unsigned
   col = read_nat16();
   read_cell_attributes();
   ...
   SUPERCLASS::read_number_cell(expect_header);
}
//_read_number_cell____________________________________________________________/
#ifdef NYI

I don't know how dates were stored in BIFF2, they couldnot have
been stored in an Integer cell because they were 16bit integers
and couldnot be number cells because probably not sufficent precision
...
//_write_date_cell__________________________________________________2010-01-16_/
#endif
//_____________________________________________________________________________/
void BIFF234_File::write_label_cell
(int16 at_col
,int16 at_row
,CSS_justifications justification_alignment
,const char *value)                                                              //030120
{  SUPERCLASS::write_label_cell(at_col,at_row,justification_alignment,value);
...
void BIFF234_File::read_label_cell(bool expect_header)
{   if (expect_header) read_rec_header();
    row = read_nat16(); // perhaps unsigned?
    col = read_nat16();
    read_cell_attributes();
    ...
    SUPERCLASS::read_label_cell(expect_header);
}
...
*/
//______________________________________________________________________________
void BIFF234_File::write_BOF_record()
{
...
//_write_BOF_record____________________________________________________________/
bool BIFF234_File::read_BOF_record()
{
   read_rec_header();
...
//_read_BOF_record_______________________________________2009-06-18_2000-03-07_/
void BIFF234_File::write_EOF_record()
...
//______________________________________________________________________________
#ifdef NYI
void BIFF234_File::write_1904_record(bool date_mode_1904)
{
   write_rec_header(BIFF234578_CODE_1904,2);
   write_nat16(date_mode_1904 ? 1 : 0);  // perhaps unsigned?
}
//_write_1904_record________________________________________________2010-01-16_/
#endif
/*
EXTERNNAME                  23h                         35d
...
*/
//______________________________________________________________________________
void BIFF234_File::write_col_width(int16 from_col, int16 to_col , int16 col_width_in_chars )
{
...
//_write_col_width__________________________________________________1998-10-06_/
/*
...
*/
//______________________________________________________________________________
void BIFF234_File::write_window1
...
//_write_window1____________________________________________________1998-10-06_/
void BIFF234_File::write_window2
...
//_write_window2____________________________________________________1998-10-06_/
/*
BACKUP                    40h                         64d
Record Type: BACKUP
...
*/
//______________________________________________________________________________
void BIFF234_File::freeze_pane(int16 left_most_column_, int16 top_most_row_)
{
...
//             Now we just have one pane.
               ...
               pane_left_most_column = left_most_column_;
               pane_top_most_row =top_most_row_;
               pane_active = 0; // lower right
//NYI             write_pane(1,1,top_most_row,left_most_column,0);  {Excel gives some data may be lost}
}
//_freeze_pane______________________________________________________1998-10-06_/
void BIFF234_File::write_pane()
{
...
//_write_pane_______________________________________________________1998-10-06_/
...
///////////////////////////////////////////////////////////////////////////////
//______________________________________________________________________________
int16 BIFF234_File::read_record()
...
Spreadsheet_abstract::Record_type BIFF234_File::read_next
(Spreadsheet_abstract::Record_type filter_type)
{  SUPERCLASS::Record_type rec_type = unknown_record;
...
//_read_next________________________________________________________1998-10-16_/
