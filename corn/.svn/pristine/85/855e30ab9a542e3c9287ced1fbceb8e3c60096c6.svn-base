...
//      virtual const Format *get_format()                                   const;//130217
   ...
   //_Array____________________________________________________________________/
   inline Object(const std::string &_key)
      ...
      {}
   #ifdef JSON_USES_DATAREC
   //_Object___________________________________________________________________/
   inline virtual bool is_key_string(const std::string &key)        affirmation_ //180820
      { return key == get_primary_section_name(); }
   //_is_key_string____________________________________________________________/
   #endif
 public:
...
//_Object___________________________________________________________2012-08-31_/
}//_namespace_CORN:JSON________________________________________________________/
#endif
