...
//_Storm_event_creation_layout_________________________________________________/
...
{public:
   Storm_event_data_record
      ...
      ,Units_code          storage_units          = UC_mm
      // This specifies the units the data is to be stored in
      //(primarily in the database,but could also be in memory).
      ,Units_code          interval_time_length   = UT_30_minutes
      // Interval time step
      ,CORN::Quality_code  default_attribute_code = CORN::generated_quality);
...
//_Storm_event_data_record_____________________________________________________/
#endif
