...
class Directory_record // saved in .directory or desktop.ini file  section [context]
: public extends_ CORN::Data_record
{
 public:
   // now use context definition std::string contextX;
   CORN::OS::Directory_name_concrete context_definition;
      // path of Explorer context definition directory
 public:
...
class Contextualization
{
 ...
 public:
/*190809 obsolete, now using context definitions
