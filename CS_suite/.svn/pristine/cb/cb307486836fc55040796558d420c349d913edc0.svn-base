...
{}
//_Application_directory:constructor______________________________constructor__/
Application_directory::Application_directory
...
{}
//_Application_directory:constructor________________________________2014-10-10_/
Application_directory::Application_directory
...
{}
//_Application_directory:constructor________________________________2014-10-10_/
const CS::Suite_Directory &Application_directory::provide_CS_Suite_directory() provision_
...
//_provide_CS_Suite_directory__________________________________________________/
}; // namespace CS
