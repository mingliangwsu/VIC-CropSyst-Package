...
*/
 ...
 public: // For scenario output context
   ...
   bool output_generate_daily_report()                                    const; //181029
   CORN::OS::File_name *output_generate_custom_report                            //181018
      (const std::string &TDF_filename
      ,const std::string &target_filetype                                        //190213
      ,const std::string &target_interface)                               const; //190213
   bool UED_dump_selected_UED
...
*/
   ...
   virtual bool setup_context_in
      (const CORN::OS::Directory_name &in_dirname
      ,nat16 context_type_index)                                          const; //190818
 public:
