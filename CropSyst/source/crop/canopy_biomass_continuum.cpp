...
//_Canopy_biomass_continuum_abstract:constructor_______________________________/
...
//_remove_yield_____________________________________________________2010-08-27_/
...
//_remove_yield_____________________________________________________2011-03-31_/
...
{}
//_Canopy_biomass_continuum_reference:constructor______________________________/
...
{}
//_Canopy_biomass_continuum_actual:constructor_________________________________/
float64 Canopy_biomass_continuum_abstract::grow_potential()        modification_
{  float64 gain = 0.0;

   float64 RUE_PAR = g_to_kg(biomass_parameters.RUE_PAR);/*per MJ*/
   ...
   float64 CO2_RUE_adjustment= CO2_response? CO2_response->actual_biomass_gain_ratio_in_response_to_CO2_RUE : 1.0; // CropState.CO2AdjustmentToRUE(TimeState.DaysAfterPlanting)
   ...
   float64 PAR_intercepted_fraction = canopy->get_interception_PAR_green() ;
   ...
   if (!phenology->is_mature())
   {
      ...
      if (CORN::is_zero<float64>(daytime_VPD,0.00001))                           //200127_101028 added by RLN for debugging
         return 0.0;
...
//grow_potential_______________________________________________________________/
...
//_Canopy_biomass_continuum_actual::CalculatePotentialGrowth___________________/
...
//_calc_water_limited_growth___________________________________________________/
...
//_grow_actual_________________________________________________________________/
...
//_start_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _/
...
//_start_season_____________________________________________________2011-06-17_/
...
//_start_dormancy___________________________________________________2011-04-05_/
...
//_start_dormancy___________________________________________________2001-04-05_/
...
//_respond_to_clipping______________________________________________2004_04-21_/
