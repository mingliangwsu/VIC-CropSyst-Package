...
protected:
   ...
   inline virtual bool convert_rain_to_snow(float64 air_temperature) 
      { return air_temperature  < get_rain_to_snow_temperature();}
 ...
 public:
   ...
   inline virtual float64 get_curr_snow_water_equivelent_depth()          const 
                                       { return liquid_water_m + ice_water_m; }
...
private:
   ...
   virtual float64 snow_melt(float64 average_air_temperature,float64 rain      
      , Seconds timestep = Seconds_per_day); //150125
...
//_Snow_pack_energy_based_____________________________________________________/
#endif
// snow.h
