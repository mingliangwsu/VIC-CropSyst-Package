...
private:
   ...
   mutable CORN::Bidirectional_list known_NCDC_stations;  // This is a list of all known NCDC weather stations so we can create location records.
   mutable CORN::Bidirectional_list known_WBAN_stations;  // This is a list of all known NCDC weather stations so we can create location records.
   mutable CORN::Bidirectional_list known_UCAR_stations;  //
...
public:
   ...
   Region_type list_regions(Reporting_agency agency, CORN::SDF_Cowl &regions) const;
...
public:
   bool load_NCDC_WBAN_stations(CORN::Bidirectional_list &locations,bool WBAN_mode);
