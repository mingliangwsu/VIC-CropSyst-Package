...
QMAKE_CFLAGS += -Wno-reorder -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-parameter
DEFINES += \
    CS_VERSION=5 \
    CROPSYST_VERSION=5 \
    ...
    xMECHANISTIC_IRRIGATION \
    xMECHANISTIC_RUNOFF_TRUE \
    ...
    ONE_SNOWBAND_FOR_CROP \
    xNOT_PRINT_CROP_DAILY_OUTPUTS \
    INPUT_24HR_AVG_SOLAR_RADIATION \
    IRRIG_PARAMETERFILE_DECIDE_IRRIGATION \
    OLD_PROVIDE_CANOPY \
    xDUMP_TO_STREAM_BUFFER_AT_FIRST_FOR_OUTPUT \
    xCONST_SOIL_MIDDLE_LAYER_DEPTH \
    xPRINT_SOM_FOR_DEBUG \
    MAD_FOR_NETIRRIGATION_DEMAND=0.2 \
    xCROP_DAILY_OUTPUT_MEMFIRST \
    POSTPONE_FIRST_IRRIGATION_PERENNIAL_CROPS \
    FULL_IRRIGATION \
    xOUTPUT_FULLIRRIGATION_PATTERN \
    xOUTPUT_SIMPLE_FOR_FORECAST \
    xENABLE_IRRIGATION_CANOPY_INTERCEPTION \
    xDEBUG_SOIL_PROPERTY \
    KEEP_VIC_Q12 \
    WATER_STRESS_TOLERANCE_FOR_IRRIGATION=1.0 \
    xNO_REDISTRIBUTE_MOISTURE_OVER_IRRIGATION_FIELD_INSTANTLY
...
unix:!macx: LIBS += -L$$PWD/../../../../UED/library/build/Qt/UED_static/Debug/ -lUED_static

INCLUDEPATH += $$PWD/../../../../UED/library/build/Qt/UED_static/Debug
DEPENDPATH += $$PWD/../../../../UED/library/build/Qt/UED_static/Debug

unix:!macx: PRE_TARGETDEPS += $$PWD/../../../../UED/library/build/Qt/UED_static/Debug/libUED_static.a

unix:!macx: LIBS += -L$$PWD/../../../../common/weather/build/Qt/weather_static/bin/debug -lweather_static

INCLUDEPATH += $$PWD/../../../../common/weather/build/Qt/weather_static/bin/debug
DEPENDPATH += $$PWD/../../../../common/weather/build/Qt/weather_static/bin/debug

unix:!macx: PRE_TARGETDEPS += $$PWD/../../../../common/weather/build/Qt/weather_static/bin/debug/libweather_static.a
