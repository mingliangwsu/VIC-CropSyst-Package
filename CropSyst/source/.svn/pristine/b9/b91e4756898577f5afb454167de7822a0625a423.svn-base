...
namespace CropSyst
{
   static const float64 CO2_conc_at_saturated_photosynthesis = 1100.0;
      //Atmospheric CO2 Concentration at Saturated Photosynthesis
...
//_Crop_CO2_response:constructor_______________________________________________/
...
//_calc_canopy_conductance_at__________________________________________________/
