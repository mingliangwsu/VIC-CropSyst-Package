...
: public extends_interface_ Physical::Mass
{
   ...
   inline virtual float64 get_carbon_organic_cycling_kg
      (Organic_matter_cycling cycling)                                     const //150629RLN
      { UNUSED_arg(cycling);
   ...
   inline virtual float64 get_phosphorus_inorganic_kg()                    const //150508
      { return get_phosphorus_total_kg()
        * (1.0 - get_phosphorus_organic_fraction()); }
  ...
  // arithmetic
   ...
   virtual bool deduct_decomposition
         ...
         ,Organic_matter_cycling cycling = OM_SINGLE_CYCLING)      modification_
         { assert(false); return false; }                                        //150704RLN
         // specialization must override
...
//_Biomass__________________________________________________________2006-03-16_/
#endif
