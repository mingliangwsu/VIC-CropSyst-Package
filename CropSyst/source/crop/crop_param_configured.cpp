...
//#ifdef TEMP_DISABLED
   ...
   */
   ...
   assert(false);
   /*200218 These have been renamed NEED TO REIMPLEMENT!
   ...
   */
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.cover_initial                   ,"canopy/cover/initial"             ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.cover_maximum_no_CO2_adj        ,"canopy/cover/maximum/no_CO2_adj"  ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.cover_maximum_CO2_adj           ,"canopy/cover/maximum/CO2_adj"     ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.cover_total_season_end          ,"canopy/cover/season_end"    ,POT_ADJUSTABLE,POT_OBSERVABLE));
   //190605 parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.mature_total_cover              ,"canopy/cover/mature/total"              ,POT_ADJUSTABLE,POT_OBSERVABLE));
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.canopy_growth_cover_based.thermal_time_fractional_at_half_cover_max  ,"canopy/growth/cover_based/fract_season_to_reach_cover_max_half"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   ...
   */
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.phenology.initiation.tuberization                   ,"phenology/tuber/initiation"       ,NOT_ADJUSTABLE,    OBSERVABLE));
   ...
   //200125 obsolete parameter_associations.append(new CS::Parameter_association_numeric(parameters.phenology.initiation.senescence                     ,"phenology/senescence/initiation"  ,NOT_ADJUSTABLE,    OBSERVABLE));
   ...
   */
   //200125 obsolete parameter_associations.append(new CS::Parameter_association_numeric(parameters.phenology.culmination.senescence                    ,"phenology/senescence/culmination" ,NOT_ADJUSTABLE,    OBSERVABLE));
   assert(false);
   /*200218 reimplement???
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.phenology.culmination.root_elongation               ,"phenology/root_elongation/culmination" ,NOT_ADJUSTABLE,    OBSERVABLE));
   */
...
*/
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.thermal_time.temperature.base   /*190605 base_temperature*/        ,"ecophysiology/thermal_time/threshold/base"     ,ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.thermal_time.temperature.cutoff /*190605 cutoff_temperature*/      ,"ecophysiology/thermal_time/threshold/cutoff"   ,ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.thermal_time.temperature.opt    /*190605 opt_temperature*/         ,"ecophysiology/thermal_time/threshold/optimal"  ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.thermal_time.temperature.max    /*190605 max_temperature*/         ,"ecophysiology/thermal_time/threshold/maximum"  ,POT_ADJUSTABLE,POT_OBSERVABLE));
...
//200125 obsolete    parameter_associations.append(new CS::Parameter_association_numeric(parameters.root.initial_depth_deprecated                   ,"root/depth/initial"               ,    ADJUSTABLE,POT_OBSERVABLE));
...
// duplicate but should be here   parameter_associations.append(new CS::Parameter_association_bool   (parameters.tolerance.enabled                          ,"ecophysiology/tolerance/temperature/enabled"));
   ...
   // 170524obs parameter_associations.append(new CS::Parameter_association_numeric(parameters.tolerance.salvageable_deg_day              ,"ecophysiology/tolerance/temperature/cold/yield/salvageable" ,POT_ADJUSTABLE,POT_OBSERVABLE));
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.layout.spacing.row                               ,"layout/spacing/row"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.layout.spacing.col                               ,"layout/spacing/col"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   ...
   */
   ...
   parameter_associations.append(new CS::Parameter_association_enum   (parameters.residue_decomposition.RUSLE2_type_clad /*NYI as cowl*/                  ,"residue/RUSLE2_type"));
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.residue_decomposition.halflife_obsolete               ,"residue/decomposition/halflife"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   ...
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.residue_decomposition.fast_cycling_halflife,"residue/decomposition/halflife/fast_cycling"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.residue_decomposition.slow_cycling_halflife,"residue/decomposition/halflife/slow_cycling"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
   parameter_associations.append(new CS::Parameter_association_numeric(parameters.residue_decomposition.lignified_halflife,"residue/decomposition/halflife/lignified"               ,POT_ADJUSTABLE,POT_OBSERVABLE));
...
{
   parameter_pertinencies.take(new CS::Document_configured::Parameter_pertinence("biomass/production/continuous_cultivation_impact"                 ,parameters.life_cycle_clad,perennial_life_cycle));
...
//NYI   initial_growth_radiogroup->Visible  = CROPSYST_FRUIT;
   ...
   bool crop_was_edited_using_old_HI =!CORN::is_zero<float32>(crop->harvest.filling_sensitivity);
   ...
   bool use_new_temperature_limitation =                                         //130513
      CORN::is_zero<float32>(crop->biomass_production.early_growth_limit_temp,);//130513
...
//_initialize_parameter_essentials_____________________________________________/
