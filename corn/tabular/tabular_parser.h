...
//200220 check if this is obsolete or can be reimplemented
...
class Tabular_file_format/*200220 Common_tabular_file__format*/;
...
public:
   ...
   //___________________________________________________________________________
protected:
   const Tabular_file_format/*200220 Common_tabular_file__format*/ &format;
protected:
   CORN::Text_list         parsing_errors;
public:
   Tabular_parser(const Tabular_file_format/*200220 Common_tabular_file__format*/ &format);
   virtual bool read
