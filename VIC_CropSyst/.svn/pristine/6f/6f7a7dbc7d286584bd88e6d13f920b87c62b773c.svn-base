...
void write_vegparam(const veg_con_struct *veg_con)
/**********************************************************************
...
**********************************************************************/
{
  ...
  for (int i = 0; i < veg_con[0].vegetat_type_num; i++) {
    int vegclass = veg_con[i].veg_class;
