...
{  // This instanciation of the event scheduler has overall
 ...
 protected:                                                                      //200815
   CS::Arguments &arguments;                                                     //200815
   // Reference to main instantiation
/*200815 use arguments.start_directory
 protected:
...
*/
 ...
 protected:
   ...
   Alteration *alteration;
      // on simulation element composite elements list, but we retain reference.
 protected:
...
/*200815
 public:
   //200317 now use CORN::global_arguments nat8 verbosity;                                                               //170211
...
*/
 ...
 public:
   ...
   //200815 (Command_options_data_source &command_line_options_data_source);     //160826
 ...
 public: // accessor
   ...
   Context_discovery         &provide_context_discovery()            provision_; //170627
 ...
 protected:
   inline virtual const CORN::OS::Directory_name
      ...
      { return arguments.start_directory; }                                      //200815
      //200815{ return CWD; }
...
*/
   ...
   nat32 discover_TDF_and_optate()                                             ; //190119
