...
, p_compptc
   (
       (comppct.low,PP_comppct_l,PPR_comppct,PPF_8_0_10)
      ,(comppct.repr,PP_comppct_r,PPR_comppct,PPF_8_0_10)
      ,(comppct.high,PP_comppct_h,PPR_comppct,PPF_8_0_10)
   )
*/
...
//_Component:constructor_______________________________________________________/
bool Component_record::expect_structure(bool for_write)
{
