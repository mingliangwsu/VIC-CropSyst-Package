...
, interpolation                                                              (0)
, observations                                        (-99999,default_ordinate_)
{
...
//_get_ordinate_by_date_____________________________________________2015-01-11_/
...
{  bool was_set = true;
   ...
   {  float32 day_abscissa = reference_date->days_between(
         for_date,false);
      observations.append_coordinate(day_abscissa,ordinate);                     //190507
   } else was_set = false;
   return was_set;
}
//_set_by_date______________________________________________________2015-01-11_/
bool Interpolator_temporal::set_reference_date
(const Date_const &reference_date_)                                contribution_
{  delete reference_date;                                                        //190507
   reference_date = new CORN::Date_clad_32(reference_date_.get_date32());        //170524
   return true;
}
//_set_reference_date_______________________________________________2015-03-10_/
