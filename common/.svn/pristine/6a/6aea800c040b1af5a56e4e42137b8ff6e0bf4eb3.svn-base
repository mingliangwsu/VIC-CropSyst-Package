...
DECLARE_ENUM_CLAD(Simulation_run_result_clad,Simulation_run_result,simulation_run_result_label_table)
//190113 DECLARE_LABELED_ENUM(Simulation_run_result_labeled,Simulation_run_result,simulation_run_result_label_table)
//______________________________________________________________________________
