...
//_get_freezing_depth_______________________________________________1999-01-20_/
...
//_get_ultimate_freezing_depth______________________________________1998-10-15_/
bool soil_freezing_profile_numerical::is_frozen(nat8  sublayer)            const
{  return get_ice_content(sublayer) > 0.0;
};
//_is_frozen________________________________________________________1999-01-20_/
...
{  float32 ice_content_new = 0.0;
   ...
   return CORN::must_be_0_or_greater<float64>(ice_content_new);
};
//_find_ice_content_________________________________________________1999-02-15_/
#endif
