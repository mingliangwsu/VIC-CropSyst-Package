...
{}
//_Common_scenario_directory:constructor_______________________________________/
Common_scenario_directory::~Common_scenario_directory()
{  reset();
}
//_Common_scenario_directory:destructor_____________________________2012-02-07_/
...
//_purge_output_____________________________________________________2005-03-25_/
...
{  if (!scenarios_directory)
   {
      ...
      CORN::OS::Directory_name *scenarios_dir_name =
         CORN::OS::file_system_engine.find_qualified_name_in_path
            (scenarios_name,*this);
         /*200426
         find_directory_name_in_path
...
//_Scenarios________________________________________________________2012-02-07_/
