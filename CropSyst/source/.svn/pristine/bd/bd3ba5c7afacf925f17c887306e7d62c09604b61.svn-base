...
public:
   ...
   soil_horizon_parameter_array(p_NH4_Langmuir_K); // kg water/kg solute         //190402
   soil_horizon_parameter_array(p_NH4_Langmuir_Q); // kg solute/kg soil          //190402
public:
   Soil_parameters();
   virtual ~Soil_parameters();                                                   //141228
   virtual bool expect_structure(bool for_write = false);                        //161025_981103
};
//_class Soil_parameters_______________________________________________________/
#endif
