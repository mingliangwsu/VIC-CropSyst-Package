...
//_Vapor_pressure_night_time_parameters_____________________________2009-12-10_/
...
//_Solar_radiation_parameters_______________________________________2009-12-14_/
...
//_Relative_humidity_extremes_______________________________________2009-12-16_/
...
#define        LADSS_loc_ID station_number
   ...
   LOC_ET_Model_clad        ET_model_clad_V3;  // This is being moved to simulation scenario  (But need to keep for V3 and ClimGen //020318
   ...
   Wind_speed_classification_clad      wind_speed_classification_clad;     //970723
...
public: // CropSyst/ClimGen parameters
   ...
   inline ET_Model get_ET_model_V3()                                      const  {return ET_model_clad_V3.get(); }//020318
#endif
#if ((CS_VERSION>0) && (CS_VERSION<5))
//#ifdef SUPPORT_OBSOLETE_LOC_FILE
...
//_Location_parameters______________________________________________2001-01-09_/
#endif
