...
{public:
   ...
   //_Print_operation________________________________________________2005-12-01_/
 public:
...
//_profile_print_event_______________________________________________1999-11-22_/
#ifdef MANAGEMENT
