...
public:
   Property_cowl                                                                 //150120
      ...
      , units_ref     (units_)
      {}
      //_Property_cowl:constructor__________________________________2015-01-20_/
   ...
   //_reset_value_and_units____________________________________________________/
   ...
   //_update_value_with_units_______________________________________2015-03-16_/
   ...
   //_get_with_units________________________________________________2010-09-30_/
   ...
   //_get_in_units__________________________________________________2010-09-30_/
   ...
   inline virtual float64 &ref_in_prescribed_units()                       const
                                            { return (float64 &)(*amount_ptr); } //190812

   virtual float64 update_amount_in_preset_units(float64 new_amount) rectification_
                                              { return set_amount(new_amount); } //150122
 ...
 protected:
   ...
   virtual float64 set_amount(float64 new_amount)                 rectification_
                                            { return force_amount(new_amount); } //150122
...
//_Property_cowl____________________________________________________2011-08-18_/
