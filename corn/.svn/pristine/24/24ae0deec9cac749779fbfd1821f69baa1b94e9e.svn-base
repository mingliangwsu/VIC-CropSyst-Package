...
#else
// this may be DOS/Windows specific, so the ifdef would be if not __MSDOS__
...
//_CPU_is_big_endian________________________________________________2001-06-08_/
Binary_fstream::~Binary_fstream()
{  delete [] file_name;
   file_name = 0;
}
//_Binary_fstream:destructor________________________________________2002-01-25_/
bool Binary_fstream::goto_EOF() performs_IO_ { return STRM seekg(0,std::istream::end) == 0;}
Binary_fstream::Binary_fstream
(const char *_file_name                                                          //001206
,bool        _big_endian)
   // Most MS-DOS or Windows base files are not big_endian
...
//_endian_correction________________________________________________1999-01-07_/
int32 Binary_fstream::write_int32(int32 value)
{  CORN_endian_correction_32(value);                                             //000129
   STRM write((char *)(&value),sizeof(int32));
   return value;
}
//_write_int32______________________________________________________1999-01-07_/
nat32 Binary_fstream::write_nat32(nat32 value)
{  CORN_endian_correction_32(value);                                             //000129
   STRM write((char *)(&value),sizeof(nat32));
   return value;
}
//_write_nat32______________________________________________________1999-01-07_/
...
//_write_float64____________________________________________________1999-01-07_/
...
//_read_float64_____________________________________________________1999-01-07_/
...
//_write_int16______________________________________________________1999-01-07_/
...
//_read_int16_______________________________________________________1999-01-07_/
...
//_read_nat16_______________________________________________________1999-01-07_/
const char *Binary_fstream::write_ASCIx
(const char *str,String_format format ,nat32 field_length)
{
/*
...
*/
   ...
   {  case DT_nat8 :  {  nat8 act_len = (str_length>(nat32)  255)   ? (nat8)    255  : (nat8)str_length; write_nat8 (act_len); str_length=act_len; remaining_field_length-=1;} break;
      ...
      default : break; // no need to adjust string length because we are not limiting the field size
   }
   ...
   } else if (null_terminate) write_nat8(0); // null terminator
   return str;
}
//_write_ASCIx______________________________________________________2005-04-08_/
const char *Binary_fstream::read_ASCIx
(char *str,String_format format ,nat32 field_length)
{
/*
...
//_read_ASCIx_______________________________________________________2005-04-08_/
///////////////////////////////////////////////////////////////////
...
//_write_cstr_______________________________________________________1999-01-03_/
const char * Binary_fstream::read_cstr
(char *cstr,nat16 max_string_length , bool null_terminated )
{  nat32 pos = 0;                                                                //050110
   bool at_eos = false;
...
//_read_cstr________________________________________________________1999-01-03_/
