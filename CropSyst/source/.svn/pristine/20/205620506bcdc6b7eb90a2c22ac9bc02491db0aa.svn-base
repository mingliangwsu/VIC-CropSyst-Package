...
,Soil::Soil_interface      *_soil                                                //050721
,Soil::Nitrogen            *_chemicals                                           //050721
...
: Crop_nitrogen_common
   ...
   ,slope_saturated_vapor_pressure_plus_psychrometric_resistance_reference_)     //150601
,slope_VPsat_plus_psychrometric_resistance_stressed(0)                           //150601
,slope_VPsat_plus_psychrometric_resistance_reference
   (slope_saturated_vapor_pressure_plus_psychrometric_resistance_reference_)     //180805
{
   if (slope_VPsat_plus_psychrometric_resistance_reference)                      //150601
   slope_VPsat_plus_psychrometric_resistance_stressed
      = new Slope_saturated_vapor_pressure_plus_psychrometric_resistance
      (*slope_VPsat_plus_psychrometric_resistance_reference);
}
//_Crop_nitrogen_V4:constructor________________________________________________/
Crop_nitrogen_V4::~Crop_nitrogen_V4()
{
   delete slope_VPsat_plus_psychrometric_resistance_stressed;                    //150601
}
//_Crop_nitrogen_V4:destructor_________________________________________________/
...
//_start_season________________________________________________________________/
bool Crop_nitrogen_V4::start_day()
{
   ...
   float64 corrected_N_stress = is_zero(N_stress,0.000001)                       //040714
   ...
   if (slope_VPsat_plus_psychrometric_resistance_stressed)
       slope_VPsat_plus_psychrometric_resistance_stressed->update();             //150602
   }
   return started;
}
//_start_day________________________________________________________2015-10-29_/
...
//deprecated121219
   ...
   {  param_N_max_conc_emerge = N_max_conc_at_emergence_species
         [crop_parameters.photosynthetic_pathway_clad.get()];                    //120427
...
float64 Crop_nitrogen_V4::update_limited_pot_transpiration()       modification_
{
   ...
   if (slope_VPsat_plus_psychrometric_resistance_reference)
   {  normal_vapor_pressure_plus_resistance
         = slope_VPsat_plus_psychrometric_resistance_reference->get_kPa_per_C(); //150601
      stressed_vapor_pressure_plus_resistance
         = slope_VPsat_plus_psychrometric_resistance_stressed ->get_kPa_per_C(); //150601
   }
   float64 transp_correction_factor
      =   normal_vapor_pressure_plus_resistance
      / stressed_vapor_pressure_plus_resistance;
   float64 N_limited_transp
      =  crop.pot_transpiration_m_CO2_adj                                        //190826
         * transp_correction_factor;                                             //151031
   return N_limited_transp;
}
//_update_limited_pot_transpiration_________________________________2001-11-17_/
#if (CROPSYST_VERSION==4)
...
#endif
//_know_start_flowering_____________________________________________2007-01-26_/
...
,float64 root_activity_factor)                                     modification_ //080728
{
   ...
   if (!(automatic_nitrogen_to_plant                                             //160329_020719
         || CORN::is_zero<float64>(crop.get_attainable_top_growth())))
   {  if (CORN::is_approximately<float64>
         (act_to_pot_transpiration_ratio,1.0,0.0001)) //020719
...
//_calc_limited_growth______________________________________________2001-10-22_/
} // This NS is temporary to see if Crop_nitrogen_V4 is still used DELETE THIS NS
