...
public:
   inline CPF_Irrigation_event
      ...
      , amount       (_amount)
      {}
   //190718 obs inline virtual const char *label_cstr_deprecated(char *buffer)          const { return buffer;}
...
//_Crop_production_function_simulation______________________________2015-04-19_/
