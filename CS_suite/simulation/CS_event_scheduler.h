...
//, public extends_ Simulation_element //_composite
{
 public:
   ...
   //_Performable_operation_________________________________________2015-01-03_/
 protected:
 ...
 protected:
   virtual bool legacy_schedule()                                 modification_; //200421
 public:
...
protected: // The following methods may be be overridden by derived classes.
   inline virtual bool end_operation_period
      (Common_operation &//op
      , const CORN::Date_const &date_period_ends)                 modification_
      {  /*UNUSED_arg(op);*/ UNUSED_arg(date_period_ends);
         return true; }
...
{protected:
 ...
 protected: // The following methods must be overridden by derived classes.
   inline virtual Event_status_indicator perform_operation
      ...
      {  UNUSED_arg(op); UNUSED_arg(associated_with_obj);
         return ES_COMPLETE; }                                                    //150627
