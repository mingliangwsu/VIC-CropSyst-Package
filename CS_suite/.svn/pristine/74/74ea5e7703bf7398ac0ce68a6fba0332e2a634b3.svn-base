...
#include <tchar.h>
//---------------------------------------------------------------------------
USEFORM("..\..\frame_context_scenario_output.cpp", frame_scenario_output); /* TFrame: File Type */
USEFORM("..\..\frame_context_scenario.cpp", frame_scenario); /* TFrame: File Type */
USEFORM("..\..\..\..\GUI\explorer\frame_navigation_JAM.cpp", navigation_frame); /* TFrame: File Type */
USEFORM("..\..\V5\frame_CS_context_functions.cpp", frame_CS_context); /* TFrame: File Type */
...
USEFORM("..\..\frame_context_meteorology.cpp", frame_meteorology_context); /* TFrame: File Type */
USEFORM("..\..\frame_options_scenario_run.cpp", frame_scenario_run_options); /* TFrame: File Type */
USEFORM("..\..\..\..\GUI\explorer\frame_instanciation.cpp", FrameInstantiation); /* TFrame: File Type */
//---------------------------------------------------------------------------
