...
interface_ Structure
{
 ...
 // bulk density
   ...
   virtual float64 set_bulk_density_g_cm3(nat8 layer,float64 bulk_density_g_cm3)=0;
   virtual float64 get_bulk_density_kg_m3(nat8 layer)                     const; //050727
   virtual float64 set_bulk_density_kg_m3(nat8 layer,float64 bulk_density_kg_cm3); //150411
   virtual float64 set_bulk_density_Mg_m3(nat8 layer,float64 bulk_density_Mg_m3);
      // Equivelent to set_bulk_density_g_cm3//070726_
   virtual float64 get_bulk_density_Mg_m3(nat8 layer)                     const;
      // equivelent to get_bulk_density_g_cm3 //051204_
 // values for the entire profile
   virtual float64 get_bulk_density_avg_g_cm3()                         const=0; //051204
...
//_Structure___________________________________________________________________/
