// This is obsolete deprecated 200204
...
//_Valid_type__________________________________________________________________/
...
{public:
 ...
 public:
   ...
   inline Valid_number(const Valid_number &from)
      :Valid_type(from)
      ,nat8_decimals(from.nat8_decimals)
...
//_Valid_number________________________________________________________________/
...
//_Valid_float64____________________________________________________1998-04-03_/
...
//_Valid_float32____________________________________________________1998-04-03_/
...
//_Valid_int16_________________________________________________________________/
...
{public:
 ...
 public:
   ...
   inline virtual Validation_status validate                                     //980401
      (char *message_text                                                        //020129
      ,bool HTML_format)
      {  return Valid_number::validate_value(message_text,HTML_format,(float64)value);
      }
   virtual const char *get_value_c_str()                                  const; //020812
};
//_Valid_int32_________________________________________________________________/
