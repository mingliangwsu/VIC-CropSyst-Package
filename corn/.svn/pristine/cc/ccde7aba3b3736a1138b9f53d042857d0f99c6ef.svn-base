...
Bidirectional_list::Iterator::Iterator(Bidirectional_list &container_)
: Unidirectional_list::Iterator(container_)
{}
...
{  Bidirectional_list::Node *detach_node =
   ...
   {  detached_item = detach_node->get();
      ...
      if (next_node) next_node->prev = prev_node;                                //180418
      curr_node = prev_node;
...
{
   Item *appropriatable_element = delete_unappropriatable(new_element);          //161024
   if (appropriatable_element)                                                   //161024
   {
...
//_write____________________________________________________________2015-07-28_/
