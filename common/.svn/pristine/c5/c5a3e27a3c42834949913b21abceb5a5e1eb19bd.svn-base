...
{  // ET solar rad should be a member
 protected:
   const CS::Solar_radiation_extraterrestrial &ET_solar_radiation_new;           //150626
 ...
 protected:  friend class Soil::Temperature_profile_hourly; // temporary
 public:
...
public:
   ...
   inline virtual float64 get_cloud_cover_fraction()                     const 
                                           { return curr_cloud_cover_fraction;}  //991022
   inline virtual const CORN::Quality  &get_cloud_cover_quality()        const 
                                                 { return cloud_cover_quality;}  //991012
};
//_Sky_________________________________________________________________________/
#endif
