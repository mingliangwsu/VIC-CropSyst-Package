...
{  // one for each crop
   ...
   , public extends_ CS::Simulation_element_abstract
   {
    ...
    public:
      ...
      virtual bool has_leaf_senescence()                            affirmation_
                               { return crop_parameters.has_leaf_senescence(); }
      virtual bool has_maturity()                                   affirmation_
                      { return crop_parameters.phenology.maturity_significant; }
   };
   //_Crop______________________________________________________________________
 public:
...
//   ::Weather&                    weather;
 ...
 public:
   CORN::statistical::Sample_cumulative<nat16,float64> *start_day_in_season_stats[NGS_COUNT];
   CORN::statistical::Sample_cumulative<nat16,float64> *start_deg_days_stats[NGS_COUNT];
   CORN::statistical::Sample_cumulative<nat16,float64> *start_day_in_season_stats_senescence; //160211
   CORN::statistical::Sample_cumulative<nat16,float64> *start_deg_days_stats_senescence; //160211
   CORN::statistical::Sample_cumulative<nat16,float64> *start_day_in_season_stats_senescence_full;//160211
   CORN::statistical::Sample_cumulative<nat16,float64> *start_deg_days_stats_senescence_full;//160211
 protected:
   Crop *crop_current;
 public:
 ...
 public:
   bool commit_computed_phenology_parameters
      (modifiable_ CropSyst::Crop_parameters_struct::Phenology &phenology_parameters) const;
 protected:
   //190718 obs virtual const char *label_cstr_deprecated(char *buffer)                const; //170423 deprecated
...
//_Phenology_adjustor_____________________________________________________________________________
#ifdef OFOOT_VERSION
...
#endif
//_Phenology_adjustors_____________________________________________________________________________
