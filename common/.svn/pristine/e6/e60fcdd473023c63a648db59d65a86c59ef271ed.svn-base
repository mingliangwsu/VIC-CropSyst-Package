...
,sync_mode_clad(RELATIVE_TO_SIMULATION_EVENT_MODE)
,simulation_event_clad(sim_event)                                                //030627
#if ((CS_VERSION > 0) && (CS_VERSION <= 3))
,sync_labeled_V3(V3_NOSYNC)
#endif
,reschedule_mode_clad(NO_RESCHEDULE)                                             //060413
{}
//_Synchronization:constructor______________________________________2003-06-05_/
Synchronization::Synchronization
(Normal_crop_event_sequence normal_crop_event_sequence                           //130425
,CORN::Days offset_days)
: CORN::Date_clad_32                                                         (0) //170525
,days_offset                                                ((int16)offset_days)
,thermal_time                                                                (0) //010716
,normal_crop_event_sequence_clad                    (normal_crop_event_sequence) //130425
,sync_mode_clad                            (AFTER_NORMAL_CROP_GROWTH_STAGE_MODE) //030609
#if ((CS_VERSION > 0) && (CS_VERSION <= 3))
,sync_labeled_V3                                                     (V3_NOSYNC) //030606
#endif
,reschedule_mode_clad                                            (NO_RESCHEDULE) //060413
{}
//_Synchronization:constructor______________________________________1999-11-22_/
...
,sync_mode_clad(mode)
#if ((CS_VERSION > 0) && (CS_VERSION <= 3))
,sync_clad_V3(V3_NOSYNC)
#endif
,reschedule_mode_clad(NO_RESCHEDULE)                                             //060413
{}
// This constructor is used to create a synchronization type (for searches)
//_Synchronization:constructor______________________________________2003-06-09_/
...
#endif
,reschedule_mode_clad(NO_RESCHEDULE)                                             //060413
,simulation_event_clad(sync_to_sim_event)
{}
// This constructor is used to create a synchronization relative to simulation event
//_Synchronization:constructor______________________________________2003-06-09_/
CORN::datetime64 Synchronization::set(const CORN::Temporal &new_date) assignation_//170524
{  sync_mode_clad.set(ACTUAL_DATE_MODE);
   return CORN::Date_clad_32::set(new_date);                                     //170525
}
//_set__________________________________________________2003-10-25__1999-03-17_/
...
,  0};
//_synchronizations_V3_label_table__________________________________2003-06-06_/
...
#endif
//_synchronizations_V3_strings_________________________________________________/
...
#endif
//_reschedule_label_table___________________________________________2006-04-13_/
...
{  Synchronization_mode sync_mode = sync_mode_clad.get();
   std::string sync_str;
   ...
   {  case ACTUAL_DATE_MODE :
      ...
      break;
      case RELATIVE_TO_SIMULATION_EVENT_MODE :
         simulation_event_clad.append_label(sync_str);                           //190109
         //190109 sync_str.append(simulation_event_clad.get_label());
      break;
      case RELATIVE_TO_SOWING_MODE :
      ...
      case AFTER_NORMAL_CROP_GROWTH_STAGE_MODE :
         ...
         normal_crop_event_sequence_clad.append_label(sync_str);                 //190109
         //190109 sync_str.append(normal_crop_event_sequence_clad.get_label());
      break;
      case AFTER_FRUIT_TREE_GROWTH_STAGE_MODE :
         sync_str.append("after ");
         fruit_tree_event_sequence_clad.append_label(sync_str);                  //190109
         //190109 sync_str.append(fruit_tree_event_sequence_clad.get_label());
      break;
...
//_append_to_string_____________________________________2014-06-16__2003-01-08_/
...
//_set_as_actual____________________________________________________2002-07-20_/
...
{  //		Note that thermal time is never before planting. 010716
   Synchronization_mode sync = sync_mode_clad.get();                             //020322
   return (sync == BEFORE_PLANTING_MODE) ||                                      //030605
      ((sync == RELATIVE_TO_SOWING_MODE) &&                                      //030605
      (get_year() < 0));
}
//_is_before_planting_______________________________________________2000-04-06_/
...
{  CORN::Date_clad_32::set(to_be_copied);                                        //170524
   ...
   sync_mode_clad               .set(to_be_copied.sync_mode_clad.get());
   normal_crop_event_sequence_clad.set(to_be_copied.normal_crop_event_sequence_clad.get());
   fruit_tree_event_sequence_clad .set(to_be_copied.fruit_tree_event_sequence_clad.get());
   simulation_event_clad        .set(to_be_copied.simulation_event_clad.get());
   reschedule_mode_clad.set(to_be_copied.reschedule_mode_clad.get());            //060413
}
//_copy_____________________________________________________________2002-09-16_/
...
{  CORN::date32 actual_date_num = 0;
   if (sync_mode_clad.get() == relative_sync)
...
//_determine_from_relative__________________________________________2003-06-10_/
...
//_determine_from_thermal_time______________________________________2003-06-10_/
...
{  Synchronization_mode sync_mode = sync_mode_clad.get();
   ...
   {  case BEFORE_PLANTING_MODE :   sync_date.dec_days(days_offset);  break;
      ...
      {  CORN::Year  relative_year = get_year();
         ...
         if ((is_leap_this_year()!= date_to_synchronize_to.is_leap_this_year())
              && (act_doy > 60))                                                 //120320_130225
               act_doy--;
         sync_date.set_YD(act_year,act_doy);
      }  break;
      case RELATIVE_TO_SIMULATION_EVENT_MODE :
      {  // to date will either be the start or end simulation date.
         switch (simulation_event_clad.get())
...
//_determine________________________________________________________2003-06-10_/
bool Synchronization::setup_structure
(CORN::Data_record &data_rec,bool for_write,const char *optional_prefix) modification_
{  // This is used for data record I/O.
   ...
   data_rec.expect_enum(prefixed_synchronization.c_str(),sync_mode_clad);                                                        //030605
   ...
   if (rel_to_sim_expected)         data_rec.expect_enum (prefixed_relative_to_simulation_event.c_str(),simulation_event_clad);  //030605
   if (phenologic_normal_expected)  data_rec.expect_enum (prefixed_phenologic_normal.c_str(),normal_crop_event_sequence_clad);   //030605
   if (phenologic_fruit_expected)   data_rec.expect_enum (prefixed_phenologic_fruit.c_str(),fruit_tree_event_sequence_clad);     //030605
   ...
   if (phenologic_normal_expected || phenologic_fruit_expected || thermal_time_expected)                                         //030608
      data_rec.expect_enum("reschedule",reschedule_mode_clad);                                                                   //060413
   ...
   {  // The following are for CS versions 0-3, Remove this if block when CropSyst goes to Version 5                             //030605
      #if ((CS_VERSION > 0) && (CS_VERSION <= 3))
      data_rec.expect_enum(LABEL_sync_old,sync_clad_V3);                                                                         //030605
      #endif
      ...
      #if ((CS_VERSION > 0) && (CS_VERSION <= 3))
      data_rec.expect_enum(LABEL_phen_sync_obsolete,sync_clad_V3); // For backwards compatibility                                //030310
      data_rec.expect_enum(LABEL_synchronization,sync_clad_V3);  // for LADSS                                                    //030310
      data_rec.expect_enum(LABEL_synchronisation,sync_clad_V3);  // for LADSS UK spelling                                        //030310
      #endif
   }
   return true;
}
//_setup_structure__________________________________________________2003-06-05_/
...
{  // Returns true if the other_sync has the same mode, and
   ...
   bool mode_matches = (sync_mode_clad.get() == other_sync.sync_mode_clad.get() );
   if (mode_matches)
   {  // so far so good, but some sync modes have sub sync categories that need to be checked.
      switch (sync_mode_clad.get())
      {        case RELATIVE_TO_SIMULATION_EVENT_MODE    :  mode_matches = simulation_event_clad.get() ==  other_sync.simulation_event_clad.get();                break;
               case AFTER_NORMAL_CROP_GROWTH_STAGE_MODE  :  mode_matches = normal_crop_event_sequence_clad.get() ==  other_sync.normal_crop_event_sequence_clad.get();break;
               case AFTER_FRUIT_TREE_GROWTH_STAGE_MODE   :  mode_matches = fruit_tree_event_sequence_clad.get() ==  other_sync.fruit_tree_event_sequence_clad.get();  break;
      }
   }
   return mode_matches;
}
//_sync_type_matches________________________________________________2003-06-05_/
...
,thermal_time(0)                                                                 //010716
,sync_mode_clad(fruit_crop_model ? AFTER_FRUIT_TREE_GROWTH_STAGE_MODE : AFTER_NORMAL_CROP_GROWTH_STAGE_MODE)   //030606
#if ((CS_VERSION > 0) && (CS_VERSION <= 3))
,sync_clad_V3(V3_NOSYNC)                                                         //030606
#endif
...
{  if (fruit_crop_model)
   {  switch (growth_stage_bitmask)
      {
//NA      case  PREPLANTING           : fruit_tree_event_sequence_clad.set(xxxxxx); break;
      case  PLANTING              : fruit_tree_event_sequence_clad.set(FGS_PLANTING); break;
//NA      case  PREEMERGENCE          : fruit_tree_event_sequence_clad.set(xxxxxx); break;
//NA      case  EMERGENCE             : fruit_tree_event_sequence_clad.set(xxxxxx); break;
//NA      case  RESTART               : fruit_tree_event_sequence_clad.set(xxxxxx); break;
      case  BUD_BREAK             : fruit_tree_event_sequence_clad.set(FGS_BUD_BREAK); break;
      case  ACTIVE_GROWTH         : fruit_tree_event_sequence_clad.set(FGS_ACTIVE_GROWTH); break;
      case  END_CANOPY_GROWTH       : fruit_tree_event_sequence_clad.set(NGS_END_CANOPY_GROWTH); break; //130429
      case  ANTHESIS              : fruit_tree_event_sequence_clad.set(FGS_ANTHESIS); break;
//NA      case  GRAIN_FILLING         : fruit_tree_event_sequence_clad.set(xxxxxx); break;
      case  INITIAL_FRUIT_GROWTH  : fruit_tree_event_sequence_clad.set(FGS_INFRUCTESCENCE); break;
      case  VERAISON              : fruit_tree_event_sequence_clad.set(FGS_VERAISON); break;
      case  RAPID_FRUIT_GROWTH    : fruit_tree_event_sequence_clad.set(FGS_RAPID_FRUIT_DEVELOPMENT); break;
      case  MATURITY              : fruit_tree_event_sequence_clad.set(FGS_MATURITY); break;
      case  DORMANT_or_INACTIVE   : fruit_tree_event_sequence_clad.set(FGS_DORMANT); break;
      case  HARVESTABLE           : fruit_tree_event_sequence_clad.set(FGS_HARVESTABLE); break;
      case  HARVESTED             : fruit_tree_event_sequence_clad.set(FGS_HARVEST); break;
//NA      case  TERMINATED            : fruit_tree_event_sequence_clad.set(xxxxxx); break;
      }
   } else
   {  switch (growth_stage_bitmask)
      {
//NYI      case  PREPLANTING          : normal_crop_event_sequence_clad.set(xxxxxx); break;
      case  PLANTING             : normal_crop_event_sequence_clad.set(NGS_SOWING); break;
//NYI      case  PREEMERGENCE         : normal_crop_event_sequence_clad.set(xxxxxx); break;
      case  EMERGENCE            : normal_crop_event_sequence_clad.set(NGS_EMERGENCE); break;
      case  RESTART              : normal_crop_event_sequence_clad.set(NGS_RESTART); break;
//NA      case  BUD_BREAK            : normal_crop_event_sequence_clad.set(xxxxxx); break;
      case  ACTIVE_GROWTH        : normal_crop_event_sequence_clad.set(NGS_ACTIVE_GROWTH); break;
      case  END_CANOPY_GROWTH    : normal_crop_event_sequence_clad.set(NGS_END_CANOPY_GROWTH); break; //130429
      case  ANTHESIS             : normal_crop_event_sequence_clad.set(NGS_ANTHESIS); break;
      case  FILLING_OR_BULKING        : normal_crop_event_sequence_clad.set(NGS_FILLING); break;
//NA      case  INITIAL_FRUIT_GROWTH : normal_crop_event_sequence_clad.set(xxxxxx); break;
//NA      case  VERAISON             : normal_crop_event_sequence_clad.set(xxxxxx); break;
//NA      case  RAPID_FRUIT_GROWTH   : normal_crop_event_sequence_clad.set(xxxxxx); break;
      case  MATURITY             : normal_crop_event_sequence_clad.set(NGS_MATURITY); break;
      case  DORMANT_or_INACTIVE              : normal_crop_event_sequence_clad.set(NGS_DORMANT_or_INACTIVE); break;
      case  HARVESTABLE          : normal_crop_event_sequence_clad.set(NGS_HARVESTABLE); break;
      case  HARVESTED            : normal_crop_event_sequence_clad.set(NGS_HARVEST); break;
      case  TERMINATED           : normal_crop_event_sequence_clad.set(NGS_TERMINATED); break;
      }
   }
}
*/
//_constructor______________________________________________________2003-06-06_/
Synchronization::Synchronization(bool fruit_crop_model, Normal_crop_event_sequence growth_stage_sequence)
: CORN::Date_clad_32(0)                                                          //170525
,days_offset(0)  // eventually will be Days type
,thermal_time(0)
,sync_mode_clad(fruit_crop_model ? AFTER_FRUIT_TREE_GROWTH_STAGE_MODE : AFTER_NORMAL_CROP_GROWTH_STAGE_MODE)
,reschedule_mode_clad(NO_RESCHEDULE)
{  if (fruit_crop_model)
      fruit_tree_event_sequence_clad.set(growth_stage_sequence);
   else
      normal_crop_event_sequence_clad.set(growth_stage_sequence);
}
//_Synchronization:constructor______________________________________2013-09-03_/
...
//_is_growing_season_synchronization________________________________2003-06-06_/
bool Synchronization::is_phenologic_synchronization()               affirmation_
{  Synchronization_mode sync_mode = sync_mode_clad.get();
   return (sync_mode == AFTER_FRUIT_TREE_GROWTH_STAGE_MODE)
       || (sync_mode == THERMAL_TIME_MODE);
}
//_is_phenologic_synchronization____________________________________2003-06-06_/
bool Synchronization::is_actual_date_synchronization()              affirmation_
{  Synchronization_mode sync_mode = sync_mode_clad.get();
   return (sync_mode == ACTUAL_DATE_MODE);
}
//_is_actual_date_synchronization___________________________________2003-06-06_/
#if ((CS_VERSION > 0) && (CS_VERSION <= 3))
...
{  bool was_CS_V3 = false;
   ...
   switch (sync_clad_V3.get())
   {  // Version 3 did not have fruit crop model, relative to simulation events, and thermal time so those are not converted.
      case V3_BEFORE_PLANTING            :  was_CS_V3 = true; sync_mode_clad.set(BEFORE_PLANTING_MODE);      break;
      case V3_AFTER_PLANTING             :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_SOWING); break;
      case V3_AFTER_EMERGENCE            :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_EMERGENCE); break;
      case V3_AFTER_FLOWERING            :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_ANTHESIS); break;
      case V3_AFTER_GRAIN_FILLING        :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_FILLING); break;
      case V3_AFTER_MATURITY             :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_MATURITY); break;
      case V3_AFTER_HARVEST              :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_HARVEST); break;
      case V3_AFTER_DORMANCY             :  was_CS_V3 = true; sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);      normal_crop_event_sequence_clad.set(NGS_DORMANT_or_INACTIVE); break;
      case V3_ACTUAL_DATE                :  was_CS_V3 = true; sync_mode_clad.set(ACTUAL_DATE_MODE);     break;
      case V3_RELATIVE_TO_SOW_DATE       :  was_CS_V3 = true; sync_mode_clad.set(RELATIVE_TO_SOWING_MODE);     break;
   }
   return was_CS_V3;
}
#endif
//_convert_from_CropSystV3_____________________________________________________/
void Synchronization::set_relative_to_simulation_mode(int16 days_offset)
{  sync_mode_clad.set(RELATIVE_TO_SIMULATION_EVENT_MODE);
   days_offset = days_offset;
}
//_set_relative_to_simulation_mode__________________________________2003-06-23_/
...
{  clear(); //180822 set_YD(0,0);
   ...
   thermal_time = 0;
   normal_crop_event_sequence_clad.set(normal_crop_event_sequence);
   sync_mode_clad.set(AFTER_NORMAL_CROP_GROWTH_STAGE_MODE);
   #if ((CS_VERSION > 0) && (CS_VERSION <= 3))
   sync_clad_V3 =V3_NOSYNC;
   #endif
   reschedule_mode_clad.set(NO_RESCHEDULE);
}
//_set_normal_growth_stage_offset___________________________________2004-08-02_/
Reschedule_mode Synchronization::get_reschedule_mode()                     const
{  Reschedule_mode mode = reschedule_mode_clad.get();
...
//_get_reschedule_mode______________________________________________2006-04-13_/
...
//_is_valid_________________________________________________________2006-07-26_/
bool Synchronization::is_date()                                     affirmation_
{  Synchronization_mode sync = (Synchronization_mode)sync_mode_clad.get();
   return (sync == ACTUAL_DATE_MODE); 
}
//_is_date__________________________________________________________2001-12-07_/
...
//_is_synchronized_relatively_______________________________________2002-03-22_/
