...
public: // event processing
   virtual bool respond_to_field_operation                                       //060727
      ...
      ,USDA::NRCS::RUSLE2::Soil_disturbance_effect operation_soil_disturbance_effect
      ,const float32  residue_flatten_ratio[RUSLE2_RESIDUE_TYPE_COUNT]
      ,const float32  residue_burial_ratio_fraction[RUSLE2_RESIDUE_TYPE_COUNT]);
 ...
 private:
    float64 get_subsurface_XXXX_biomass
      (soil_sublayer_array_64(layer_residues),Organic_matter_type residue_type); //000810
 public: // accessors
    ...
    virtual float64 get_subsurface_plant_biomass                                 //000810
      (soil_sublayer_array_64(plant_residues)  = 0);
    virtual float64 get_subsurface_manure_biomass                                //000810
      (soil_sublayer_array_64(manure_residues) = 0);
...
//_Residues_V4_common__________________________________________________________/
#endif
