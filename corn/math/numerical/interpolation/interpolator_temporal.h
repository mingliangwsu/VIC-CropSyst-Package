...
//_Interpolation_curve_type____________________________________________________/
...
//   Interpolation *curveX;  // rename to interpolation
 ...
 public:
   ...
   virtual bool set_by_date
      (const Date_const &for_date, float32 ordinate)              modification_;
 protected:
   virtual bool set_reference_date
      (const Date_const &reference_date)                          contribution_;
};
