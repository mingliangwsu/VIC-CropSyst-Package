...
: public implements_ Soil::Freezing_profile                                      //070824
{
 protected: // Soil interfaces references
   unmodifiable_ Soil::Layers_interface               &soil_layers;               //070825  // These were moved from  Soil_freezing_profile_abstract
   unmodifiable_ Soil::Structure                      &soil_structure;            //070825
   unmodifiable_ Soil::Hydraulic_properties_interface &soil_hydraulic_properties; //070825
   unmodifiable_ Soil::Hydrology_interface            &soil_hydrology;            //070825
 private:// Nested classes
   ...
   public: // Nested classes
      ...
      //_Lens_______________________________________________________1998-10-14_/
   ...
   //_Lenses_manager___________________________________________________________/
 private:
 ...
 protected:
   unmodifiable_ Soil::Temperature_interface  &temperature_profile;               //080123
   const         Air_temperature_average     &air_temperature_avg;                //151022
 public:
   Soil_freezing_profile_jumakis                                                 //990308
      (unmodifiable_ Soil::Layers_interface                &soil_layers          //051201
      ,unmodifiable_ Soil::Structure                       &soil_structure       //070725
      ,unmodifiable_ Soil::Hydraulic_properties_interface  &soil_hydraulic_properties  //051201
      ,  modifiable_ Soil::Hydrology_interface             &soil_hydrology        //051201
      ,unmodifiable_ Soil::Temperature_interface           &soil_temperature
      ,const         Air_temperature_average              &air_temperature_avg); //151022
...
//_Soil_freezing_profile_jumakis____________________________________1998-07-29_/
#endif
//soilfrzj.h
