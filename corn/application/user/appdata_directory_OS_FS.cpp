...
//_Application_data_directory:constructor______________________________________/
...
, settings_filename(0)
{}
//_Application_data_directory::constructor__________________________2012-02-14_/
...
//_set_settings_filename_______________________________________________________/
...
{
   OS::file_system_engine.provide_directory(*this);
   // Create this application/package directory if it doesn't already exist
   //(otherwise we cannot write the file into it)
...
//_save_user_settings__________________________________________________________/
...
//_load_user_settings__________________________________________________________/
...
//_provide_settings_filename________________________________________2013-03-19_/
