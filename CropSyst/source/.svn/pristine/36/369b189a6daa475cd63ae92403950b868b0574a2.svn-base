...
//181225 class Chemical_pool;                                                             //170502
namespace Soil
{
   class Chemical_pool;
}
...
: public Organic_matter_residues_profile_abstract                                //070707
{
 ...
 public: // Constructors and Destructors
   Organic_matter_residues_profile_simple
      ...
      #ifndef OLD_N_XFER
      ,Soil::Chemical_pool                     &receiver_NO3                     //170502
      #endif
   ...
   inline virtual Organic_matter_and_residue_model get_model()            const
      { return V4_1_ORGANIC_MATTER_AND_RESIDUE;}                                 //070730
 public: // Residue
 ...
 public: // The following are for the Nitrogen model return 0 if not simulating nitrogen
   ...
   inline virtual Pot_mineralizable_N_profile *get_pot_mineralizable_N_profile()
      { return pot_mineralizable_N; }
 ...
 public:
   inline virtual void decompose_all_without_N
      ...
      ,Soil::Soil_interface &soil)                                                     //040608
      {
   ...
   inline virtual float64 get_mass_from_layer_to_layer
      (Mass_total mass_total,nat32 include_organic_matter_types
      ,nat8 from_layer,nat8 to_layer,float64 prorate_fraction_bottom_layer)const
         { return 0.0; /* not available in this version */ } //071214
 public: // Event processing
   inline virtual bool respond_to_field_operation                                //060726
      ...
      ,USDA::NRCS::RUSLE2::Soil_disturbance_effect op_soil_disturbance_effect
      ,const Soil::Disturbance *_soil_disturbance // This model doesn't use this  //060807
      ,const float32  residue_flatten_ratio[]
      ,const float32  residue_burial_ratio[])       modification_{ return true;}
        // This model doesn't currently do anything with organic matter (residue is currently redistributed separately)
   inline virtual const Soil::Disturbance *know_soil_disturbance
   ...
   inline virtual bool write(std::ostream &)           performs_IO_ { return 0;} //120912
   inline virtual bool read(std::istream &stream)  performs_IO_ { return false;} //140213_120912
};
//_Organic_matter_residues_profile_simple___________________________2005-07-26_/
#endif
#endif
