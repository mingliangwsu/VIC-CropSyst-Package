...
//_Soil_texture:constructor____________________________________________________/
Soil_texture::Soil_texture
...
//_determine_percentages_______________________________________________________/
...
//_determine_texture___________________________________________________________/
bool Soil_texture::is_root_penetratable() const
{  return (texture_code != weathered_bedrock)
       && (texture_code != unweathered_bedrock);
}
//_is_root_penetratable________________________________________________________/
