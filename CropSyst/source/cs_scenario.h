...
class Climate_adjustments;                                                       //181011
...
///*200122 #define    LABEL_grass_filename_OLD       "grass_filename"
...
{no_cropping_system,single_cropping_system,rotation_cropping_system
,established_cropping_system};                                                   //051231
extern Label_description  cropping_system_mode_label_table[];                    //051231
DECLARE_DESCRIPTIVE_ENUM_CLAD
(Cropping_system_mode_clad,Cropping_system_mode,cropping_system_mode_label_table)//051231
namespace CropSyst                                                               //130621
{
   class Simulation_override_record;                                             //140216
//_Cropping_system_mode________________________________________________________/
class Single_cropping_system
{
 public:
   CORN::Date_clad_32            planting_date;  //191211 was sowing_date
   CRP_filename                  crop_filename;
   MGT_filename                  management_filename;
   bool                          stop_at_harvest;                                //181031
      // stop_at_harvest was added for AgMIP however it would have general use
 public:
...
*/
   ...
   Cropping_system_mode_clad  cropping_system_mode_clad;                         //051231

   Single_cropping_system        single;                                         //180425
   Climate_adjustments           *climate_adjustments;                           //181011
      // optional climate_adjustments were added for AgMIP project but could have
...
*/
 ...
 public: // residue initialization
   ...
   // Residue Initializations:
   float32 stubble_residue_32; Parameter_number p_stubble_residue; //kg/m2       //170604
   float32 surface_residue_32; Parameter_number p_surface_residue; //kg/m2       //170604
   soil_horizon_array32(horizon_incorporated_residue);             //kg/m2       //060405
   float32 N_conc_residue_32; Parameter_number p_N_conc_residue;//kgN/kgbiomass  //170604
   /*200220obs
   #if (CS_VERSION==4)
   int16   decomposition_time_residue_63; Parameter_number p_decomposition_time_residue_63; //days //040830 deprecated, replacing with 50% basis
   // in later versions used only 50% decomp rate
   #endif
   */
   //200220obs? int16   halflife_residue; Parameter_number p_halflife_residue; //days
 ...
 public: // Residue manure initialization
   ...
   float32 surface_manure_32;     /*kg/m2*/  Parameter_number p_surface_manure;  //170604
   float32 incorporated_manure_32;/*kg/m2*/  Parameter_number p_incorporated_manure; //170604
   float32 N_conc_manure_32;      /*kg/m2*/  Parameter_number p_N_conc_manure;   //170604
   //200220obs?    int16 halflife_manure;                    Parameter_number p_halflife_manure; //days  //170604
         // may be obsolete
#endif
 ...
 public: // soil profile initialization
   ...
   Moisture_characterization_clad moisture_initial_clad;                         //170320
 ...
 public: // soil nitrogen profile initialization
   ...
   float32 initial_water_table_N_NO3; Parameter_number p_initial_water_table_N_NO3;
   float32 initial_water_table_N_NH4; Parameter_number p_initial_water_table_N_NH4;
#endif
#ifdef PHOSPHORUS
   float32 phosphorus_in_profile;   // kg P/ha initial                              //110801
   Valid_float32 v_phosphorus_in_profile;
   //NYI   soil_horizon_array32(horizon_P);  valid_soil_horizon_array(v_P);  //kgP/ha   //110801
#endif
#ifdef SALINITY
 ...
 public:
   float32 ECe_to_TDS;  Parameter_number p_ECe_to_TDS;
      // Conversion factor electrical conductivity of soil to TDS concentration  //80402
   float32 ECw_to_TDS;  Parameter_number p_ECw_to_TDS;                           //080402
#endif
/*200122
#ifdef SOILR
...
//_scenario_________________________________________________________2002-03-08_/
