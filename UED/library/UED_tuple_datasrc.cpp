...
{}
//_Tuple_data_source:constructor_______________________________________________/
const char *Tuple_data_source::label_string(std::string &buffer)           const
{  buffer = database->get_file_name(); return buffer.c_str(); }
//_label_string_____________________________________________________2003-01-23_/
void Tuple_data_source::set_date(datetime64 date_time)
{ active_date_time.set_datetime64(date_time); }
//_set_date____________________________________________________________________/
...
//_get_field_creation__________________________________________________________/
...
//_add_field___________________________________________________________________/
...
//_add_field2_______________________________________________________2004-09-24_/
bool Tuple_data_source::get(CORN::Data_record &data_rec)
{  UNUSED_arg(data_rec);
...
//_set_data____________________________________________________________________/
