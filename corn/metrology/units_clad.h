...
*/
 ...
 public:
  ...
  private:
      float32 time_to_seconds_factor
         (nat8 time_measure, int8 base_10_exponent)                       const;
};
//_Units_component_____________________________________________________________/
...
public:
   ...
   bool  compose_description_str
      (std::string &component_descr, std::string &component_abbr)         const; //170114
      ///<  Composes a text description of the units
   bool  is_temporal()                                             affirmation_; //170520
   int16 has_definition()                                          affirmation_;
};
//_Units_clad__________________________________________________________________/
