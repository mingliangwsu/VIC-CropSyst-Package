...
//______________________________________________________________________________
#define RENDER_MODIFIERS_DECLARATION           \
virtual CS::Emanator *render_modifiers         \
(CORN::Container      &modifiers               \
,const CS::Emanator  *context                   \
,const std::string   &instance ) rendition_
//______________________________________________________________________________
#define RENDER_MODIFIERS_DECLARATION_PURE      \
   RENDER_MODIFIERS_DECLARATION = 0
//______________________________________________________________________________
#define RENDER_MODIFIERS_DEFINITION(rendering_class)     \
CS::Emanator *rendering_class::render_modifiers          \
(CORN::Container      &modifiers                         \
,const CS::Emanator  *context                            \
,const std::string   &instance          ) rendition_
//______________________________________________________________________________
