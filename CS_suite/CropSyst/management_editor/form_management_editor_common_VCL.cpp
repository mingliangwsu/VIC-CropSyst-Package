...
{  management = _management;
   ...
   radiogroup_land_treatment  ->bind_to(&(management->land_treatment_clad) V4_HELP_URL(HELP_P_mgmt_conserv_land_treatment));
...
Common_event * TManagement_editor_form::add_residue_event(const char *help_URL)
{
   ...
   residue_op->op_clad.set(CS_OP_MGMT_RESIDUE);
