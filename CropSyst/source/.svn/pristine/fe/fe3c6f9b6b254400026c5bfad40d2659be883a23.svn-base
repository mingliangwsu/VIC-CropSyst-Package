...
Interception_architectural_Oyarzun_Stockle::Interception_architectural_Oyarzun_Stockle
( CropSyst::Crop_parameters_struct::Layout                            &layout_   //110218
, CropSyst::Crop_parameters_struct::Canopy_architecture  &canopy_architecture_   //110218
...
: Orchard_common::Interception_architectural
   (layout_
   ,canopy_architecture_
   ,slope_percent_
...
, solar_beam_radiation_hour        (99999.9)
, solar_diffuse_radiation_hour     (99999.9)
//190721, hour(24)
//151029, doy(999)
{
#ifdef DEBUG_OYARZUN_HOUR
...
<< "solar_beam_radiation"       << '\t'
<< "solar_diffuse_radiation"    << '\t'
<< "solid_hourly_interception"   << '\t'
<< "solar_radiation_fract"      << '\t'
<< endl;
#endif
};
//_Orchard_interception_Oyarzun_Stockle:constructor____________________________/
float64 Interception_architectural_Oyarzun_Stockle
::update_solid_canopy_interception()                              rectification_
{
   ...
   declination_radians_daily =  sun_days.get_solar_declination_rad(doy);
   ...
   {   float64  solar_radiation_fract_hour = weather_hours
         .get_insolation_fraction(hour);                                         //151224
       if ( solar_radiation_fract_hour > 0.001)
       {
      ...
      solar_beam_radiation_hour = weather_hours.get_solar_direct_radiation_MJ_m2(hour);
      solar_diffuse_radiation_hour =  weather_hours.get_solar_diffuse_radiation_MJ_m2(hour);
...
<< A_Daily_Dif_transmit_Rs             << '\t'
<< solar_beam_radiation_hour          << '\t'
<< solar_diffuse_radiation_hour       << '\t'
<< solid_hourly_interception<< '\t'
<< solar_radiation_fract_hour << '\t'
<< endl;
#endif
      solid_interception_daily +=  solar_radiation_fract_hour * solid_hourly_interception;
            // solar_radiation_fract should be 0 at night
...
float64 Interception_architectural_Oyarzun_Stockle::calc_hourly_solid_interception() calculation_
{
...
071114
 ...
 // fraction_shaded_orchard  the shadow of the tree excluding sun flecks   (as if the canopy were fully solid)
   ...
   float64 total_radiation_hour = (solar_beam_radiation_hour + solar_diffuse_radiation_hour);
   total_radiation_hour = CORN::must_be_greater_or_equal_to<float64>(total_radiation_hour,0.000001); // Avoid div0 //071117
   float64 hourly_fraction_of_beam_radiation    = solar_beam_radiation_hour    / total_radiation_hour;
   float64 hourly_fraction_of_diffuse_radiation = solar_diffuse_radiation_hour / total_radiation_hour;
...
//_calc_hourly_solid_interception_________________________________________2007_/
float64 Interception_architectural_Oyarzun_Stockle
::calc_daily_diffuse_transmittance_of_Rs_for_hour()                calculation_  //modification_ // of_solar_radiation?
{  float64 Daily_Dif_transmit_Rs = 0.0;
   ...
   {  float64 Local_Solar_Zenith_Angle =  sun_hours.get_solar_zenith_angle_rad(doy,local_hour);
      float64 local_solar_azimuth_angle = sun_hours.get_solar_azimuth_angle_radians(doy,local_hour);
...
//_calc_daily_diffuse_transmittance_of_Rs_for_hour__________________2007-11-15_/
float64 Interception_architectural_Oyarzun_Stockle::calc_shadow_length
...
{  //This function calculates the plant shadow length perpendicular
   ...
   shadow_length = CORN::must_be_0_or_greater<float64>(shadow_length);
   return shadow_length;
};
//_calc_shadow_length__________________________________________________________/
float64 Interception_architectural_Oyarzun_Stockle::calc_ghost_shadow_length
( float64 solar_zenith_angle_radians_hourly_param
, float64 solar_azimuth_angle_radians_hourly_param)                        const
{  // This function calculates the "blank space" in the shadow length cast, perpendicular
   ...
   float64 ghost_shadow_length = architecture.branch_insertion_height
      * (tan(solar_zenith_angle_radians_hourly_param)) * GSL1;
   ghost_shadow_length         = CORN::must_be_0_or_greater<float64>(ghost_shadow_length);
   return ghost_shadow_length;
};
//_calc_ghost_shadow_length____________________________________________________/
float64 Interception_architectural_Oyarzun_Stockle::calc_shadow_length_along
( float64 solar_zenith_angle_radians_hourly_param
, float64 solar_azimuth_angle_radians_hourly_param)                        const
{
   // The following contributes should have already been calculated:
   ...
   shadow_length_along = CORN::must_be_0_or_greater<float64>(shadow_length_along);
   return shadow_length_along;
};
//_calc_shadow_length_along____________________________________________________/
float64 Interception_architectural_Oyarzun_Stockle::calc_ghost_shadow_length_along
( float64 solar_zenith_angle_radians_hourly_param
, float64 solar_azimuth_angle_radians_hourly_param)                        const
{
   // The following contributes should have already been calculated:
   ...
   float64 ghost_shadow_length_along = architecture.branch_insertion_height
      * (tan(solar_zenith_angle_radians_hourly_param)) * GSL4;
   ghost_shadow_length_along = CORN::must_be_0_or_greater<float64>(ghost_shadow_length_along);
   return ghost_shadow_length_along;
};
//_calc_ghost_shadow_length_along______________________________________________/
float64 Interception_architectural_Oyarzun_Stockle::calc_shadow_correction_factor() const
{
   ...
   shadow_correction_fact = CORN::must_be_0_or_greater<float64>(shadow_correction_fact);
   return shadow_correction_fact;
};
//_calc_shadow_correction_factor_______________________________________________
float64 Interception_architectural_Oyarzun_Stockle::calc_fraction_of_shade
   ...
   float64 Term1 =
      ((Shlength_corr + limited_plot_width) * (limited_plot_breadth + Shlength_corr_ALONG)
       - (Shlength_corr * Shlength_corr_ALONG))
         / (layout.spacing.row * row_spacing_along);
   Term1 = CORN::must_be_less_or_equal_to<float64>(Term1,1.0);
   return Term1;
};
//_calc_fraction_of_shade______________________________________________________.
#ifdef OBSOLETE
RLN solar declination is already available form Sun_days
float64 Interception_architectural_Oyarzun_Stockle::calc_solar_declination_daily( )
...
#endif
//_calc_solar_declination_daily_____________________________________________________________________________
#ifdef OBSOLETE
071115 RLN Using my own calculations for this  (dont delete this until I verify the differences)
float64 Interception_architectural_Oyarzun_Stockle::calc_solar_zenith_angle
...
float64 Interception_architectural_Oyarzun_Stockle::calc_half_day_length
( CORN::DOY  doy
...
#ifdef OBSOLETE
//071115 RLN Using my own calculations for this
float64 Interception_architectural_Oyarzun_Stockle::calc_hour_of_sunrise
( CORN::DOY  doy
, float64 latitude_radians
...
#ifdef OBSOLETE
//071115 RLN Using my own calculations for this
float64 Interception_architectural_Oyarzun_Stockle::calc_hour_of_sunset
( CORN::DOY doy
, float64 latitude_radians
, float64 longitude_radians
, float64 standard_meridian_radians)
...
#ifdef CHECK_USED
//071114 RLN
Function Interception_architectural_Oyarzun_Stockle::BeamExtinctionCoeff(X As Double, ZenithAngle As Double, Absorptivity As Double) As Double
...
#ifdef CHECK_USED
//071114 RLN
Private Function Interception_architectural_Oyarzun_Stockle::DiffuseExtinctionCoeff(X As Double, LAI As Double, Absorptivity As Double) As Double
...
#ifdef CHECK_USED
//071114 RLN
Private Function Interception_architectural_Oyarzun_Stockle::SolarReflectionCoefficient(Absorptivity As Double, LAI As Double,  , _
...
#ifdef CHECK_USED
//071114 RLN
float64 Interception_architectural_Oyarzun_Stockle::AverageDiffusePlusScatteredIrradiance(Absorptivity As Double, LAI As Double, , _
...
#ifdef CHECK_IF_USED
071115 RLN
Sub Interception_architectural_Oyarzun_Stockle::FractionSunlitShadedRadiationInterception(Canopy_X_Value As Double, LAI As Double, doy As Integer, _
solar_beam_radiation_hour As Double, _
solar_diffuse_radiation_hour As Double, Tree_Canopy As Boolean)
Dim K_Beam_Black_Leaves As Double
...
Beam_Solar_Interception = (1.0 - Beam_Real_Leaves_Solar_Transmissivity) * solar_beam_radiation_hour
Diffuse_Solar_Interception = (1.0 - Diffuse_Solar_Transmissivity) * solar_diffuse_radiation_hour
...
Total_Solar_Irradiance = solar_beam_radiation_hour + solar_diffuse_radiation_hour
...
Diffuse_Plus_Scattered_Solar_Irradiance = AverageDiffusePlusScatteredIrradiance(0.5, LAI,  solar_beam_radiation_hour, _
    solar_diffuse_radiation_hour, Canopy_X_Value)

Sunlit_Leaves_Average_Solar_Irradiance = K_Beam_Black_Leaves * solar_beam_radiation_hour + Diffuse_Plus_Scattered_Solar_Irradiance

Shaded_Leaves_Average_Solar_Irradiance = Diffuse_Plus_Scattered_Solar_Irradiance

Calculations for photosynthetically active radiation
...
Beam_PAR_Irradiance = solar_beam_radiation_hour * 0.5
Diffuse_PAR_Irradiance = solar_diffuse_radiation_hour * 0.5
...
#endif
//_FractionSunlitShadedRadiationInterception___________________________________/
#ifdef UNUSED_code
RLN
float64 Interception_architectural_Oyarzun_Stockle::calc_beta
()
...
//_calc_beta___________________________________________________________________/
float64 Interception_architectural_Oyarzun_Stockle::calc_cosine_incidence_angle()
{  // This function calculates the incidence angle, defined as the angle between the suns beam
   ...
   cosine_incidence_angle = CORN::must_be_0_or_greater<float64>(cosine_incidence_angle);
   return cosine_incidence_angle;
};
//_calc_cosine_incidence_angle_________________________________________________/
#endif
