...
//_Uniform_resource_identifier:constructor_____________________________________/
...
//_Uniform_resource_identifier:constructor(copy)_______________________________/
...
//_construction_decompose______________________________________________________/
      ...
      {  std::string top_level_domain(*authority_without_port,rightmost_dot_pos+1);
         ...
         {  size_t a_pos = authority_without_port->find('@');
            ...
            {  std::string user_info(authority_without_port->c_str(),0,a_pos);
               ...
               // WARNING THE FOLLOWING HAS NOT YET BEEN CHECKED
...
//_recompose________________________________________________________2015-07-29_/
const std::string &Uniform_resource_identifier::set_path_string
...
//_set_path_string__________________________________________________2015-07-29_/
const std::string &Uniform_resource_identifier::set_path_filename
(const OS::File_name &new_path)
{
   delete path;
   path = new CORN::OS::File_name_concrete(new_path);
   return recompose();
}
//_set_path_filename________________________________________________2015-07-29_/
const std::string &Uniform_resource_identifier::set_local_path_string
(const std::string &new_path)
{
...
//_set_local_path_string____________________________________________2015-07-29_/
const std::string &Uniform_resource_identifier::set_local_path_filename
(const OS::File_name &new_path)
{
   // filename is likely fully qualified (put could be relative)
   // The schema is change to 'file'
...
//_set_local_path_filename__________________________________________2015-07-29_/
...
{  if (username)
   ...
   if(port)
   {  buffer.append(":");
      CORN::append_nat16_to_string(port,buffer);
   }
   return buffer;
}
//_append_to_string_________________________________________________2015-08-18_/
const Uniform_resource_identifier::Authority *Uniform_resource_identifier
::get_authority()                                                     provision_
{  return authority;
}
//_get_authority____________________________________________________2016-08-24_/
bool Uniform_resource_identifier::get_path_query_fragment_string
...
//_get_path_query_fragment_string___________________________________2016-08-24_/
