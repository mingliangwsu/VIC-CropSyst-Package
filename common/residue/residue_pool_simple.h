...
namespace Soil
{
   ...
   class Layers_interface;                                                 //060122
   class Hydrology_interface;                                              //060122
   class Hydraulic_properties_interface;                                   //060122
   class Nitrogen;                                                         //060122
}
//______________________________________________________________________________
...
{protected:
   ...
   const     Soil::Hydrology_interface   &soil_hydrology;                         //060122
   const     Soil::Hydraulic_properties_interface &soil_hydraulic_props;          //060122
   modifiable_ Soil::Nitrogen  *soil_nitrogen_modifiable;  // May be 0 if no nitrogen //060122
   const     Air_temperature_average    &temperature_air_avg;                    //150427
 public:
   // The following are for manure only:
#ifdef NITROGEN
   Organic_matter_type   type;                                                   //190124
