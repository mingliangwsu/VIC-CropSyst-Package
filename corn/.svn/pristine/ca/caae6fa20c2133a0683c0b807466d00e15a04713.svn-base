#ifndef worksheet_Excel_BIFFH
#define worksheet_Excel_BIFFH
...
*/
    public:
      ...
      virtual void commit(Workbook/*190113 Excel_workbook*/ &workbook);
#ifdef DISABLED
101127
...
protected:
 ...
 public:  // Association implementation
   virtual bool is_key_string(const std::string &key)              affirmation_;  //181001
...
public: // Constructors
   Worksheet
      ...
      ,BIFF_Format BIFF_version = BIFF8
   ...
   */
   virtual void commit(Workbook &workbook); //190711
public:  // Settings and operations
   void freeze_pane
      (nat16 left_most_column_ , nat16 top_most_row_
      ,BIFF_rec_PANE::Panes active_pane = BIFF_rec_PANE::lower_right);
   ...
   virtual nat16 get_row_count()                                   const;
// private:
//   bool write_cell_record(const Cell_common &BIFF_rec);                          //111011
 private:
   inline bool test_abstract()                  { return new Worksheet("test");}
};
//_Worksheet___________________________________________________________________/
