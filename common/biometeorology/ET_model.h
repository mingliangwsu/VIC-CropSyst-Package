...
//200228 #define ET_MODEL_AUTOMATIC       ET_all_models
#if (CS_VERSION==4)
...
DECLARE_DESCRIPTIVE_ENUM_CLAD(LOC_ET_Model_clad,ET_Model,CS_ET_model_label_table)
//_ET_Model_________________________________________________________2009-09-28_/
#endif
