...
public:
   ...
   inline virtual const CS::CO2_atmospheric_concentration &ref_CO2_current_conc()
                                                 const { return curr_CO2_conc; }
};
//_class Atmospheric_CO2_change_recalibration__________________________________/
#endif
