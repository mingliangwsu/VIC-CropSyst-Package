...
: public extends_ Land_unit_with_output
{
 ...
 protected: // objects shared by all the simulations
   ...
   const CORN::OS::File_name &format_filename;                                   //120505
   #endif
 public:
...
public:
   ...
   virtual bool output_growing_season
      (const Crop_model_interface &crop_at_start_season);                        //130716
   ...
   virtual void harvest_event
      (const CropSyst::Crop_model_interface &crop_at_harvest);                   //130716
...
//_Land_unit_with_output_V4____________________________________________________/
