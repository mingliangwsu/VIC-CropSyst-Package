...
: public extends_ CORN::Bidirectional_list
{
 public:
   ...
   //Column____________________________________________________________________/
   class Element
...
//_Column_elements__________________________________________________2014-05-23_/
class Convertor
{public: // command line parameters
 ...
 protected:
   ...
   provided_ CORN::OS::Directory_name     *ued_file_path_checkused;
...
*/
 ...
 protected:
   ...
   inline virtual bool is_import_data_record                                     //160212
      ...
      ,const Container &import_columns
...
   virtual Geolocation_record *provide_geolocation_record();                     //160212
   virtual Geolocation *render_geolocation                                       //160212
      (const std::string &station_ID)                                rendition_;
};
//_class Convertor_____________________________________________________________/
