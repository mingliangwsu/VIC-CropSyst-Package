...
: public virtual CropSyst::Crop_model_interface                                  //131008NS
...
//NYI this is not in CropSyst thermal time units/*_______*/    float32 DTX_accum;  // Accumulated thermal time
   statistical::Descriptive_progressive_index vapor_deficit_stats; // used only for output
   statistical::Descriptive_progressive_index N_stress_stats;
//crop_common/*_______*/    statistical::Descriptive_progressive_index water_stress_stats;
private: // May eventually want to move these dates into CropGro crop.
   ...
   contribute_ CORN::date32  NA_date32; // This is a buffer for dates that are not applicable to CropGro. //130715_081013
   Temperature_estimator      hourly_temperature_estimator;
 private: // interface variables stored by this
   statistical::Descriptive_progressive_index SWFAC_stats;                                        //010726
 ...
 public:  // The following accessors are used for processing
   ...
   //200228 inline virtual float64  get_fract_canopy_cover()                        const { return 0.0; /*N/A fract_canopy_cover;*/ }
   inline virtual float64  get_canopy_interception_global_total()          const { return 0.0; /*N/A fract_canopy_cover;*/ }
   ...
   virtual float64 get_terminate_straw_to_residue()            const { return 1.0; } //040514_
   virtual bool    set_fallow(bool i_fallow)               modification_ { return false;}
      // not sure how to handle fallow in this case
   virtual void    set_terminate_pending()                        {} //040514 Crop Gro does not have terminate like cropsyst
   inline virtual bool        is_terminate_pending() const  { return false; } // Crop Gro does not have terminate like cropsyst // 071111
 private:
   nat32 triggered_synchronizations;                                 //020310
   nat32 previously_triggered_synchronizations;                      //020310
   bool trigger_synchronization(nat32 event_sync);                   //020310
      // returns true if the sync has not already been triggered.
 public:  // The following accessors are used only for output
   ...
   inline virtual float64 get_intercepted_precipitation_m()               const
      { return Crop_common::get_intercepted_precipitation_m(); }                 //140320
   inline virtual float64 intercept_precipitation
      (float64 water_reaching_plant)                              modification_
      { return Crop_common::intercept_precipitation(water_reaching_plant); }     //140320
   virtual const char  *get_description()                                 const;
   /*200420 replace with describe_periods
   ...
   */
   ...
   inline virtual const CORN::date32 &get_bud_break_date()                const  { return NA_date32;} // Not applicable to CropGro   //081013_
   inline virtual const CORN::date32 &get_initial_fruit_growth_date()     const  { return NA_date32;} // Not applicable to CropGro   //081013_
   inline virtual const CORN::date32 &get_rapid_fruit_growth_date()       const  { return NA_date32;} // Not applicable to CropGro   //081013_
   inline virtual const CORN::date32 &get_dormancy_start_date()           const  { return NA_date32;} // Not applicable to CropGro   //081013_
   inline virtual const CORN::date32 &get_dormancy_end_date()             const  { return NA_date32;} // Not applicable to CropGro   //081013_
   inline virtual const CORN::date32 &get_chill_requirement_satisfied_date()const  { return NA_date32;} // Not applicable to CropGro   //081013_
 ...
 protected:  // The following
   ...
   inline virtual float64 get_canopy_interception_global_green()           const { return 0.0; /* N/A */  }
 ...
 public:  // The following are processes used by the calling program
   ...
   inline virtual float64 update_evapotranspiration_max                          //190812_010910
      (float64 ET_ref_m)                                         rectification_  //200127
                { return Crop_common::update_evapotranspiration_max(ET_ref_m); }
 ...
 private:
   ...
   float64 calc_cover_fract(float64 xAI)                                  const; //000623
...
//_Crop_interfaced_CropGro_____________________________________________________/
#endif
