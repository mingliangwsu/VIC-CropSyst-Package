...
//_Date_cowl_const__________________________________________________2017-08-24_/
template <typename dateT>  // floating point or integer
class Date_cowl
...
//_Date_cowl________________________________________________________2017-08-24_/
template <typename dateT>  // floating point or integer
class Date_clad
: public extends_ Date_cowl<dateT>
{
 public:
   //200220 friend class Tabular_format;
...
//_Date_clad________________________________________________________2017-08-24_/
