...
|STAT_final_bit
;
//_statistic_units_matches_observation_units___________________________________/
nat32 statistics_string_to_mask(const std::string &options_string)
{  return statistics_ASCIIz_to_mask(options_string.c_str());
}
//_statistics_string_to_mask________________________________________2017-03-18_/
...
//_statistics_mask_to_string________________________________________2017-03-18_/
