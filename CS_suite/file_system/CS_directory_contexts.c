...
,  { 3,true ,"weather"              ,"folder_weather.ico"     ,"common\\weather\\UED_weather_editor.exe"    ,"UED"            ,"UED"            ,"UED weather"}                   //  8
,  { 3,true ,"soil"                 ,"folder_soil.ico"        ,"CropSyst\\soil_editor.exe"              ,CS_soil_EXT_V5       ,CS_soil_EXT_V4      ,"CropSyst soil"}                 //  9
,  { 3,true ,"rotation"             ,"folder_rotation.ico"    ,"CropSyst\\rotation_editor.exe"          ,CS_rotation_EXT_V5   ,CS_rotation_EXT_V4  ,"CropSyst rotation"}             // 10
,  { 3,true ,"crop"                 ,"folder_crop.ico"        ,"CropSyst\\crop_editor.exe"              ,CS_crop_EXT_V5       ,CS_crop_EXT_V4      ,"CropSyst crop"}                 // 11
,  { 3,true ,"management"           ,"folder_management.ico"  ,"CropSyst\\management_editor.exe"        ,CS_management_EXT_V5    ,CS_management_EXT_V4,"CropSyst management"}           // 12
