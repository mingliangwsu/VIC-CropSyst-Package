...
,const CS::Solar_radiation_extraterrestrial  &_ET_solar_radiation_new            //150625
...
,ET_solar_radiation_new(_ET_solar_radiation_new)                                 //150625
...
,pot_solar_rad(0)
{}
//_Solar_radiation_with_estimation_parameter:constructor____________2010-12-08_/
...
,_ET_solar_radiation_new                                                         //150625
,_air_temperature_max,_air_temperature_min,_air_temperature_avg)
, min_temp_adjacent_day(0)
{}
//_constructor______________________________________________________2010-12-08_/
...
{
   const CORN::Quality &worst_temperature_quality
      = air_temperature_max.worst(air_temperature_min);                          //081024
   ...
   pot_solar_rad = ET_solar_radiation_new.get_MJ_per_m2_day();                   //150625_011009
/*150627
   // new will replace old, but need to check that it has same value

   pot_solar_rad = ET_solar_radiation_old.get_extraterrestrial_radiation_today();  //011009
*/
...
const CORN::Quality &Solar_radiation_with_Donatelli_Campbell_estimation_parameter::update() rectification_
{
   ...
   {const CORN::Quality &result_quality = Solar_radiation_with_estimation_parameter::update();
      if (air_temperature_max.is_valid() && air_temperature_min.is_valid())      //200328
      {
...
{  const CORN::Quality &result_quality = Solar_radiation_with_estimation_parameter::update();
   ...
   pot_solar_rad_last_month = ET_solar_radiation_new.get_MJ_per_m2_day(date_minus_30.get_DOY());  //150625_011009
   float64 est_value = compute
...
{  float64 Tnc = generation_parameters.Tnc;
   if (CORN::is_zero<float64>(Tnc)) return 0; // invalid                         //200329
...
//_compute______________________________________________2010-12-08__1998-03-31_/
float64 Solar_radiation_with_Campbell_estimation_parameter
::estimate_summer_B_solar_rad()                                            const
...
//_estimate_summer_B_solar_rad______________________________________2010-12-08_/
...
//_estimate_winter_B_solar_rad______________________________________2010-12-08_/
...
//_summer_B_period__________________________________________________2010-12-08_/
...
//_compute__________________________________________________________2010-12-08_/
...
//_calc_atmospheric_transmissivity__________________________________2010-12-08_/
...
//_calc_atmospheric_transmissivity__________________________________1997-07-11_/
