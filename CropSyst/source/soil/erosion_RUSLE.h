...
: public extends_ CS::Simulation_element_abstract                                //160503
{
 ...
 public:  // RUSLE_annual_C_factor temporarily public for special output for Manuel
   CORN::statistical::Sample_dataset_clad<float64,float64,float32> C_factor_tally;//160616_160506
 ...
 private: // current year
   CORN::statistical::Sample_dataset_clad<float64,float32,float32> storm_energy;  //160616_160506
   CORN::statistical::Sample_dataset_clad<float64,float64,float32> storm_R_tally; //160616
         // (MJ/ha) * (mm/hr)
...
//_class:Soil_erosion_RUSLE_________________________________________1998-07-29_/
