#This class is abandoned/obsolete
...
class Directory_entry_name_logical
...
public: // queries
   ...
   virtual bool is_relative()                                      affirmation_;
      /**< \return true if the name has a relative (or partial) path
         ...
         Use is_qualified_relative() if you do not want to consider unqualifed names.
      **/
   virtual bool is_qualified_relative()                            affirmation_;
...
//_Directory_entry_name_logical________________________________________________/
