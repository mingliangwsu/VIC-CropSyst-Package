...
/*_980426*/ enum Request_method {REQUEST_DEBUG,GET,POST};
            ...
            DECLARE_ENUM_CLAD(Request_method_clad,Request_method,request_method_label_table);
            //190113 DECLARE_LABELED_ENUM(Request_method_labeled,Request_method,request_method_label_table);
