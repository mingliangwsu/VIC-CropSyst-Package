...
: public Data_record
{public:
   Container &tabular_data_columns;   // list of Delineated columns
   sint16 year_offset_for_dates_with_only_two_digits_Y;                            //120331
 public: //constructor
   Delineated_data_record
      (Container &_tabular_data_columns
 ...
 public: // virtual overrides
   ...
   inline virtual sint16 get_year_offset_for_dates_with_only_two_digits()  const { return year_offset_for_dates_with_only_two_digits_Y; }
 public:
