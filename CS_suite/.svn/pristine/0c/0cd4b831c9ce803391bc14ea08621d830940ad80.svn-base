...
//_Soil_with_sublayering:constructor___________________________________________/
Soil_with_sublayering::~Soil_with_sublayering()
{
   if (soil) delete soil; soil = 0;
}
//_Soil_with_sublayering:destructor____________________________________________/
