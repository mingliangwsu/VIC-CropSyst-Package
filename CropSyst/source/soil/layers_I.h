...
interface_ Layers_interface
{
 ...
 public: // Soil parameter accessors
   ...
   */
          virtual nat8 count()                                          const=0;
   //190123   { return get_number_layers(); }
   inline virtual nat8 count_uninundated()                              const
      //190123 was get_number_uninundated_layers
      { return count(); }                                                        //190123_131122
 ...
 public: // set accessors
   inline virtual nat8  set_number_uninundated_layers
      (nat8 new_uninundated_layers)                                modification_
       { UNUSED_arg(new_uninundated_layers); return 0; }                             //131122
