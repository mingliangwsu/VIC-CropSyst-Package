...
//______________________________________________________________________________
bool Worksheet::is_key_string(const std::string &key)         affirmation_
{
...
//______________________________________________________________________________
/*180820 
const char *Worksheet::get_key()                                    const
{
   static std::string sheet_name;
   get_name(sheet_name);
...
const BIFF_cell_record *Worksheet::Row_set::get_cell(nat16 col)     const
{
...
#endif
//______________________________________________________________________________
Cell_textual *Worksheet::Row_set::provide_textual_record(nat16 col) provision_
...
Cell_numeric *Worksheet::Row_set::provide_numeric_record
...
//_2011-10-06___________________________________________________________________
//120105 sint16 Worksheet::set_cell_integer(nat16 col, nat32 row, sint16 value)
sint32 Worksheet::set_cell_integer30(nat16 col, nat32 row, sint32 value)
...
//______________________________________________________________________________
const std::string & Worksheet::set_cell_label
(nat16 col, nat32 row
...
//______________________________________________________________________________
const std::wstring &Worksheet::set_cell_label_wstring
...
float64 Worksheet::set_cell_number(nat16 col, nat32 row, float64 value,uint8 precision)
{
   redimension_if_necessary(col,row);
   Row_set *row_set = provide_row(row);
...
//______________________________________________________________________________
int32 Worksheet::set_cell_date(nat16 col, nat32 row,       const CORN::Date_const &date_value)
...
//______________________________________________________________________________
int32 Worksheet::get_cell_integer30(nat16 col, nat32 row)           const
{  Row_set *row_set = provide_row(row);
...
//______________________________________________________________________________
bool Worksheet::get_cell_bool(nat16 col, nat32 row)                  const
{  Row_set *row_set = provide_row(row);
   Cell_numeric *numeric_record = row_set->provide_numeric_record
      (col,DT_int32);
...
float64 Worksheet::get_cell_number(nat16 col, nat32 row)             const
{  Row_set *row_set = provide_row(row);
   Cell_numeric *numeric_record = row_set->provide_numeric_record(col,DT_float64);
   return numeric_record ? numeric_record->get_float64() : 0.0;
}
//______________________________________________________________________________
const std::wstring &Worksheet::get_cell_label  (nat16 col, nat32 row,std::wstring &label)   const
{  Row_set *row_set = provide_row(row);
assert(false); // NYI
...
//______________________________________________________________________________
void Worksheet::commit(Workbook /*190113 Excel_workbook*/ &workbook)
{
/*
Required Records
...
//______________________________________________________________________________
void Worksheet::redimension_if_necessary(nat16 col, nat32 row)
{  if (dimensions)
...
//______________________________________________________________________________
void Worksheet::create_bof()                                        //provision
{  switch (format)
...
//_create_bof__________________________________________________________________/
#ifdef NYI
void Worksheet::create_index()
{  switch (format)
   {
...
#endif
//______________________________________________________________________________
void Worksheet::create_dimensions()                                //provision
{  switch (format)
   {  case BIFF2 :
...
//_create_dimensions___________________________________________________________/
void Worksheet::create_window1()
{  window1 =  (format <= BIFF4)
   ?  (BIFF_rec_WINDOW1_common *)new BIFF234_rec_WINDOW1
   :  (BIFF_rec_WINDOW1_common *)new BIFF578_rec_WINDOW1;
}
//_create_window1______________________________________________________________/
BIFF_rec_WINDOW2_common &Worksheet::provide_window2()                 provision_
{  if (!window2)
   switch (format)
   {  case BIFF2:
...
//______________________________________________________________________________
BIFF_rec_PANE  &Worksheet::provide_pane()                             provision_
{  if (!pane) pane = new BIFF_rec_PANE;
   return *pane;
}
//_provide_pane________________________________________________________________/
void Worksheet::freeze_pane
(nat16 left_most_column_, nat16 top_most_row_,BIFF_rec_PANE::Panes active_pane )
{  if (!pane)
...
*/
   provide_window2();
   pane->freeze(left_most_column_ ,top_most_row_,active_pane );
   window2->set_has_frozen_panes(true);
}
//_freeze_pane_________________________________________________________________/
nat32 Worksheet::get_first_define_row()                                    const
{  return dimensions ? dimensions->get_first_define_row() : 0; }
nat32 Worksheet::get_first_define_column()                                 const
//  Excel only has 16bit column indexes
{  return dimensions ? dimensions->get_first_define_column() : 0; }
nat32 Worksheet::get_last_define_row()                                     const
{  return dimensions ? dimensions->get_last_define_row() : 0; }
nat32 Worksheet::get_last_define_column()                                  const
//  Excel only has 16bit column indexes
{  return dimensions ? dimensions->get_last_define_column() : 0; }
//______________________________________________________________________________
nat16 Worksheet::get_row_count()                                    const
{  nat16 row_count = 0;
...
//_get_row_count_______________________________________________________________/
#ifdef DISABLED
101127
This is dependent on get_cell which I needed to disable
This class is deprecated and is not longer used for reading,
instead, use Cell_reader
bool Worksheet::is_cell_empty(nat16 col, nat32 row)                   const
{  bool result = false;
...
//______________________________________________________________________________
#endif
Worksheet::Row_set *Worksheet::provide_row(nat32 row)                 provision_
...
//_provide_row_________________________________________________________________/
Worksheet::Row_set *Worksheet::get_row(nat32 row)
{  Row_set *row_set = (Row_set *)row_sets.find(row);
   return row_set;
}
//_get_row_____________________________________________________________________/
void Worksheet::freeze_pane(nat16 left_most_column,nat32 top_most_row )
...
//_freeze_pane_________________________________________________________________/
const std::string &Worksheet::get_name(std::string &sheet_name)            const
{  boundsheet->get_sheet_name(sheet_name);
   return sheet_name;                                                            //101127
}
//_get_name_____________________________________________________________________
Worksheet::Row_set::Row_set(nat32 row_number, BIFF_Format _format)
: Item()
, row_record(0)
, cell_records()
, format(_format)
...
//_Row_set:constructor_________________________________________________________/
Worksheet::Row_set::Row_set(BIFF_rec_ROW_abstract  *_row_record)
: row_record (_row_record)
, cell_records()
{}
//_Row_set:constructor_________________________________________________________/
nat32 Worksheet::Row_set::get_key_nat32()                                  const
{ return row_record->get_row(); } ;
//_get_key_nat32_______________________________________________________________/
bool Worksheet::Row_set::is_key_nat32(nat32 key)                    affirmation_
{  return row_record->get_row() == key;
}
//_is_key_nat32_____________________________________________________2019-01-13_/
}}//_namespace_CORN::Excel_BIFF________________________________________________/
