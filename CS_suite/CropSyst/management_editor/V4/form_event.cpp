...
//150403   CORN::File_name parameters_event_period_htm; CS::Suite_directory->find_file_name("period.htm",parameters_event_period_htm);
   ...
   //190527 canms_options_radiogroup->bind_to(&(event->enable_for_model_labeled),0); // no help yet
#ifdef DISABLED
...
void __fastcall Tevent_editor_form::show_hide_controls(TObject *Sender)
{
   ...
   //190527 CANMS_operation_fileeditbar->Visible =  event->enable_for_model_labeled.get() == SECONDARY_OVER_PRIMARY;
