...
class Container                                                                  //991105
{
 ...
 public:
   ...
   virtual nat32 transfer_all_from  //200202 rename to take_from
   ...
   */
   ...
   inline virtual nat32 clear()           modification_ { return delete_all(); } //181111
 ...
 protected:
   virtual Item *delete_unappropriatable(Item *new_item)         appropriation_;
};
//_Container___________________________________________________________________/
...
{  CORN::Container::Iterator *iterator_name = (container).iterator();          \
   ...
   {
//_FOR_EACH_IN_REVERSE_PARALLEL_____________________________________2017-05-28_/
#else
...
//_FOR_ITERATION_______________________________________________________________/
