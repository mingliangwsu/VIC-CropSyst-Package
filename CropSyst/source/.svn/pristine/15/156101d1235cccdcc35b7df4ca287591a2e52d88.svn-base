...
: public extends_ Biomass_production_transpiration_dependent_common
{
   ...
   //_TUE_Equation_curve_______________________________________________________/
   ...
   : public implements_ TUE_Equation
   {
    ...
    public:
       inline TUE_Equation_AquaCrop_water_productivity
         (const float32 &param_AquaCrop_water_productivity_
         ,const float64 &pot_ref_evapotranspiration_)
         : TUE_Equation                                                       ()
         , param_AquaCrop_water_productivity(param_AquaCrop_water_productivity_)
         , pot_ref_evapotranspiration              (pot_ref_evapotranspiration_)
         {}
      virtual float64 calculate()                                  calculation_;
   };
   //_TUE_Equation_AquaCrop_water_productivity_________________________________/
 private:
...
//_Biomass_production_transpiration_dependent_V5____________________2015-10-30_/
