...
{  // This may be use for daily or instantaneous values
 ...
 public:
   ...
   float64 calc_from_dew_point
      ...
      ,bool over_water_only = true)                                calculation_;
   ...
   float64 calc_from_vapor_pressure_deficit                                      //080617
      ...
      ,bool over_water_only = true)                                calculation_;
 private: // accessors
   bool is_valid_dew_point_temperature()                           affirmation_;
   bool is_relative_humidity_better_than_derived()                 affirmation_; //100412
   bool is_valid_temperature()                                     affirmation_;
};
//______________________________________________________________________________
#endif
