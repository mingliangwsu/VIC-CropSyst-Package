...
//_Rotation_entry:constructor__________________________________________________/
...
//_Rotation_entry:constructor_______________________________________1999-02-23_/
...
//_compare__________________________________________________________1999-02-23_/
bool Rotation_entry::qualify()
{  crop_filename.qualify();
   management_filename.qualify();
   return true;
}
//_qualify__________________________________________________________2000-02-12_/
/*190718
...
//_write____________________________________________________________1999-02-23_/
Rotation_file::Rotation_file()
: Bidirectional_list()
, Data_record("-")
{}
//_Rotation_file_constructor________________________________________1999-02-23_/
void Rotation_file::load(const ROT_filename &i_file_name)
{
   ...
   {  rot_entry_str.read_line(rot_strm);
      if ((rot_entry_str.length() == 0) || rot_strm.eof())
        at_eof = true;
      if (!at_eof)
...
//_load_____________________________________________________________1999-02-23_/
void Rotation_file::save(const ROT_filename &i_file_name)
{  ofstream rot_strm(i_file_name.c_str());
   write(rot_strm);
};
//_save_____________________________________________________________1999-02-23_/
bool Rotation_file::qualify(const CORN_Directory_name &rot_dir_name)
...
//_qualify__________________________________________________________2000-02-11_/
