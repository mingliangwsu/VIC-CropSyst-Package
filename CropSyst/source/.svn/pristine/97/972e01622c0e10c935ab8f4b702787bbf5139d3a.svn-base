...
//_Organic_matter_simple:constructor___________________________________________/
...
//_recalibrate_________________________________________________________________/
...
//_receive_mineralized_N________________________________________________________
...
//_total_profile_biomass_______________________________________________________/
...
{  // Returns the organic matter balance
   ...
   float64 bal =
      ...
      - total_recalibration_difference
      - total_profile;
   if (CORN::is_zero<float64>(bal/*020127,0.0,0.000001*/))
      bal = 0.0;
    return bal;
}
//_balance______________________________________________________________________
...
//_get_molecular_N______________________________________________________________
...
//_extract_active_molecular_N__________________________________________________/
void Organic_matter_simple::intromit_active_molecular_N
(soil_sublayer_array_64( molecular_N))
{  for (nat8 sublayer = 1 ; sublayer <= MAX_soil_sublayers; sublayer++)
...
//_intromit_active_molecular_N_________________________________________________/
float64 Organic_matter_simple::get_organic_carbon
(nat8 sublayer , float64 layer_thickness )                                 const
...
//_get_biomass______________________________________________________1998-07-19_/
float64 Organic_matter_simple::get_percent
(nat8 sublayer, float64 thickness_sl, float64 bulk_density_sl)
{  return (get_biomass(sublayer) * 100.0) / (thickness_sl * tonne_to_kg(bulk_density_sl));
}
//_get_percent______________________________________________________1999-02-10_/
