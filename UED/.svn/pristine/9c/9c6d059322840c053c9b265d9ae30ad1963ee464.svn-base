...
#pragma pack()
//______________________________________________________________________________
void NCDC_NOAA_global_surface_summary_of_the_day_convertor::import_record_V6( NCDC_NOAA_global_surface_summary_of_the_day_format_V6 &element_record, CORN::OS::Directory_name &ued_file__path)
{
...
//______________________________________________________________________________
void NCDC_NOAA_global_surface_summary_of_the_day_convertor::import_record_V7( NCDC_NOAA_global_surface_summary_of_the_day_format_V7 &element_record, CORN::OS::Directory_name &ued_file__path)
{
   element_record.delimA = 0; // Quick and dirty way to extract STN as null terminated string
		...
		{  CORN::Ustring station_IDs_filter(parameters.station_IDs_filter);
	             ...
	             )
         {
                ...
                || (buffer_read == buffer_size_V6 -1)) // The file may or may not have trailing spaces
		      {
		         ...
		         import_record_V6(data_buffer_V6,*ued_file__path);  //051213  ued_file__path may be obsolete
		         records_imported++;
		      }
                     ...
                     || (buffer_read == buffer_size_V7-1)) // The file may or may not have trailing spaces
		      {
               memcpy((char *)&data_buffer_V7,buffer_str.c_str(),buffer_size_V7);
		       	import_record_V7(data_buffer_V7,*ued_file__path);  //051213  ued_file__path may be obsolete
		         records_imported++;
