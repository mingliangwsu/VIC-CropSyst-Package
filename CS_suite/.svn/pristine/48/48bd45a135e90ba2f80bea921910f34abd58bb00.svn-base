...
, column    (_column)
{}
//_Reporter:constructor_____________________________________________2015-09-19_/
Reporters::Reporters
(
 Output_aggregation         aggregation_
,const CORN::OS::File_name &TDF_filename_)
: CORN::Unidirectional_list                                               (true)
, format                                                                      ()
, TDF_filename                                                   (TDF_filename_)
, last_known_inspector_count                                                 (0)
, aggregation                                                     (aggregation_)
{
   load_TDF_format(TDF_filename);
}
//_Reporters:constructor____________________________________________2015-09-19_/
Reporters::Reporters
(Output_aggregation         aggregation_)
: CORN::Unidirectional_list                                               (true)
, format                                                                      ()
...
//_load_TDF_format__________________________________________________2015-09-19_/
bool Reporters::initialize()                                     initialization_
{
      bool annual_mode = aggregation == annual_aggregation;
         ...
         //NA date_column->record_type_clad
         //NA date_column->variable_code_clad.code
         ...
         else                                                                    //141201
         {
            ...
            //NA crop_name_column->record_type_clad
            /*150929
            #if (CS_VERSION < 5)
            // In V5 I am trying to eliminate predefined variable codes
            crop_name_column->variable_code_clad.set(CSVC_crop_base_name);
            #endif
            */
...
//_resync___________________________________________________________2015-09-19_/
...
//_resync_to_predefined_format______________________________________2015-09-19_/
         ...
         switch (aggregation)
         {
            case annual_aggregation : case season_aggregation : case daily_aggregation :
            {
               ...
               // for (nat16 vd = 0; vd <variable_definition_count; vd++)
               {
                  ...
                  //column->record_type_clad only used with importing to UED
                  column->variable_code_clad.set(0); // variable code is not currently used (In V5)
...
//_resync_defining_format___________________________________________2015-09-19_/
...
//_find_reporter_with_properties____________________________________2015-09-19_/
...
//_find_inspector_with_properties___________________________________2015-09-19_/
...
//_find_inspector___________________________________________________2015-09-19_/
...
//_find_reporter_with_inspector_____________________________________2015-09-19_/
...
//_find_reporter_with_column________________________________________2015-09-19_/
bool Reporters::stop()                                              modification_
{
   ...
   if (!predefined_format)
   {
      ...
      CORN::OS::file_system_engine.provide_directory(format_dir);
      CORN::VV_File TDF_file(TDF_filename.c_str());
      stopped = TDF_file.set(format);
   }
   return stopped;
}
//_Reporters________________________________________________________2015-09-19_/
bool Reporting::start()                                            modification_
{
   if (reporters.predefined_format)
   {
      /*
         ...
         {  column_start.append(format_column->start_number);                    //100104
...
//_start____________________________________________________________2015-09-19_/
...
{  bool ended = reporters.resync();
   if (reporters.predefined_format)
   {
      ...
      {
         if (first_column)
            reporters.format.detail_lines_delineation.get_delimiter();
...
: TDF_filename
 (project_database_format_directory,get_aggregation_filename(aggregation),"TDF")
, report_filename
 (scenario_output_directory        ,get_aggregation_filename(aggregation),"dat")
, report_stream                                        (report_filename.c_str())
, reporters                                           (aggregation,TDF_filename)
, today                                                                 (_today)
{
}
//_2015-09-19__________________________________________________________________/
