...
#endif
{
 ...
 public:
   ...
   nat32 render_planting_events_adjusted_for_weather_conditions
      (CS::Weather_database_daily &weather // eventually delete this line
      ,modifiable_ CORN::Container &event_list
      ,CORN::Year start_year
      ,CORN::Year stop_year
      ,nat8 cycle)                                                        ;//const;
...
//_Rotation_________________________________________________________2016-07-08_/
...
//_Rotations________________________________________________________2016-07-08_/
