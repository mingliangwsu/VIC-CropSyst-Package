...
public:
 ...
 public:
   Common_parameters_directory                                                   //060614
      ...
      ,bool        create_now /*100729 = false */
      // if associated_parameters_filename!=0 then we may need to create the directory //060614
      );                                                                         //060614
 ...
 public:
   ...
   inline virtual bool get_notes_filename                                        //090222
      (CORN::Smart_file_name &return_filename
      ,bool check_existence = false)                                      const
            { return get_filename("notes.txt",return_filename,check_existence);}
#endif
...
#endif
   inline virtual const CORN::OS::File_name_concrete &get_folder_icon_filename
      (CORN::OS::File_name_concrete &icon_filename,int &icon_index)       const
      { icon_index = 0; return icon_filename;} //130215_060614
...
public:
   const CORN::Smart_file_name &get_filename
      (bool fully_qualified,const CORN::Smart_file_name &filename
      ,const CORN::Smart_directory_name &qualifaction_dir)          mutatation_; //041030
...
//_Parameters_directory_____________________________________________2012-02-02_/
}}//_namespace_CORN:OS_FS______________________________________________________/
#endif
