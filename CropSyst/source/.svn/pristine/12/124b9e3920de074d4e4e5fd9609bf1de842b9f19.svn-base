...
: public extends_ CropSyst::Layers_abstract
{
 ...
 public:
   ...
   virtual void expand_last_layer_for_boundary_conditions                           //080130
      (nat8 number_layers,nat8 number_expanded_layers)            modification_; // initialization 080211_
 ...
 public: // Soil parameter accessors
   virtual nat8   get_max_number_sublayers()                               const { return MAX_soil_sublayers; }
      // 190123 rename to count_max_sublayers
   ...
   inline virtual nat8    get_number_sublayers()                           const { return num_sublayers; }
      // 190123 rename to count_sublayers
   ...
   inline virtual nat8   count_max()                                       const {return get_max_number_sublayers(); }
      // This is the absolute maximum number of layers
      // (array dimension) that are reserved to store soil profile data by sublayer.
   inline virtual nat8   count()                                           const { return get_number_sublayers(); } //190123
      // This is the number of sublayers identified in the soil profile.
   inline virtual nat8   count_uninundated()                               const { return get_number_uninundated_sublayers(); }
...
//_Soil_sublayers___________________________________________________2005-11-16_/
#endif
