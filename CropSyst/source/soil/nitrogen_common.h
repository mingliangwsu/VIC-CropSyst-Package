...
class Nitrogen_common
: public Nitrogen
{
 protected:
   unmodifiable_ Structure &structure;
 public:
   inline Nitrogen_common
      (unmodifiable_ Structure &_structure)
      : Nitrogen()
      , structure(_structure)
      {}
   inline Nitrogen_common                                                        //140610
      (const Nitrogen_common &copy_from,float64 fraction)
      : Nitrogen()
