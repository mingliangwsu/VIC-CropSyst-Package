...
class Soil_abstract
: public Soil::Layers_interface // Soil_layers_interface
{
public: // Constructors
//   xSoil_abstract() {};
...
public: // Soil parameter accessors
   ...
   virtual nat8   sublayer_at
      (float64 a_given_depth_m = ENTIRE_PROFILE_DEPTH
      , bool limit_to_MAX_trans_sublayers=false)                        const=0;
...
public: // Soil profile parameter accessors (layer    number is 1 based)
   ...
   virtual float64 get_saturation_water_content_volumetric
      (nat8  layer   ,float64 current_ice_water_conten)                 const=0;
