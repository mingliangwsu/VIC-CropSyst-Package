...
, Xconvert_text_dBase_Excel_with_TDF_exe(0)//("text_dBase_Excel_with_TDF.exe")
, UED_collate_exe                      (0)                                       //190213
...
, convert_Excel_workbook_with_TDF_exe  (0)//("Excel_workbook_with_TDF.exe")
, Xconvert_text_dBase_Excel_with_TDF_exe(0)//("text_dBase_Excel_with_TDF.exe")
, UED_collate_exe                      (0)//("UED_collate.exe")                  //190213
, convert_CropSyst_exe                 (0)
// The following are convertors with export only
, convert_RZWQM_exe                    (0)
, convert_Canadian_Climatological_exe  (0)
...
void Application_directory::reset()                                    provision_
{
   ...
   delete Xconvert_text_dBase_Excel_with_TDF_exe;   Xconvert_text_dBase_Excel_with_TDF_exe = 0;
   delete UED_collate_exe;                         UED_collate_exe = 0;          //190213
#ifdef __unix
...
provide_directory_name_implementation  (UED::Application_directory,collate         ,collate_dir         ,"collate");
...
provide_file_name_implementation       (UED::Application_directory,compare_executable           ,compare_exe                  ,"compare.exe");  //181018
provide_file_name_implementation       (UED::Application_directory,dump_executable              ,dump_exe                     ,"dump.exe");     //181818
...
provide_subdir_file_name_implementation(UED::Application_directory,convert_text_dBase_Excel_with_TDF_executable,Xconvert_text_dBase_Excel_with_TDF_exe ,convert(),"text_dBase_Excel_with_TDF.exe");
provide_subdir_file_name_implementation(UED::Application_directory,UED_collate_executable,UED_collate_exe ,collate(),"UED_collate.exe");
