...
//_Crop_nitrogen_state_interface____________________________________2005-07-22_/
...
, public implements_ CS::Simulation_element                                      //150601
{
 ...
 public: // accessors
   ...
   virtual float64 update_limited_pot_transpiration()           modification_=0;
 ...
 public: // calculations
   ...
   virtual float64 calc_leaf_stress_factor()                     calculation_=0; //200529_070224
      //200529 (Nitrogen_leaf_stress_mode calc_mode)                             const=0; //070224
 ...
 public: // operations                                                           //070412
   ...
   virtual Crop_mass_fate *render_N_fate
      ...
      ,float64 root_before)                                        rendition_=0; //131005
...
//_Crop_nitrogen_interface_____________________________________________________/
