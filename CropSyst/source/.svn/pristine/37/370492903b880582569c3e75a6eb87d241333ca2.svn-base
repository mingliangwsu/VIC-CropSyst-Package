...
//_Tally_aggregator:constructor________________________________________________/
...
{  sint32 polygon_ID; // Signed because negative number is offsite indicator
 ...
 public:
   ...
   inline virtual nat32 get_key_nat32()      const { return (nat32)polygon_ID;}
      // At this point polygon_ID will be positive because we don't include offsite values
};
//_Polygon_aggregation_________________________________________________________/
...
//_aggregate___________________________________________________________________/
...
,Generic_data_record *_weighted_average_data_record)
{
   ...
   Polygon_aggregation *polygon_aggregation = (Polygon_aggregation *)polygon_aggregations.find((nat32)_polygon_ID);
   ...
   {  polygon_aggregation = new Polygon_aggregation(polygon_ID_attribute.c_str()
         ,_polygon_ID, _cropable_percentage,_weighted_average_data_record);      //051116
      polygon_aggregations.append(polygon_aggregation);
   }
   return polygon_aggregation;
}
//_provide_polygon_aggregation__________________________________________________
nat32 Tally_aggregator::aggregate()
{
   nat32 polygons_aggregated = 0;
