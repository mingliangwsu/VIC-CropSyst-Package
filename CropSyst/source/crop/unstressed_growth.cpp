...
{}
//_Unstressed_growth:constructor_______________________________________________/
void Unstressed_growth::initialize()                             initialization_
{  O_cover_green_fract       = 0;
...
//_initialize_______________________________________________________2001-10-16_/
...
{  O_biomass                = init_biomass;
   ...
   O_GAI                    = init_GAI;
   O_cover_green_fract      = init_cover_green_fract;
}
//______________________________________________________________________________
...
{  if (growth_stage >= NGS_GERMINATION)
      O_cover_green_fract= unstressed_fract_canopy_cover;                        //011016
...
//_update_attainable_top_growth_____________________________________2005-05-05_/
float64 Unstressed_growth::update_evapotranspiration_max
(float64 ET_ref_m,float64 act_GAI)
{  // Note, I am not sure why this is multiplied by fraction of green cover.
   O_pot_transpiration_CO2_adjusted = (act_GAI > 0.0)
   ? (O_cover_green_fract * ET_ref_m) * CO2_transpiration_adjustment_factor      //151031
   : 0.0;
   return ET_ref_m;
}
//_update_evapotranspiration_max____________________________________2001-10-16_/
void Unstressed_growth::adjust_for_removal(float64 new_biomass,float64 new_GAI)
{  O_biomass = new_biomass;
   O_GAI = new_GAI;
}
//_adjust_for_removal_______________________________________________2004-12-06_/
