...
#define convert_halflife_to_constant(decomp_time_50) (decomp_time_50 > 0.0 ? (- CORN_ln(0.5)/ (float64)decomp_time_50) : 0.0)

/*200220 These are no longer used because we now normalize as halflife
don't delete may want to keep for conversions
