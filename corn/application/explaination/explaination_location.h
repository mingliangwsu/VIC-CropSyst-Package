...
//_struct Documentation_paths_fully_qualified__________________________________/
...
public:
   ...
   DECLARE_DESCRIPTIVE_ENUM_CLAD(Severity_labeled,Severity,severity_label_table)
   //190114 DECLARE_DESCRIPTIVE_LABELED_ENUM(Severity_labeled,Severity,severity_label_table)
public:  // This class is used for internal communication of error information
   ...
   **/
   ...
   Text_list   context_URIs;
      ...
      // For VV/parameter files this may the the fully qualified name of the
      // parameter file and the name of the edit control this way the help viewer
      // can open the problem file and focus on the edit control where the error
...
//_class_Explaination__________________________________________________________/
} // namespace CORN;
#endif
