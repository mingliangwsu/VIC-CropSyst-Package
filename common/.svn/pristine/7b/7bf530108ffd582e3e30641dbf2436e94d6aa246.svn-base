...
{protected:
 ...
 public: // Vapor pressure accessors
   ...
   virtual float64 get_curr_avg_fullday_vapor_pressure_deficit
      (Quality &quality)                                                  const; //050801
      // I don't think I need to return quality any more
      // since this should be a parameter and we have the quality
   float64 curr_vapor_pressure_actual_calc_saturation_kPa
      (float64 at_temperature_C, float64 air_temp_C, bool over_water_only) modification_;  //050802
 private:
