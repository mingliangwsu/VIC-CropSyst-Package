...
)
{
   ...
   float64 Solar_Elev = CORN::must_be_0_or_greater<float64>(asin(Sine_Solar_Elev));
...
//_expand_dimension_________________________________________________2000-07-17_/
...
//_expand_dimensions___________________________________________________________/
