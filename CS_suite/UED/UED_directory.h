...
protected:
   ...
   provided_ CORN::OS::Directory_name_concrete *collate_dir;
   ...
   provided_ CORN::OS::File_name_concrete *Xconvert_text_dBase_Excel_with_TDF_exe;
   provided_ CORN::OS::File_name_concrete *UED_collate_exe;                      //190213
...
#endif
   provided_ CORN::OS::File_name_concrete *compare_exe;                          //181018
   provided_ CORN::OS::File_name_concrete *dump_exe;                             //181018
public: // 'structors
...
public:
   ...
   const CORN::OS::Directory_name &collate()                          provision_;
   ...
   const CORN::OS::File_name &UED_collate_executable()                      provision_; //190213
   ...
   const CORN::OS::File_name &compare_executable()                          provision_; //181018
   const CORN::OS::File_name &dump_executable()                             provision_; //181018
};
