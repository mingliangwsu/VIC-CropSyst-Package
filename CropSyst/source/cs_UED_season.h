...
class Season_data_record : public CORN::Data_record
{
   ...
   CORN::Date_clad_32 tuberization_date;     //181111 tuber_init_date;           //081111
   CORN::Date_clad_32 yield_formation_date;  //181111 grain_filling_date;
   CORN::Date_clad_32 culminescence_date;    //181111 peak_LAI_date;
   CORN::Date_clad_32 maturity_date;
   CORN::Date_clad_32 harvest_date;
   #ifdef CROP_ORCHARD
   CORN::Date_clad_32 bud_break_date;                                            //081013
   CORN::Date_clad_32 fructescence_date;  //181111 initial_fruit_growth_date;                                 //081013
   ...
   float32  fruit_reserves_biomass;                                              //200608
   #endif
...
#           define season_section  "growing_season"
 // special outputs
   ...
   float32 degree_hours_above_30_season;                                         //180919
   float32 degree_hours_above_35_season;                                         //180919
   #endif
   float32 WUE;
   float32 Srad_mean;
   float32 Tmax_mean;
   ...
   float32 duration_season_days;                                                 //160527
   float32 GDDs_normal; // Growing DegreeDays                                    //200722
   float32 canopy_cover_max;                                                     //180413
   float32 canopy_cover_green_final;                                             //180413
   float32 canopy_cover_total_final;                                             //200127
 public: // constructor
   Season_data_record();
   void update
      (const CropSyst::Crop_model_interface  &crop                               //131008NS
      ,const CropSyst::Soil_components &soil                                     //141106
...
//_Season_data_record__________________________________________________________/
...
//_Season_data_source__________________________________________________________/
#endif
