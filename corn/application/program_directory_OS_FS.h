...
protected:
   provided_ Suite_directory         *suite_directory;       bool suite_directory_owned;
   // Typically the parent directory of this program's application directory.
   // May be 0 if the program is not part of a suite.
   provided_ Application_directory   *application_directory; bool application_directory_owned;
...
//_Program_directory___________________________________________________________/
extern Program_directory *program_directory;
}}//_namespace CORN::OS_FS_____________________________________________________/
#endif
