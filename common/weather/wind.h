...
//             eventually I would like to store in a single units
 ...
 public:  // accessors
   inline float64 get_aerodynamic_resistance_of_snow
      (Seconds time_step = SECONDS_PER_METER) const
      { return aerodynamic_resistance_of_snow_s_m / time_step; }
    // timestep/meter or def: seconds/meter

   inline float64 set_aerodynamic_resistance_of_snow_s_m
      (float64 aero_resist_s_m)                                     assignation_ //011009
...
//_Wind________________________________________________________________________/
#endif
