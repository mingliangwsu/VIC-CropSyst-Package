#error obsolete now use scenario generator and collation
...
//_GIS_simulation:constructor__________________________________________________/
GIS_simulation::~GIS_simulation()
{
   if (coverage_PAT)     delete coverage_PAT; coverage_PAT = 0;                  //050927
}
//_GIS_simulation:destructor________________________________________2005-07-29_/
...
//_add_table_line______________________________________________________________/
...
//_generate_scenarios__________________________________________________________/
...
//_provide_STATSGO_database_________________________________________2005-08-19_/
...
//_check_run_STATGO_scenario___________________________________________________/
...
//_run_scenarios_______________________________________________________________/
...
//_tally_scenarios_____________________________________________________________/
...
//_aggregate_scenarios_________________________________________________________/
...
//                   Only run the simulation file if no outputs already exists, we don't need to rerun the simulation
      ...
      {
         std::string status_note("Using previously run polygon/cell/scenario:");
         status_note.append(scenario_ID_str);                                    //050919
         run_form->append_status(status_note.c_str());
               status = ready_status;                                            //000627
      }
...
//_parameterize_and_run_scenario____________________________________1999-06-11_/
nat8 GIS_simulation::get_range_of_MUID_sequence_numbers(const char *MUID)
{
...
//_get_range_of_MUID_sequence_numbers_______________________________2005-07-20_/
...
// Keep the following
#ifdef DONT_DELETE
   FXiltered_file_name harvest_htm;                                               //030516
...
//_clean_up_scenario________________________________________________2005-09-20_/
...
//_get_generated_scenarios_directory_qual___________________________2014-02-14_/
