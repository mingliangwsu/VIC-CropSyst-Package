...
: P_T_constant_obsolete(DEF_PT_constant)
...
{
   P_T_constant_obsolete   = from.P_T_constant_obsolete;
...
{
   data_rec.expect_float32 ("PT_constant",P_T_constant_obsolete);  // provided to support previous version
