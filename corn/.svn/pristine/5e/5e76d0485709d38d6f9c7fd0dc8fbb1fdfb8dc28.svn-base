#error no longer used and I have new convertors  200302
...
Tabular_text_parser::Tabular_text_parser(const Tabular_file_format/*200220 Common_tabular_file__format*/ &format)
...
*/
   ...
   while (!text_file_stream.eof())
   {
      ...
      if (the_char)
      {  // the_char may have been 'eaten' by the context update (I.e. as delimiter, white space, quotation etc.).
