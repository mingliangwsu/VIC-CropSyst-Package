...
void Hydrology_finite_difference::initialize(float64 *_node_depth)
{  node_depth = _node_depth;                                                     //080211
   update_soil_volume
      (soil_layers_ref.count()+2
      ,soil_layers_ref.count()+3);
}
//_initialize___________________________________________2008-02-11__2006-05-08_/
float64 Hydrology_finite_difference
::calc_water_depth_profile                                                       //130930
...
//_get_water_depth_profile__________________________________________2008-01-21_/
float64 Hydrology_finite_difference::get_liquid_water_depth_profile()      const
{  float64 WD_profile = 0;
   for (nat8 layer = 1; layer <=soil_layers_ref.count_uninundated(); layer ++)
   {  WD_profile += calc_liquid_water_content_layer
         (layer
...
//_get_liquid_water_depth_profile___________________________________2008-01-21_/
float64 Hydrology_finite_difference::extract_water
(soil_layer_array64(amount_to_extract_m),nat8 start_layer)
{  // Extraction could be water uptake or evaporation
   float64 act_total_amount_to_extract = 0.0;
   nat8 num_sublayers = soil_layers_ref.count();
...
//_extract_water____________________________________________________2001-05-22_/
Hydrology_finite_difference::Hydrology_finite_difference
      (const Layers_interface                 &_soil_layers_ref
      , const Hydraulic_properties_interface  &_hydraulic_properties_ref
      ,const Structure                        &_soil_structure)
: Hydrology_abstract
(_soil_layers_ref,_hydraulic_properties_ref,_soil_structure)
...
//_Hydrology_finite_difference:constructor_____________________________________/
Hydrology_finite_difference::Hydrology_finite_difference
(const Hydrology_finite_difference &copy_from
,float32 fraction)
: Hydrology_abstract
   (copy_from,fraction)
{
...
//_Hydrology_finite_difference_copy_constructor_____________________2014-06-09_/
float64 Hydrology_finite_difference
...
//_set_upper_and_lower_water_content_liquid_________________________2007-10-10_/
float64 Hydrology_finite_difference
...
//_calc_liquid_water_content_layer______________________2008-01-31__2007-08-30_/
float64 Hydrology_finite_difference
...
//_get_liquid_water_content_volumetric______________________________2006-05-08_/
bool Hydrology_finite_difference
::set_upper_and_lower_liquid_water_content_volumetric
...
//_set_upper_and_lower_liquid_water_content_volumetric_________________________/
float64 Hydrology_finite_difference::set_water_content_volumetric_layer          //010522
...
//_set_upper_and_lower_liquid_water_content_volumetric______________2007-08-27_/
float64 Hydrology_finite_difference
...
//_change_liquid_water_content_by_volumetric____________2008-01-27__2007-08-15_/
float64 Hydrology_finite_difference
::get_upper_water_content_liquid(nat8 layer)                               const
{  return upper_water_content_liquid[layer];
}
//_get_upper_water_content_liquid___________________________________2007-10-10_/
float64 Hydrology_finite_difference
::get_lower_water_content_liquid(nat8 layer)                               const
{  return lower_water_content_liquid[layer];
}
//_get_lower_water_content_liquid___________________________________2007-10-10_/
float64 Hydrology_finite_difference::set_upper_water_content_liquid
(nat8 layer,float64 new_WC)                                        modification_
{  return upper_water_content_liquid[layer] = new_WC;
}
//_set_upper_water_content_liquid___________________________________2009-01-07_/
float64 Hydrology_finite_difference
::set_lower_water_content_liquid(nat8 layer,float64 new_WC)        modification_
{  return lower_water_content_liquid[layer] = new_WC;
}
//_set_lower_water_content_liquid___________________________________2009-01-07_/
bool Hydrology_finite_difference::update_soil_volume                             //080211
...
//_update_soil_volume_______________________________________________2008-01-30_/
bool Hydrology_finite_difference::get_liquid_water_depth_nodes
...
//_get_liquid_water_depth_nodes_____________________________________2008-02-01_/
void Hydrology_finite_difference::expand_last_layer_for_boundary_conditions
(nat8 number_layers,nat8 number_expanded_layers)                   modification_
{  Hydrology_abstract
   ::expand_last_layer_for_boundary_conditions(number_layers,number_expanded_layers);
...
//_expand_last_layer_for_boundary_conditions________________________2008-02-12_/
float64 Hydrology_finite_difference::calc_water_potential_with_respect_to_layer
(float64 water_content_volumetric
// The WC is passed because it could be upper or lower or in the case of evaporation, the evaporation of the layer
,nat8 layer)                                                               const
{  
   ...
   float64 water_pot =
      (  CORN::is_zero<float64>(water_content_volumetric/*200127 ,0.0,0.00000001*/)
      || CORN::is_zero<float64>(sat_water_cont/*200127 ,0.0*/,0.00000001))
...
//_calc_water_potential_with_respect_to_layer_______________________2009-01-07_/
