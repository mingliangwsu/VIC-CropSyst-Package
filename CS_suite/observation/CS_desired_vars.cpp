#error 2019-01-22 replaced with CS_optation.cpp removed from your project
...
{  nat32 found_at_index = 0;
   bool desired
      = desire_everything || occurs((nat32) var_code,found_at_index);
   return desired;
}
//______________________________________________________________________________
...
{  bool added = false;
   ...
   added = !occurs(var_code,existing_position);
   if (added)
      append(var_code);
   return added;
}
