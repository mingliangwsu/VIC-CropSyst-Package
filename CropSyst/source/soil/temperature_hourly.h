...
// Eventually put the following in the Soil namespace
...
{  // This class is normalized meters, kilogram, hour
 private:
   ...
   const Soil::Soil_interface          &soil;                                    //150424
   const Soil::Layers_interface   &soil_layers;
   const CS::Land_unit_meteorological &meteorological;                           //151022
   const CS::Solar_radiation_extraterrestrial   &ET_solar_radiation;
 ...
 public:
   Temperature_profile_hourly
      (const Soil::Soil_interface                               &soil
      ,const CS::Land_unit_meteorological                 &meteorological        //151022
      ,const CS::Solar_radiation_extraterrestrial         &ET_solar_radiation    //151022
...
//_Temperature_profile_hourly_______________________________________2004-10-25_/
