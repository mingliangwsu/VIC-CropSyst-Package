...
//_write_ASCII_line_________________________________________________1998-04-03_/
...
//_write_ASCII_column_headers_______________________________________2002-12-16_/
...
//_write_ASCII_________________________________________________________________/
...
{  std::string variable_line;
   ...
   UED::Variable_code var_codes[1000];     int var_code_count = 0;
...
//_read_column_headers______________________________________________2002-09-05_/
...
//_create_datasets_for_format__________________________________________________/
...
//_identify_old_file_format____________________________________________________/
...
//_identify_file_format_____________________________________________2002-08-21_/
...
//_read_ASCII_record________________________________________________2004-04-27_/
...
//_read_ASCII__________________________________________________________________/
...
//_get_avg_annual_temperature__________________________________________________/
void Weather_text_file::invalidate_DOY(CORN::DOY doy)
{  FOR_EACH_IN(data,Weather_column_data,data_sets,each_weather_column_data)      //030707
      data->invalidate_DOY(doy);                                                 //980305
   FOR_EACH_END(each_weather_column_data);                                       //030707
}
//_invalidate_DOY___________________________________________________1999-10-14_/
Weather_text_file::Weather_text_file
(const GEN_DAT_UED_Filename  &file_name_
,Year                         year_                                              //060221
,bool                         for_write_                                         //000619
,Format_old                   V3_write_format_                                   //021216
,bool                         allow_missing_dates_                               //040427
,bool                         need_to_write_column_headers_                      //060221
,ofstream                    *single_outfile_)                                   //060221
:file_name                                (new GEN_DAT_UED_Filename(file_name_)) //150315
,modified                                                                (false) //990903
,for_write                                                          (for_write_) //000316
,V3_write_format                                              (V3_write_format_) //021216
,write_units                                                                 (0) //021218
,allow_missing_dates                                      (allow_missing_dates_) //040427
,year                                                                    (year_) //060221
,need_to_write_column_headers                    (need_to_write_column_headers_) //060221
,single_outfile                                                (single_outfile_) //060221
{  if (for_write_ && V3_write_format)                                            //021216
...
//_Weather_text_file::constructor______________________________________________/
...
{  // We can't just use find because we need to look at units code (for dates
   ...
   {
      UED::Variable_code CVcode = column->variable.get();
...
//_get_data_set_____________________________________________________2002-09-05_/
...
//_set_precip_m_____________________________________________________1999-10-13_/
...
//_set_pot_ET_m_____________________________________________________1999-10-13_/
...
//_set_daytime_VPD_kPa______________________________________________1999-10-13_/
...
//_set_fullday_VPD_kPa______________________________________________1999-10-13_/
...
//_set_max_temp_____________________________________________________1999-10-13_/
...
//_set_min_temp_____________________________________________________1999-10-13_/
...
//_set_max_rel_humid________________________________________________1999-10-13_/
...
//_~Weather_text_file_______________________________________________1999-09-03_/
...
//_set_alt_units____________________________________________________1999-10-13_/
...
//_set_with_quality_________________________________________________1999-10-13_/
...
//_get______________________________________________________________1998-03-05_/
