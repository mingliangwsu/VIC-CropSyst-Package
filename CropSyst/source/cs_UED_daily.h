...
private:
   void register_layer_field                                                     //041002
      (UED::Variable_code variable_code,nat8 num_sublayers
...
//_class CS_UED_tuple_data_source___________________________________2003-07-15_/
...
: public CORN::Data_record    // ? Data_source_abstract? probably not because don't need indexer or modified
{
   ...
   float32 crop_canopy_cover_green;
   float32 crop_canopy_cover_total;
...
//NYI here I could output biomass_grazed
   ...
   float32 nitrogen_amount_kg_m2;                                                //181031
...
// continuous is the default mode case CONTINUOUS_ACCUM :
   float32 ET_max_accum_cont_m; //190812 ET_pot_accum_cont_m;
 ...
 public:
   CS_daily_data_record
      (CropSyst::Land_unit_simulation &land_unit_sim);                           //170225
   virtual bool expect_structure(bool for_write);                                //161025
   virtual bool set_start();                                                     //161023_120426
};
//_class CS_daily_data_record___________________________2003-07-15__2004-10-21_/
