...
*/
   ...
   //_Header____________________________________________2008-08-04__1997-07-20_/
   class Field
   ...
   {  friend class Data_source_dBase;                                            //990615
    ...
    public: // accessors
      ...
      virtual bool is_key_cstr(const char *key)                    affirmation_; //181115
      virtual bool is_key_string(const std::string &key)           affirmation_; //180820;
      virtual const char *get_name()                                      const;
    };
    //_Field________________________________________________________1997-07-20_/
    ...
    //_Field_item___________________________________________________1997-07-20_/
 ...
 private:  // actually private but need to imp
    ...
    Bidirectional_list expected_fields;                                            //090131
 public: // Actual fields is public because we allow this list to be used by data aware controls
    Bidirectional_list actual_fields;  // list of  Field_item                      //970722
...
public:
 ...
 private:
   ...
   bool is_creating()                                              affirmation_; //010104
...
//_Data_source_dBase___________________________________________________________/
...
//_Dynamic_indexed_dBase_data_source________________________________2000-01-12_/
...
{  contribute_ std::string last_where_value;                                     //040909
 public:  // made public so caller can scan the indexed items with out having to read the database himself
   contribute_ CORN::Binary_tree indicies;
public:
   //___________________________________________________________________________
   class Index_item
   : public Item                                                                 //170928
   ...
   //_Index_item_______________________________________________________________/
public:
...
//_Dynamic_string_indexed_dBase_data_source_________________________2000-01-12_/
...
//_Dynamic_string_int32_indexed_dBase_data_source___________________2005-11-01_/
...
{  contribute_ Bidirectional_list indicies;
 ...
 public:
    Dynamic_int32_indexed_dBase_data_source
       ...
       ,std::ios_base::openmode _openmode);                                      //111026
       // (std::ios_base::in | std::ios_base::out)
    inline virtual ~Dynamic_int32_indexed_dBase_data_source()                 {} //081125
...
//_Dynamic_int32_indexed_dBase_data_source__________________________2000-01-12_/
...
{   // This is for a two key index where both index keys are integers
 ...
 public:
   ...
   //_Index_item______________________________________________________________/
 public:
...
//_Dynamic_int32_int32_indexed_dBase_data_source____________________2014-11-11_/
}//_namespace CORN_____________________________________________dbase_datasrc.h_/
#endif
