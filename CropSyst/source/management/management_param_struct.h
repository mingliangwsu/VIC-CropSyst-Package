...
//200220 #define LABEL_decomposition_time_50                "decomposition_time_50"
//200220 #define LABEL_decomposition_time_calculated        "decomposition_time_calculated"
...
//_Tillage_operation_struct_________________________________________2011-01-13_/
...
//_Organic_nitrogen_operation_abstract_struct_______________________2011-01-13_/
   ...
   {  // Eventually (V6) there will be a more generalized condition mechanism
    ...
    public:
      inline bool is_always_applicable()
         { return CORN::is_zero<float32>(N_soil_critical); }
   } condition;
};
//_Inorganic_nitrogen_operation_struct______________________________2011-01-15_/
...
//_Harvest_or_clipping_operation_struct_____________________________2011-01-15_/
...
//_Auto_clip_biomass_mode_struct____________________________________2011-01-15_/
struct Irrigation_operation_struct
{
   ...
   #else
   float32 wetting_area_surface_fraction;                                        //200225
   #endif
   std::string chemical_name;
   nat16 irrigation_type;                                                        //150701LML
};
//_Irrigation_operation_struct_________________________________________________/
struct N_application_soil_observation_mode_struct
{
...
//_N_application_soil_observation_mode_struct_______________________2000-05-19_/
struct Chemical_operation_struct
{  float32 chemical_concentration; // { concentration (kg chem/m3 soil) (With irrigation)}
   std::string chemical_name;
};
//_Chemical_operation_struct________________________________________2011-01-XX_/
#ifdef __cplusplus
