...
#define DLY_MAX_IDS  99
#define GS_MAX_IDS  92
...
(report_var_layout_with_graph variable_set[], int set_count, CS_UED_variable_code var_code);
uint16                           lookup_variable_index
(report_var_layout_with_graph variable_set[], int set_count, CS_UED_variable_code var_code);
//_lookup_functions_________________________________________________2000-09-26_/
...
//_group_report_var_layout____________________________________________________________________________/
