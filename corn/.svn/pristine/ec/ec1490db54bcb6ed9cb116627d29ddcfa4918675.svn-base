...
: public std::string
{
 ...
 public: // structors
   ...
   Uniform_resource_identifier(const Uniform_resource_identifier &URI);
 public:
...
//_Uniform_resource_identifier______________________________________2013-11-18_/
}}//_namespace_CORN::OS________________________________________________________/
#endif
