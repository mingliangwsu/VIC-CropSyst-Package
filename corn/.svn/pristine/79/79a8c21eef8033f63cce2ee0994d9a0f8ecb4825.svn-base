...
//_default_directory_entry_____________________________________________________/
Compound_file_binary_format::Compound_file_binary_format(const char *file_name_)
: Binary_file_fstream(file_name_,false,std::ios_base::in|std::ios_base::out)     //111119
, header(0)
...
{}
//_Compound_file_binary_format:constructor__________________________2011-08-22_/
Compound_file_binary_format::~Compound_file_binary_format()
{}
//_Compound_file_binary_format:destructor___________________________2011-08-22_/
...
//_write_all________________________________________________________2011-10-10_/
...
//_calc_sector_file_pos_____________________________________________2011-08-22_/
/*NYN
...
Compound_file_binary_format::Stream_directory &Compound_file_binary_format
::provide_master_directory_stream()                                 performs_IO_
...
//_Compound_file_binary_format______________________________________2011-08-27_/
Compound_file_binary_format::Stream_user &Compound_file_binary_format
::provide_user_stream(const std::wstring &name)                     performs_IO_
...
//_provide_user_stream______________________________________________2011-08-22_/
...
//_provide_header___________________________________________________2011-08-27_/
...
//_write_header_____________________________________________________2011-08-27_/
...
//_provide_stream___________________________________________________2007-08-27_/
...
//_load_stream_buffer_______________________________________________2007-08-27_/
...
//_write_stream_buffer______________________________________________2007-08-28_/
...
//_Sector_allocation_table::render_stream_sector_chain______________2007-08-27_/
Compound_file_binary_format::Master_sector_allocation_table
&Compound_file_binary_format::provide_master_sector_allocation_table() performs_IO_
...
//_provide_master_sector_allocation_table___________________________2007-08-27_/
Compound_file_binary_format::Sector_allocation_table
&Compound_file_binary_format::provide_sector_allocation_table()     performs_IO_
...
//_provide_sector_allocation_table__________________________________2007-08-27_/
bool Compound_file_binary_format::Stream_user::has_name(const std::wstring &name) const
{  return dir_entry->name == name;
}
//_Stream_user::has_name____________________________________________2007-08-28_/
sector_ID Compound_file_binary_format::Stream_user::get_first_sector_ID()  const
{  return dir_entry->first_sector_ID;
}
//_Stream_user::get_first_sector_ID_________________________________2007-08-28_/
Compound_file_binary_format::Stream_user
*Compound_file_binary_format::Stream_directory::provide_user_stream
...
//_Stream_directory::provide_user_stream____________________________2011-08-22_/
...
//_Stream_directory:constructor_____________________________________2011-08-22_/
bool Compound_file_binary_format::Stream_directory
::read(Directory_entry &dir_ent)                                    performs_IO_
...
//_Stream_directory::read___________________________________________2011-08-28_/
...
//_write_sector_allocation_table____________________________________2011-08-28_/
sector_ID Compound_file_binary_format::Sector_allocation_table
::allocate_sector()                                                modification_
{  nat32 free_sector_index;
   if (!occurs(-1,free_sector_index))
   {  append(-1);
      free_sector_index = get_count();
   }
   return free_sector_index;
}
//_Sector_allocation_table::allocate_sector_________________________2011-08-28_/
