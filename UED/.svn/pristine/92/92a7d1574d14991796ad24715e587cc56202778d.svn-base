...
: public extends_ CORN::Item // CORN::Enumeration
{
 public:
 ...
 public: // accessors
   inline const Variable_code_clad &
      ref_smart_variable_code()                       const { return code_clad;} //010216
   virtual const std::string &ref_description()                         const=0;
};
//_Variable_format_abstract_________________________________________2016-06-20_/
...
//_Variable_format_ontological______________________________________2016-06-20_/
...
//_Variable_format_0________________________________________________1998-02-10_/
