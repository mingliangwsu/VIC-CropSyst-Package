...
{}
//_Crop_nitrogen_mass_balancer:constructor__________________________2007-02-20_/
...
{  return current_canopy_vital + current_canopy_effete
        + current_root_vital   + current_root_effete;
}
