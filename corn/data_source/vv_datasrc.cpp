...
{}
//_VV_Data_source:constructor__________________________________________________/
   ...
   {  size_t equal_pos = buffer.find("=");
      ...
      {  status = VV_Data_source::entry_unknown;                                 //130401
         ...
         {  VV_base_entry *entry =                                               //130401
            ...
            const VV_unexpected_entry *unexpected_entry
               = dynamic_cast<const VV_unexpected_entry *>(entry);               //130401
            status = unexpected_entry
               ? VV_Data_source::entry_unknown
               : VV_Data_source::entry_known;                                    //130401
         }
         }
      } else
         if (current_section)                                                    //120311
...
//_parse_item_______________________________________________________2013-04-01_/
