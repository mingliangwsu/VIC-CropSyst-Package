...
Parameter_properties_literal PP_sowing_avg_temp         ={LABEL_avg_temp               ,NoAltFieldName,TL_Five_day_mean_temp                  ,""                     ,"",UC_Celcius             ,TU_degrees_C};
Parameter_properties_literal PP_sowing_min_PAW          ={LABEL_min_PAW                ,NoAltFieldName,TL_layer_2_is_greater_than             ,TL_Sow_only_when_PAW   ,"",U_units_not_specified  ,TU_0_1};
Parameter_properties_literal PP_sowing_max_PAW          ={LABEL_max_PAW                ,NoAltFieldName,TL_layer_1_is_less_than                ,TL_Sow_only_when_PAW   ,"",U_units_not_specified  ,TU_0_1};
Parameter_properties_literal PP_expected_days_to_emerge ={LABEL_expected_days_to_emerge,NoAltFieldName,"Typical days for emergence"           ,""                     ,"",UT_day                 ,"Days"/*T_date_Days*/};
Parameter_properties_literal PP_delay_after_precip      ={LABEL_delay_after_precip     ,NoAltFieldName,TL_Number_of_days_to_delay             ,""                     ,"",UT_day                 ,"Days"/*T_date_Days*/};
Parameter_properties_literal PP_appreciable_precip_mm   ={LABEL_appreciable_precip     ,NoAltFieldName,TL_Significant_precipitation_amount    ,""                     ,"",UC_mm                  ,TU_mm};
...
/*200318obs
Parameter_formatX PPF_sowing_avg_temp         ={{6},{2}};
Parameter_formatX PPF_sowing_min_PAW          ={{6},{2}};
Parameter_formatX PPF_sowing_max_PAW          ={{6},{2}};
Parameter_formatX PPF_expected_days_to_emerge ={{3},{0}};
Parameter_formatX PPF_delay_after_precip      ={{3},{0}};
Parameter_formatX PPF_appreciable_precip      ={{6},{1}};
*/
...
, seeding_parameters()
#endif
, sowing_date_mode_clad(FIXED_DATE)
...
, p_sowing_avg_temp         (sowing_avg_temp          ,PP_sowing_avg_temp        ,PPR_sowing_avg_temp          ,PPF_F)// ,PPF_sowing_avg_temp)
, p_sowing_min_PAW          (sowing_min_PAW           ,PP_sowing_min_PAW         ,PPR_sowing_min_PAW           ,PPF_F)// ,PPF_sowing_min_PAW)
, p_sowing_max_PAW          (sowing_max_PAW           ,PP_sowing_max_PAW         ,PPR_sowing_max_PAW           ,PPF_F)// ,PPF_sowing_max_PAW)
, p_expected_days_to_emerge (expected_days_to_emerge  ,PP_expected_days_to_emerge,PPR_expected_days_to_emerge  ,PPF_N) // ,PPF_expected_days_to_emerge)
, p_delay_after_precip      (delay_after_precip       ,PP_delay_after_precip     ,PPR_delay_after_precip       ,PPF_N) //,PPF_delay_after_precip)
, p_appreciable_precip_mm   (appreciable_precip_mm    ,PP_appreciable_precip_mm  ,PPR_appreciable_precip_mm    ,PPF_F)// ,PPF_appreciable_precip)
...
//_Sowing_operation:constructor________________________________________________/
...
, p_sowing_avg_temp         (sowing_avg_temp          ,PP_sowing_avg_temp        ,PPR_sowing_avg_temp          ,PPF_F)
, p_sowing_min_PAW          (sowing_min_PAW           ,PP_sowing_min_PAW         ,PPR_sowing_min_PAW           ,PPF_F)
, p_sowing_max_PAW          (sowing_max_PAW           ,PP_sowing_max_PAW         ,PPR_sowing_max_PAW           ,PPF_F)
, p_expected_days_to_emerge (expected_days_to_emerge  ,PP_expected_days_to_emerge,PPR_expected_days_to_emerge  ,PPF_N)
, p_delay_after_precip      (delay_after_precip       ,PP_delay_after_precip     ,PPR_delay_after_precip       ,PPF_N)
, p_appreciable_precip_mm   (appreciable_precip_mm    ,PP_appreciable_precip_mm  ,PPR_appreciable_precip_mm    ,PPF_F)
...
, sowing_date_mode_clad((Sowing_date_mode)original.sowing_date_mode_clad.get())
...
{  CropSyst_field_operation_VX::setup_parameters(data_rec,for_write);
   ...
   if (!for_write || (sowing_date_mode_clad.get() != FIXED_DATE))
   {
...
{  bool determinable = true;
   ...
   */
   ...
   switch (sowing_date_mode_clad.get())
   {
      case MIN_TEMP_REQ    :
      {
         if (!adjusted_for_weather_conditions)                                   //170220
         { // air temperature condition moved to Rotation class
         CORN::statistical::Descriptive_progressive avg_air_temp_for_window;     //200701
...
{  nat16 computed_planting_count = 0;
   FOR_EACH_IN(planting_event,Sowing_event,planting_events,each_planting)
      ...
      += planting_event->sowing_op->sowing_date_mode_clad.get()!=FIXED_DATE;
...
//_set_operation____________________________________________________2004-12-03_/
Crop_parameters *Sowing_operation::relinquish_crop_params()
{  if (crop_params)
      crop_params_relinquished_to_crop = true;
   return crop_params;
}
//_relinquish_crop_params___________________________________________2003-07-11_/
...
//_take_crop_params_________________________________________________2003-07-11_/
