...
//24 mukey Mapunit Key String Yes 30
{}
//_Mapunit_record:constructor__________________________________________________/
bool Mapunit_record::expect_structure(bool for_write)
{
