...
//_constructor______________________________________________________1999-04-17_/
...
,int crop_name_column
,Association_list &separate_crop_tallies)                                        //980721
{  BIFF234_File  infile(XLH_filename.c_str());
   if (infile.good())
   {
      while (!infile.eof())
      {
         bool process_this_row = true;
         infile.read_next(Spreadsheet_abstract::data_cell_record);
         ...
         if ((infile.data_type == Spreadsheet_abstract::type_str)
...
//_identify_different_crops_________________________________________1998-07-21_/
...
//_donatelli_analysis_variable_selection____________________________1999-11-20_/
...
//_donatelli_analysis__________________________________________________________/
...
//_setup_common_analysis_structures_________________________________1998-12-18_/
...
//_load_previous_run___________________________________________________________/
...
{}
//_run_________________________________________________________________________/
void ArcCS_cooperator_simulation::copy_results_files
(int32 from_polygon_ID,int32 to_polygon_ID)
...
//_copy_results_files_______________________________________________2001-05-14_/
...
{  // Create a Spreadsheet file containing notes about the exempler polygons
   ...
   BIFF234_File notes_sheet(notes_filename.c_str(),0,1000,0,20);
   notes_sheet.write_label_cell(0,0,Spreadsheet_abstract::CSS_justify_left,"Exemplar");
   notes_sheet.write_label_cell(3,0,Spreadsheet_abstract::CSS_justify_left,"Water holding capacity(mm)");
   notes_sheet.write_label_cell(0,1,Spreadsheet_abstract::CSS_justify_left,"polygon_ID");
   notes_sheet.write_label_cell(1,1,Spreadsheet_abstract::CSS_justify_left,"soil");
   notes_sheet.write_label_cell(2,1,Spreadsheet_abstract::CSS_justify_left,"depth (m)");
   notes_sheet.write_label_cell(3,1,Spreadsheet_abstract::CSS_justify_left,"profile");
   notes_sheet.write_label_cell(4,1,Spreadsheet_abstract::CSS_justify_left,"1-meter depth");
   notes_sheet.row = 2;
   setup_common_analysis_structures(true);
   ...
   {  Polygon_attribute_data_record  polygon_attr_DR                             //030224
      ...
      if (polygon_equivalences[record_num] == -1)
      {
         ...
         VV_File soil_file(polygon_attr_DR.get_record_soil_filename
            (template_sim->soil_filename.c_str()));
         soil_file.get(soil);
         ...
         notes_sheet.write_string(Spreadsheet_abstract::CSS_justify_left,polygon_attr_DR.soil_code.c_str());   //030224
...
//_compute_relevent_soil_WHC________________________________________1998-12-18_/
