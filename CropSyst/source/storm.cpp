...
//_Storm_database_or_generator:constructor_____________________________________/
Storm_database_or_generator::~Storm_database_or_generator()
{  if (storm_database) delete storm_database;
}
//_Storm_database_or_generator:destructor___________________________2000-03-03_/
