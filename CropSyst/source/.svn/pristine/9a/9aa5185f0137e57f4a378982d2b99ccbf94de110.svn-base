...
: public CropSyst::Management_parameters                                         //010109
{
 ...
 public:
   inline Management()
      ...
      {}
   inline virtual ~Management()                                               {} //120217
   inline virtual const char *get_record_section_label()                   const
      { return "management";};
   void transfer_all
      (Common_event_list &event_list
      , bool run_nitrogen
      , Synchronization_mode relevant_sync //= ANY_SYNC_MODE                     //151004
...
//_Management__________________________________________________________________/
