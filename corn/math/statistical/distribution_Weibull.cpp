...
//_bisection_method_________________________________________________1998-03-18_/
...
//_f________________________________________________________________1998-03-18_/
...
{  // First approximation of alpha:
   ...
   for (nat32 i = 0; i < n; i++)  // for each item in the dataset
      sum_x_pow_alpha
         += pow((float64)statistical_dataset.get(i),(float64)alpha_shape);
...
//_get_shape_scale__________________________________________________1998-03-18_/
