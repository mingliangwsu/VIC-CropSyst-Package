...
nat32 CropSyst_text_convertor::perform_import()
{
   ...
   CS_text_weather_ext.include_pattern("gen");
   ...
   UED::Geolocation_record  *geoloc_rec = const_cast<UED::Geolocation_record *>
      (ued_database.ref_geolocation_record());                                   //110822

      190515 reimplement using provide_geolocation_record()
