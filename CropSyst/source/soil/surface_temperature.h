...
{public:
   /*181212 conceptual
   float64 calc_max //181212 max_surface_temp     // rename to calc_maximum
      ( float64 moisture_component   //Moisture component of temperature
      , float64 radiation_component
      , float64 cover_component
      , float64 a
      , float64 max_temp);
   float64 calc_min //181212 min_surface_temp     // rename to calc_minimum
      ( float64 f
      , float64 cover
      , float64 g
      , float64 min_temp);
...
//_Soil_surface_temperature_________________________________________1998-06-01_/
#endif
