#ifndef statistics_commonH
#define statistics_commonH
//______________________________________________________________________________
#define  STAT_value_bit     1
#define  STAT_sum_bit       2
#define  STAT_mean_bit      4
// This should be named Arithmetic mean
#define  STAT_std_dev_bit   8
#define  STAT_coef_var_bit 16
#define  STAT_sum_sqrs_bit 32
#define  STAT_min_bit      64
#define  STAT_max_bit     128
#define  STAT_count_bit	  256
...
//#define  STAT_ALL_NOT_DATUMS ((uint16)(STAT_ALL - STAT_DATUMS));
