...
class Infiltration_finite_difference; // forward declaration
//______________________________________________________________________________
class Hydrology_finite_difference
: public Hydrology_abstract
{protected: friend class Infiltration_finite_difference;
 ...
 public: // constructor
   ...
   inline virtual Hydrology_finite_difference *copy(float32 fraction=1.0) const  //140610
      { return new Hydrology_finite_difference(*this,fraction); }
...
public:  // Calculated for today
 ...
 public: // accessors
   ...
   virtual float64 calc_water_depth_profile                                      //130930_080314
...
//_Hydrology_finite_difference______________________________________2006-05-05_/
