...
//_NB_report_var_opts__________________________________________________________/
...
{{0/*DLY_ID*/                     , 0,0,TL_BLANKLINE       ,0          ,TL_BLANKLINE                           ,false,LAYOUT_NO_OPTIONS},
 ...
 {CSVC_crop_biomass_canopy        , 7,1,TU__kg_ha_         ,UC_kg_ha   ,"Above ground biomass_(drywt)" ,true,RTG_Crop          ,YELLOW,true},  //200608
 ...
 {CSVC_crop_base_fruit_canopy_biomass  , 7,1,TU__kg_ha_    ,UC_kg_ha   ,"Non-fruit above_ground(+reserves) biomass"       ,true,RTG_Crop          ,LIGHT_GRAY,true},
 {CSVC_crop_base_fruit_reserves_biomass, 7,1,TU__kg_ha_    ,UC_kg_ha   ,"reserves biomass"       ,true,RTG_Crop          ,LIGHT_GRAY,true},
...
{DLY_ET_max                      , 6,2,TU__mm_            ,UC_mm      ,"Evapotranspiration maximum"           ,true,RTG_weather       ,MAGENTA ,true}, /*23*/
//190812 {DLY_ET_pot                      , 6,2,TU__mm_            ,UC_mm      ,TL_Potential_evapotranspiration        ,true,RTG_weather       ,MAGENTA ,true}, /*23*/
{DLY_ET_act                      , 6,2,TU__mm_            ,UC_mm      ,"Evapotranspiration actual"            ,true,RTG_weather       ,LIGHT_MAGENTA ,true}, /*24*/
{DLY_transp_pot                  , 6,2,TU__mm_            ,UC_mm      ,"Transpiration potential"           ,true,RTG_Crop          ,CYAN,true}, /*25*/
...
*/
{DLY_transp_act                  , 6,2,TU__mm_            ,UC_mm      ,"transpiration actual"            ,true,RTG_Crop          ,LIGHT_CYAN,true}, /*26*/

/* continue here!
   rename transpiration uptake actual
...
{DLY_ET_max_accum                , 7,2,TU_accum__mm_      ,UC_mm      ,"Evapotranspiration maximum"           ,true,RTG_weather_accum ,MAGENTA,true},/*38*/
{DLY_ET_act_accum                , 7,2,TU_accum__mm_      ,UC_mm      ,"Evapotranspiration actual"            ,true,RTG_weather       ,LIGHT_MAGENTA,true},/*39*/
{DLY_transp_pot_accum            , 7,2,TU_accum__mm_      ,UC_mm      ,"Transpiration potential"           ,true,RTG_Crop          ,CYAN ,true},/*40*/
...
{DLY_transp_act_accum            , 7,2,TU_accum__mm_      ,UC_mm      ,"Transpiration actual"            ,true,RTG_Crop          ,LIGHT_CYAN,true},/*41*/
...
//_DLY_report_var_opts_________________________________________________________/
...
/* 4*/{YLY_ET_max,               7,2,TU__mm_       ,UC_mm      ,"Evapotranspiration maximum"     ,true,LAYOUT_NO_OPTIONS}, /* 4*/
/* 5*/{YLY_ET_act,               7,2,TU__mm_       ,UC_mm      ,"Evapotranspiration actual"      ,true,LAYOUT_NO_OPTIONS}, /* 5*/
/* 6*/{YLY_transp_pot,           7,2,TU__mm_       ,UC_mm      ,"Transpiration potential"       ,true,LAYOUT_NO_OPTIONS}, /* 6*/
...
/* 7*/{YLY_transp_act,           7,2,TU__mm_       ,UC_mm      ,"Transpiration actual"          ,true,LAYOUT_NO_OPTIONS}, /* 7*/

/* continue here!
   rename Transpiration putake actual
*/
...
//_YLY_report_var_opts_________________________________________________________/
...
{     {0/*HRV_ID*/,                     0,0,TL_BLANKLINE ,0          ,TL_BLANKLINE            ,false,LAYOUT_NO_OPTIONS},
      ...
      {CSVC_crop_base_fruit_canopy_biomass,8,2,TU__kg_ha_   ,UC_kg_ha,"Non-fruit above_ground(+reserves) biomass"       ,true,LAYOUT_NO_OPTIONS},  //200608
      {CSVC_crop_base_fruit_reserves_biomass,8,2,TU__kg_ha_   ,UC_kg_ha,"Reserves biomass"       ,true,LAYOUT_NO_OPTIONS}, //200608
...
/*22*/{GS_incorporated_manure,         7,2,TU__kg_ha_   ,UC_kg_ha   ,TL_Incorporated_manure    ,true,LAYOUT_NO_OPTIONS},
      ...
      {GS_ET_max,                      7,2,TU__mm_      ,UC_mm      ,"Evapotranspiration maximum"  ,true,LAYOUT_NO_OPTIONS},
/*26*/{GS_ET_act,                      7,2,TU__mm_      ,UC_mm      ,"Evapotranspiration actual"   ,true,LAYOUT_NO_OPTIONS},
/*27*/{GS_transp_pot,                  7,2,TU__mm_      ,UC_mm      ,"Transpiration potential"     ,true,LAYOUT_NO_OPTIONS},
...
/*28*/{GS_transp_act,                  7,2,TU__mm_      ,UC_mm      ,"Transpiration actual"        ,true,LAYOUT_NO_OPTIONS},
...
//_GS_report_var_opts__________________________________________________________/
...
//_column_header_______________________________________________________________/
...
const char *lookup_description
(report_var_layout_with_graph variable_set[], int set_count, CS_UED_variable_code var_code)
{  for (int i = 0 ; i < set_count; i++)
      if (variable_set[i].ID == var_code)
         return (variable_set[i].desc);
   return "";
}
//_lookup_description_______________________________________________2000-09-26_/
nat16 lookup_variable_index
(report_var_layout_with_graph variable_set[]
, int set_count, CS_UED_variable_code var_code)
{  for (uint16 i = 0 ; i < set_count; i++)
      if (variable_set[i].ID == var_code)
         return i;
   return 0;
}
//_lookup_variable_index____________________________________________2000-09-26_/
report_var_layout_with_graph *lookup_report_var_layout
(report_var_layout_with_graph variable_set[]
,int set_count, CS_UED_variable_code var_code)
{  for (uint16 i = 0 ; i < set_count; i++)
      if (variable_set[i].ID == var_code)
...
//_lookup_report_var_layout_________________________________________2000-09-26_/
