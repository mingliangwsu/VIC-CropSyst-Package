...
{}
//_Crop_production_function_simulation:constructor_____________________________/
   ...
   for (Date_time_64 date(earliest_date); date.get_datetime64() <= latest_date.get_datetime64(); date.inc())   //031218
    {
      ...
      if (! CORN::is_zero<float32>(irrigation_mm ,0.00001))
      {
...
//_collect_automatic_irrigation________________________________________________/
...
//_create_scenario_____________________________________________________________/
...
//_run_scenario________________________________________________________________/
