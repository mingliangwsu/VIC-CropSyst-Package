...
float64 Nitrogen_common::uptake_N_mass(nat8 layer, float64 requested_pot_elemental_N_uptake_kg_m2) modification_
...
//______________________________________________________________________________
float64 Nitrogen_common::add_NO3_N_mass(nat8 layer,float64 NO3_N_mass_addend) modification_
...
//______________________________________________________________________________
float64 Nitrogen_common::add_NH4_N_mass(nat8 layer,float64 NH4_N_mass_addend) modification_
...
//______________________________________________________________________________
float64 Nitrogen_common::add_NO3_molecular_mass(nat8 layer,float64 NO3_mass_M_addend) modification_
...
//______________________________________________________________________________
float64 Nitrogen_common::add_NH4_molecular_mass(nat8 layer,float64 NH4_mass_M_addend)
...
#ifdef NYI
float64 Nitrogen_common::subtract_NO3_mass_molecular(nat8 layer,float64 NO3_mass_M);
//______________________________________________________________________________
float64 Nitrogen_common::subtract_NH4_mass_molecular           (nat8 layer,float64 NH4_mass_M);
//______________________________________________________________________________
#endif
