...
#endif
//_is_project_directory_____________________________________________2014-01-25_/
...
//_render_project_directory_________________________________________2014-01-25_/
...
//_2014-01-25___________________________________________________________________
bool Context_directory::is_scenario_directory
(const CORN::OS::Directory_name &dir_name)                          affirmation_
{
   ...
   bool is_scenario =
      ...
      CORN::OS::file_system_engine.exists
         (CORN::OS::Directory_name_concrete(dir_name,*canonical_scenario_file_name));
   if (!is_scenario)
   {  is_scenario = get_directory_context(dir_name) == scenario_context;
   }
   return is_scenario;
}
//_is_scenario_directory____________________________________________2014-01-25_/
...
//_render_scenario_directory________________________________________2014-01-25_/
*/
}//_namesace_CS________________________________________________________________;
