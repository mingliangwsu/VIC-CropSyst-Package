#error obsolete
This appears to be obsolete  200302
...
private:
   ...
   public:// 'structors
      Scalar_field_caption_context(ED_tabular_file_format::Metadata_field &_field_description)
   ...
   public: // adjunct references from format
      ED_tabular_file_format::Metadata_field                  &field_description;
   public:// 'structors
      Scalar_field_value_context(ED_tabular_file_format::Metadata_field &_field_description
         : CORN::Tabular_parser::Context_abstract()
         ,field_description(_field_description)
         {};
   public: // override Context_interface
   ...
   : public  CORN::Tabular_parser::Context_abstract
   {
   private: // adjunct references from Common_tabular_file__format
   ...
   private:
      ...
      bool                          last_character_processed_was_delimiter;      // Used in the case of continuous delimiters treated as one
      ...
      uint32                        curr_delimiter_string_pos;
      char                          curr_delimiter_string[1000];                 // Buffer storing this current portion of any delimiter substring
         // As we are processing columns text, we may be within a delimiter string
         // I.e. the HTML table delimiter  <TD>  then we need to subparse this text as well.
      char                          in_quote;   // 0 if we have not started quotation
                                                // " if we have started a double quote
                                                // ' if we have started a single quote
   public: // 'structors
      Columnar_context
         (const Delineation  &_delineation
         ...
         , last_character_processed_was_delimiter(false)
         , curr_column_pos  (0)
   ...
   {
   private: // adjunct references from Common_tabular_file__format
      const Common_tabular_file__format::Column_headers_delineation   &column_headers_delineation;  // reference to column_headers_delineation
   protected:
   ...
   public: // 'structors
      ...
      Column_header_context
         (const Common_tabular_file__format::Column_headers_delineation   &_column_headers_delineation
         ,const Association_list             &_columns_1based)
   ...
   private: // adjunct references from Common_tabular_file__format
      Common_tabular_file__format::Detail_lines_delineation     &detail_lines_delineation;     // reference to detail_lines_delineation
   public: // 'structors
      Detail_line_context
         (Tabular_format::Delineation_detail /*200220 Common_tabular_file__format::Detail_lines_delineation */  &_detail_lines_delineation
