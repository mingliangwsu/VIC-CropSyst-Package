...
// UM_power
#define UC_watt                          (nat16)0x5400
// UM_radiant_flux               (nat8) 0x55
#define UC_watt_radiant_flux             (nat16)0x5500
// This is watt/m2
#define UC_mega_watt_radiant_flux           (nat16)0x5503
...
// atmospheric
// stress
#define UC_pascal                        (nat16)0x5800
#define UC_pascal_pressure               (nat16)0x5800
#define UC_hPa                           (nat16)0x5802
#define UC_kPa                           (nat16)0x5803
#define UC_barye                         (nat16)0x5841
// 1 barye = 0.1 pascal
#define UC_millibar                      (nat16)0x5842
// 1 millibar (millibarye) = 1 hectopascal
// could also have other presure units I.e. torr
// 1013.25 mbar (101325 Pa), equivalent to 760 mm Hg (torr),

//conceptual
//#define UM_barametric_pressure
//#define UC_mm_mercury  (nat16)0x5943
// Note barametric pressure can be represented with mm of mercury ("pascals")
...
#define UC_milliosmol                     (nat8) 0x5B43
...
#define UC_microsiemens                  (nat16)0x7746
...
#define UC_cm_per_day                     U_a_per_b(UC_cm,UT_day)
#define UC_mm_per_hour                    U_a_per_b(UC_mm,UT_hour)
...
#define UC_MJ_per_m2_solar_radiation      UC_MJ_per_m2
...
#define UC_mg_per_m2                      U_a_per_b(UC_mg_mass,UC_square_meter_area)
#define UC_kg_per_m3                      U_a_per_b(UC_kg_mass,UC_cubic_meter_volume)
#define UC_tn_per_ha                      U_a_per_b(UC_tonne_mass,UC_hectare)
#define UC_tn_per_m2                      U_a_per_b(UC_tonne_mass,UC_square_meter_area)
...
#define UC_g_per_m3                       U_a_per_b(UC_gram_mass,UC_cubic_meter_volume)
#define UC_ug_per_m3                      U_a_per_b(UC_microgram_mass,UC_cubic_meter_volume)
...
#define UC_mmole_per_m2                   U_a_per_b(UC_mmole,UC_square_meter_area)
...
#define UC_liter_per_second               U_a_per_b(UC_liter,UT_second)
...
#define UC_m3_per_second                  U_a_per_b(UC_cubic_meter_volume,UT_second)
...
#define UC_g_per_hour                     U_a_per_b(UC_g_mass,UT_hour)


#define UC_m2_per_gram                    U_a_per_b(UC_square_meter_area,UC_gram_mass)

#define UC_ml_per_liter                   U_a_per_b(UC_ml,UC_liter)

#define UC_g_per_liter                    U_a_per_b(UC_gram_mass,UC_liter)
#define UC_mg_per_liter                   U_a_per_b(UC_mg_mass,UC_liter)
#define UC_ug_per_liter                   U_a_per_b(UC_microgram_mass,UC_liter)
#define UC_mg_per_ml                      U_a_per_b(UC_mg_mass,UC_ml)
...
// Reposition the following
#define UC_microsiemens_per_cm            U_a_per_b(UC_microsiemens,UC_cm)
#define UC_milliosmol_per_kg           U_a_per_b(UC_milliosmol,UC_kg_mass)
