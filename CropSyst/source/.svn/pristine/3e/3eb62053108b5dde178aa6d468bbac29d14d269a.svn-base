...
,const Soil::Soil_interface   *soil_                                             //181206_160415
...
//_Crop_transpiration_2:constructor_________________________________2004-03-31_/
...
,float64 yesterday_fract_green_canopy_solrad_interception_mm
...
,float64 CO2_transpiration_adjustment_factor)                              const //160418
{
   ...
   nat8 soil_num_sublayers = soil ?soil->ref_layers()->count():0;                //051028
...
//200507          && (leaf_water_pot > parameters_LWP_wilt_point)
          && (!CORN::is_zero<float64>(max_crop_water_uptake_mm,0.00000007)))
      {  // onset of stress
      // Reduce transpiration when leaf water potential is less than
      // the critical leaf water potential at the onset of stomatal closure.
...
//_uptake_actual____________________________________________________2016-04-15_/
...
,  float64 soil_avg_water_pot)                                             const
{
   ...
   if (leaf_water_pot < leaf_water_pot_onset_of_stress_ )
   {
      ...
      float64 plant_hydraulic_cond_adjusted = PHC_adj * plant_hydraulic_cond;    //200318COS
      leaf_water_pot
      = (plant_hydraulic_cond_adjusted //200318 plant_hydraulic_cond
         * soil_avg_water_pot
         * (leaf_water_pot_onset_of_stress_  - leaf_water_pot_wilt_)
...
//_calc_leaf_water_potential________________________________________2001-07-23_/
...
{  // sharing parent's emanator
   ...
   inspectors.append(new CS::Inspector_scalar(uptake_act_m   ,UC_m       ,*context,"transpiration/uptake/act",value_statistic  ,CSVP_crop_base_transp_uptake_act));
   return 0;
}
