...
class Descriptive_common   //200701 was Statistics_descriptive_common
{protected:
...
//_Descriptive_common_____________________________________________________________________________
class Descriptive_dataset
: public Dynamic_array<float32>                                                  //140610
, public Descriptive_common                                                      //990401
{private: // updated by recompute
 ...
 public:
   Descriptive_dataset();
   Descriptive_dataset(const Dynamic_array<float32> &data_to_copy);              //140610
   virtual bool reset();                                           modification_ //150825_040123
   inline virtual bool clear()                                     modification_{ return Dynamic_array<float32>::clear() && reset(); }  //140610_980310
...
//_Descriptive_dataset_________________________________________________________/
class Descriptive_progressive //200701 was Descriptive_progressive Running_tally          // Rename this to Statistics_running tally
: public Descriptive_common
{private:
   nat32  count;
 public:
   Descriptive_progressive();
   virtual bool reset();
   virtual float32 append(float32 value);                                        //980305
...
//_Descriptive_progressive__________________________________________1999-03-31_/
class Descriptive_progressive_index // 200701 was Running_index      // This is only used by CropSyst, probably should move it
: public Sample_cumulative<float32,float32>                                      //200701
{
public:
   float64 index; // 1 = max stress 0 = no stress So recorder can reference
public:
   Descriptive_progressive_index(nat16 _applicable /*= STAT_ALL_bits*/);
   virtual float32 append(float32 value);
   virtual bool reset();                                                         //150825
};
//_Descriptive_progressive_index____________________________________2001-07-26_/
}//_namespace_stastitical___________________________________________2020-07-01_/
