...
BIFF2_rec_INTEGER &Worksheet_BIFF2::Row_set::provide_INTEGER_record(uint16 col) provides_
...
BIFF_rec_LABEL &Worksheet_BIFF2::Row_set::provide_LABEL_record(uint16 col) provides_
{  BIFF_rec_LABEL *rec =
#ifdef USE_XF
      (format >= BIFF4)
...
//______________________________________________________________________________
BIFF_rec_NUMBER &Worksheet_BIFF2::Row_set::provide_NUMBER_record(uint16 col) provides_
{  BIFF_rec_NUMBER *rec =
#ifdef USE_XF
      (format >= BIFF5)
...
//______________________________________________________________________________
}//_namespace_Excel_BIFF____________________________________________2019-01-07_/
