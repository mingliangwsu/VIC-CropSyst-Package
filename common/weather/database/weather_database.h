...
*/
   ...
   inline virtual bool is_daily_data_available_for
      (CORN::Year /*year*/
      ,UED::Variable_code /*variable_to_check = 0*/)
      { return true; }
...
//_Weather_database____________________________________________________________/
...
//_Annual_data_status__________________________________________________________/
#endif
