...
extern UED::Variable_code Identify_standard_variable_code(const char *variable_label);     //020906
extern const std::string &standard_variable_abbreviation(UED::Variable_code var_code);//140615
...
}//_namespace UED___________________________________________________2007-07-18_/
#endif
//std_codes
