...
// moved to PAT_tally_engine
 ...
 private:
   ...
   bool check_run_STATGO_scenario(const char *MUID, int seq_num,std::string &COMPNAME) const; //050819
...
//_GIS_simulation______________________________________________________________/
#endif
