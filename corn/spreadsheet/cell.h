...
{public:
    ...
    virtual nat32  get_col()                                            const=0;
      // Note: Excel currently only uses uint16  for columns
};
//______________________________________________________________________________
...
//_Cell_numeric________________________________________________________________/
...
//_Cell_textual________________________________________________________________/
