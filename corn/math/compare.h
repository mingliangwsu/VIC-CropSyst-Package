...
//eventually restore this for C #define CORN_is_approximately  (value,target,tolerance) (((value) < ((target) + (tolerance))) && ((value) > ((target) - (tolerance))))
#define CORN_is_approximately(value,target,tolerance) (((value) < ((target) + (tolerance))) && ((value) > ((target) - (tolerance))))

extern int CORN_compare_float(float value1, float value2);                       //050630
extern int CORN_compare_int  (int value1, int value2);                           //050630
